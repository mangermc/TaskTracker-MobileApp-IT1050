;(() => {
  var e = {
      "./node_modules/.pnpm/mlly@1.8.2/node_modules/mlly/dist lazy recursive"(
        e,
      ) {
        ...
        ;(webpackEmptyAsyncContext.keys = () => []),
          ...
          (webpackEmptyAsyncContext.id =
            "./node_modules/.pnpm/mlly@1.8.2/node_modules/mlly/dist lazy recursive"),
          (e.exports = webpackEmptyAsyncContext)
      },
      fs(e) {
        "use strict"
      ...
      "./node_modules/.pnpm/get-tsconfig@4.14.0/node_modules/get-tsconfig/dist/index.cjs"(
        e,
        t,
        i,
      ) {
        ...
        const S = r((e) => {
            ...
            return (i, ...n) => {
              ...
              return (
                void 0 === l &&
                  ((l = Reflect.apply(t, c, n)), null == i || i.set(a, l)),
                l
              )
            }
          }, "cacheFs"),
        ...
        r(Ne, "createScanner"),
          ...
          r(M, "isLineBreak"),
          r(R, "isDigit"),
          ((q = $ || ($ = {}))[q.lineFeed = 10] = "lineFeed"),
          (q[q.carriageReturn = 13] = "carriageReturn"),
          (q[q.space = 32] = "space"),
          (q[q._0 = 48] = "_0"),
          (q[q._1 = 49] = "_1"),
          (q[q._2 = 50] = "_2"),
          ...
          (q[q.Y = 89] = "Y"),
          (q[q.Z = 90] = "Z"),
          (q[q.asterisk = 42] = "asterisk"),
          (q[q.backslash = 92] = "backslash"),
          (q[q.closeBrace = 125] = "closeBrace"),
          (q[q.closeBracket = 93] = "closeBracket"),
          (q[q.colon = 58] = "colon"),
          (q[q.comma = 44] = "comma"),
          (q[q.dot = 46] = "dot"),
          (q[q.doubleQuote = 34] = "doubleQuote"),
          (q[q.minus = 45] = "minus"),
          (q[q.openBrace = 123] = "openBrace"),
          (q[q.openBracket = 91] = "openBracket"),
          (q[q.plus = 43] = "plus"),
          (q[q.slash = 47] = "slash"),
          (q[q.formFeed = 12] = "formFeed"),
          (q[q.tab = 9] = "tab"),
          ...
          return (
            ...
            We(
              e,
              {
                ...
                onLiteralValue: o,
                onError: r((e, i, n) => {
                  t.push({ error: e, offset: i, length: n })
                }, "onError"),
              },
              i,
            ),
        ...
        function We(e, t, i = K.DEFAULT) {
          ...
          r(o, "toNoArgVisit"),
            ...
            r(g, "toBeginVisit"),
            r(m, "toEndVisit")
          const l = g(t.onObjectBegin),
            y = u(t.onObjectProperty),
            E = m(t.onObjectEnd),
            w = g(t.onArrayBegin),
            C = m(t.onArrayEnd),
            S = u(t.onLiteralValue),
            I = f(t.onSeparator),
            N = o(t.onComment),
            O = f(t.onError),
            j = i && i.disallowComments,
            F = i && i.allowTrailingComma
          function T() {
            for (;;) {
              const e = n.scan()
          ...
          function G() {
            ...
            for (; 4 !== n.getToken() && 17 !== n.getToken(); ) {
              if (5 === n.getToken()) {
                if ((t || k(4, [], []), I(","), T(), 4 === n.getToken() && F))
                  break
              } else t && k(6, [], [])
              e ? (a.push(0), (e = !1)) : a[a.length - 1]++,
                U() || k(4, [], [4, 5]),
                (t = !0)
            }
            return (
              C(), e || a.pop(), 4 !== n.getToken() ? k(8, [4], []) : T(), !0
            )
          }
          function U() {
            switch (n.getToken()) {
        ...
        new Array(W).fill(0).map((e, t) => "\n" + " ".repeat(t)),
          new Array(W).fill(0).map((e, t) => "\r" + " ".repeat(t)),
          new Array(W).fill(0).map((e, t) => "\r\n" + " ".repeat(t)),
          new Array(W).fill(0).map((e, t) => "\n" + "\t".repeat(t)),
          new Array(W).fill(0).map((e, t) => "\r" + "\t".repeat(t)),
          new Array(W).fill(0).map((e, t) => "\r\n" + "\t".repeat(t)),
        ...
        const X = r((e, t) => Q(N(t, e, "utf8")), "readJsonc"),
          te = Symbol("implicitBaseUrl"),
          ie = "${configDir}",
          se = r(() => {
          ...
          re = r((e, t, i, n) => {
            ...
            return (E = a.join(e, "..", E)), null == n || n.set(c, E), E
          ...
          ce = r((e, t) => B(a.relative(e, t)), "pathRelative"),
          he = ["files", "include", "exclude"],
          le = r((e, t, i) => {
            const n = a.join(t, i)
          ...
          ue = r((e, t, i, n) => {
            ...
            if (i.has(c))
              throw new Error(
                `Circularity detected while resolving configuration: ${c}`,
              )
            i.add(c)
            const l = a.dirname(c),
              y = fe(c, n, i)
          ...
          fe = r((e, t, i = new Set()) => {
            ...
            if (n.extends) {
              ...
              for (const a of e.reverse()) {
                ...
                e.watchOptions &&
                  (l.watchOptions = { ...e.watchOptions, ...n.watchOptions }),
                  (n = l)
              }
            }
            if (n.compilerOptions) {
              ...
              for (const t of de) {
                ...
                i &&
                  (Array.isArray(n.exclude) ||
                    (n.exclude = de.map((t) => e[t]).filter(Boolean)),
                  i.startsWith(ie) || (i = B(i)),
                  (e[t] = i))
              }
            } else n.compilerOptions = {}
            if (
              (n.include && (n.include = n.include.map(h)),
              n.files &&
                (n.files = n.files.map((e) => (e.startsWith(ie) ? e : B(e)))),
              n.watchOptions)
            ) {
              const { watchOptions: e } = n
              e.excludeDirectories &&
                (e.excludeDirectories = e.excludeDirectories.map((e) =>
                  h(a.resolve(c, e)),
                )),
                e.excludeFiles &&
                  (e.excludeFiles = e.excludeFiles.map((e) =>
                    h(a.resolve(c, e)),
                  )),
                e.watchFile && (e.watchFile = e.watchFile.toLowerCase()),
                e.watchDirectory &&
                  (e.watchDirectory = e.watchDirectory.toLowerCase()),
                e.fallbackPolling &&
                  (e.fallbackPolling = e.fallbackPolling.toLowerCase())
            }
            return n
          }, "_parseTsconfig"),
          me = r((e, t) => {
          ...
          xe = r((e) => {
            if (e.strict) {
              ...
              for (const i of t) void 0 === e[i] && (e[i] = !0)
            }
            if (
              (e.composite &&
                (null != e.declaration || (e.declaration = !0),
                null != e.incremental || (e.incremental = !0)),
              e.target)
            ) {
              ...
              "es2015" === t && (t = "es6"),
                (e.target = t),
                "esnext" === t &&
                  (null != e.module || (e.module = "es6"),
                  null != e.useDefineForClassFields ||
                    (e.useDefineForClassFields = !0)),
                ("es6" === t ||
                  "es2016" === t ||
                  "es2017" === t ||
                  "es2018" === t ||
            ...
            if (e.module) {
              ...
              if (
                ...
                ("es6" === t ||
                  ...
                  "umd" === t ||
                  "amd" === t) &&
                  (null != e.moduleResolution ||
                    (e.moduleResolution = "classic")),
                "system" === t &&
                  (null != e.allowSyntheticDefaultImports ||
                    (e.allowSyntheticDefaultImports = !0)),
                ("node16" === t ||
                  "node18" === t ||
                  "node20" === t ||
                  "nodenext" === t ||
                  "preserve" === t) &&
                  (null != e.esModuleInterop || (e.esModuleInterop = !0),
                  null != e.allowSyntheticDefaultImports ||
                    (e.allowSyntheticDefaultImports = !0)),
                ("node16" === t ||
                  "node18" === t ||
                  "node20" === t ||
                  "nodenext" === t) &&
                  (null != e.moduleDetection || (e.moduleDetection = "force")),
                "node16" === t &&
                  (null != e.target || (e.target = "es2022"),
                  null != e.moduleResolution ||
                    (e.moduleResolution = "node16")),
                "node18" === t &&
                  (null != e.target || (e.target = "es2022"),
                  null != e.moduleResolution ||
                    (e.moduleResolution = "node16")),
                "node20" === t &&
                  (null != e.target || (e.target = "es2023"),
                  null != e.moduleResolution || (e.moduleResolution = "node16"),
                  null != e.resolveJsonModule || (e.resolveJsonModule = !0)),
                "nodenext" === t &&
                  (null != e.target || (e.target = "esnext"),
                  null != e.moduleResolution ||
              ...
              "preserve" === t &&
                (null != e.moduleResolution || (e.moduleResolution = "bundler"))
            }
            if (e.moduleResolution) {
              let t = e.moduleResolution.toLowerCase()
              "node" === t && (t = "node10"),
                (e.moduleResolution = t),
                ("node16" === t || "nodenext" === t || "bundler" === t) &&
                  (null != e.resolvePackageJsonExports ||
                    (e.resolvePackageJsonExports = !0),
                  null != e.resolvePackageJsonImports ||
                    (e.resolvePackageJsonImports = !0)),
                "bundler" === t &&
                  (null != e.allowSyntheticDefaultImports ||
                    (e.allowSyntheticDefaultImports = !0),
                  null != e.resolveJsonModule || (e.resolveJsonModule = !0))
            }
            e.jsx && (e.jsx = e.jsx.toLowerCase()),
              e.moduleDetection &&
                (e.moduleDetection = e.moduleDetection.toLowerCase()),
              e.importsNotUsedAsValues &&
                (e.importsNotUsedAsValues =
                  e.importsNotUsedAsValues.toLowerCase()),
              e.newLine && (e.newLine = e.newLine.toLowerCase()),
              e.esModuleInterop &&
                (null != e.allowSyntheticDefaultImports ||
                  (e.allowSyntheticDefaultImports = !0)),
              e.verbatimModuleSyntax &&
                (null != e.isolatedModules || (e.isolatedModules = !0),
                null != e.preserveConstEnums || (e.preserveConstEnums = !0)),
              e.isolatedModules &&
                (null != e.preserveConstEnums || (e.preserveConstEnums = !0)),
              e.rewriteRelativeImportExtensions &&
                (null != e.allowImportingTsExtensions ||
                  (e.allowImportingTsExtensions = !0)),
              e.lib && (e.lib = e.lib.map((e) => e.toLowerCase())),
              e.checkJs && (null != e.allowJs || (e.allowJs = !0))
        ...
        var ye = Object.defineProperty,
          _e = r((e, t) => ye(e, "name", { value: t, configurable: !0 }), "s")
        const Ee = _e((e) => {
            let t = ""
          ...
          Ce = _e((e, t = E, i = !0) => {
            ...
            const c = Ee(n)
            return (
              (a = c !== n && t.existsSync(n) ? !t.existsSync(c) : we(n, e, t)),
              i && be.set(n, a),
              a
            )
          }, "isFsCaseSensitive"),
          ...
          Te = r((e) => {
            ...
            return (
              null != e &&
                e.allowJs &&
                (t.push(".js", ".jsx"), i.push(".cjs"), n.push(".mjs")),
              [...t, ...i, ...n]
            )
          ...
          Ae = r(
            (e) => e.replaceAll(/[.*+?^${}()|[\]\\]/g, String.raw`\$&`),
            "escapeForRegexp",
          ),
          Le = `(?!(${["node_modules", "bower_components", "jspm_packages"].join("|")})(/|$))`,
          Oe = /(?:^|\/)[^.*?]+$/,
          De = "**/*",
          Ve = "[^/]",
          Ue = "[^./]",
          Me = "win32" === process.platform,
          je = r(({ config: e, path: t }, i = Ce()) => {
            if ("extends" in e)
              throw new Error(
                "tsconfig#extends must be resolved. Use getTsconfig or parseTsconfig to resolve it.",
              )
            if (!a.isAbsolute(t))
              throw new Error("The tsconfig path must be absolute")
            Me && (t = h(t))
            const n = a.dirname(t),
              { files: c, include: l, exclude: y, compilerOptions: E } = e,
              w = r((e) => (a.isAbsolute(e) ? e : Se(n, e)), "resolvePattern"),
              C = null == c ? void 0 : c.map(w),
              S = Te(E),
              I = i ? "" : "i",
              N = (y || Re(E)).map((e) => {
                const t = w(e),
              ...
              j = O
                ? O.map((e) => {
                    ...
                    Oe.test(t) && (t = Se(t, De))
                    const i = Ae(t)
                      .replaceAll(String.raw`/\*\*`, `(/${Le}${Ue}${Ve}*)*?`)
                      .replaceAll(/(\/)?\\\*/g, (e, t) => {
                        const i = `(${Ue}|(\\.(?!min\\.js$))?)*`
                        return t ? `/${Le}${Ue}${i}` : i
                      })
          ...
          Be = r(
            (e = process.cwd(), t = "tsconfig.json", i = new Map(), n = !1) => {
              var a
              return n
                ? null == (a = Fe(e, t, i))
                  ? void 0
          ...
          He = r(
            ({ prefix: e, suffix: t }, i) => i.startsWith(e) && i.endsWith(t),
            "isPatternMatch",
          ),
          ze = r(
            (e, t, i) =>
              Object.entries(e).map(
                ([e, n]) => (
                  Ge(e, `Pattern '${e}' can have at most one '*' character.`),
                  {
                    pattern: Ke(e),
                    substitutions: n.map((n) => {
                      if (
                        (Ge(
                          n,
                          `Substitution '${n}' in pattern '${e}' can have at most one '*' character.`,
                        ),
                        !t && !F.test(n) && !a.isAbsolute(n))
                      )
                        throw new Error(
          ...
          Je = r((e) => {
            ...
            if (!i && !n) return null
            const c = te in t && t[te],
              l = a.resolve(a.dirname(e.path), i || c || "."),
              y = n ? ze(n, i, l) : []
            return (e) => {
              if (F.test(e)) return []
              const t = []
              ...
              for (const i of t)
                He(i.pattern, e) &&
                  i.pattern.prefix.length > c &&
                  ((c = i.pattern.prefix.length), (n = i))
              if (!n) return i ? [h(a.join(l, e))] : []
              const E = e.slice(
                n.pattern.prefix.length,
                e.length - n.pattern.suffix.length,
              )
              return n.substitutions.map((e) => h(e.replace("*", E)))
            }
          }, "createPathsMatcher")
        ;(t.createPathsMatcher = Je), (t.getTsconfig = $e)
      },
      "./node_modules/.pnpm/resolve-pkg-maps@1.0.0/node_modules/resolve-pkg-maps/dist/index.cjs"(
        e,
        t,
        ...
        const d = (e) => null !== e && "object" == typeof e,
          s = (e, t) => Object.assign(new Error(`[${e}]: ${t}`), { code: e }),
          i = "ERR_INVALID_PACKAGE_CONFIG",
          n = "ERR_INVALID_PACKAGE_TARGET",
          a = /^\d+$/,
          c = /^(\.{1,2}|node_modules)$/i,
          l = /\/|\\/
        var y,
          E = (((y = E || {}).Export = "exports"), (y.Import = "imports"), y)
        const f = (e, t, y, E, w) => {
            if (null == t) return []
            if ("string" == typeof t) {
              const [i, ...a] = t.split(l)
              if (".." === i || a.some((e) => c.test(e)))
                throw s(
                  n,
                  `Invalid "${e}" target "${t}" defined in the package config`,
                )
            ...
            if (d(t)) {
              for (const n of Object.keys(t)) {
                if (a.test(n))
                  throw s(i, "Cannot contain numeric property keys")
        ...
        ;(t.resolveExports = (e, t, a) => {
          ...
          ;(t = "" === t ? "." : `./${t}`),
            ("string" == typeof e ||
              ...
              (e = { ".": e })
          const [c, l] = A(e, t),
            y = f(E.Export, e[c], t, a, l)
          if (0 === y.length)
            throw s(
              "ERR_PACKAGE_PATH_NOT_EXPORTED",
              "." === t
                ? 'No "exports" main defined'
                : `Package subpath '${t}' is not defined by "exports"`,
            )
          for (const e of y)
            if (!e.startsWith("./") && !C.test(e))
              throw s(
                n,
                `Invalid "exports" target "${e}" defined in the package config`,
              )
          return y
        }),
          (t.resolveImports = (e, t, i) => {
            ...
            const [n, a] = A(e, t),
              c = f(E.Import, e[n], t, i, a)
            if (0 === c.length)
              throw s(
                "ERR_PACKAGE_IMPORT_NOT_DEFINED",
                `Package import specifier "${t}" is not defined in package`,
              )
            return c
          })
      },
  ...
  ;(() => {
                ...
                (e < 97
                  ...
                  : e < 123 ||
                    (e <= 65535
                      ...
                      : !1 !== i &&
                        (isInAstralSet(e, n) || isInAstralSet(e, t))))))
    }
    ...
    function binop(e, t) {
      return new acorn_TokenType(e, { beforeExpr: !0, binop: t })
    }
    var S = { beforeExpr: !0 },
      I = { startsExpr: !0 },
      N = {}
    ...
    var O = {
        ...
        bracketL: new acorn_TokenType("[", { beforeExpr: !0, startsExpr: !0 }),
        bracketR: new acorn_TokenType("]"),
        braceL: new acorn_TokenType("{", { beforeExpr: !0, startsExpr: !0 }),
        braceR: new acorn_TokenType("}"),
        parenL: new acorn_TokenType("(", { beforeExpr: !0, startsExpr: !0 }),
        ...
        eq: new acorn_TokenType("=", { beforeExpr: !0, isAssign: !0 }),
        assign: new acorn_TokenType("_=", { beforeExpr: !0, isAssign: !0 }),
    ...
    function nextLineBreak(e, t, i) {
      ...
      for (var n = t; n < i; n++) {
        ...
        if (isNewLine(a))
          return n < i - 1 && 13 === a && 10 === e.charCodeAt(n + 1)
            ? n + 2
            : n + 1
      }
      return -1
        ...
        (Y(t.onComment) &&
          (t.onComment = (function (e, t) {
            return function (i, n, a, c, l, y) {
              var E = { type: i ? "Block" : "Line", value: n, start: a, end: c }
              e.locations && (E.loc = new acorn_SourceLocation(this, l, y)),
                e.ranges && (E.range = [a, c]),
                t.push(E)
            }
          })(t, t.onComment)),
        "commonjs" === t.sourceType && t.allowAwaitOutsideFunction)
      )
        throw new Error(
    ...
    var acorn_Parser = function (e, t, i) {
        ...
        ;(this.reservedWordsStrict = wordsRegexp(a)),
          ...
          (this.scopeStack = []),
          this.enterScope("commonjs" === this.options.sourceType ? 2 : 1),
      ...
      (re.allowReturn.get = function () {
        return (
          ...
          !!(
            ...
            1 & this.currentVarScope().flags
          )
        )
      }),
      (re.allowSuper.get = function () {
        return (
          (64 & this.currentThisScope().flags) > 0 ||
    ...
    oe.parseTopLevel = function (e) {
      ...
      if (this.inModule)
        for (
          var n = 0, a = Object.keys(this.undefinedExports);
          n < a.length;
          n += 1
        ) {
          var c = a[n]
          this.raiseRecoverable(
            this.undefinedExports[c].start,
            "Export '" + c + "' is not defined",
          )
        }
      return (
        ...
        this.next(),
        (e.sourceType =
          "commonjs" === this.options.sourceType
            ? "script"
    ...
    ;(oe.isLet = function (e) {
      ...
      (oe.isAsyncFunction = function () {
        ...
        var e,
          ...
          i = this.pos + t[0].length
        return !(
          j.test(this.input.slice(this.pos, i)) ||
          "function" !== this.input.slice(i, i + 8) ||
          (i + 8 !== this.input.length &&
            (isIdentifierChar((e = this.fullCharCodeAt(i + 8))) || 92 === e))
        )
      }),
      (oe.isUsingKeyword = function (e, t) {
        ...
        $.lastIndex = this.pos
        var i = $.exec(this.input),
          n = this.pos + i[0].length
        if (j.test(this.input.slice(this.pos, n))) return !1
        if (e) {
          var a,
            c = n + 5
          if (
            "using" !== this.input.slice(n, c) ||
            c === this.input.length ||
            isIdentifierChar((a = this.fullCharCodeAt(c))) ||
            92 === a
          )
            return !1
          $.lastIndex = c
          var l = $.exec(this.input)
          if (((n = c + l[0].length), l && j.test(this.input.slice(c, n))))
            return !1
        }
      ...
      (oe.parseStatement = function (e, t, i) {
        ...
        switch ((this.isLet(e) && ((a = O._var), (n = "let")), a)) {
          case O._break:
          case O._continue:
            return this.parseBreakContinueStatement(c, a.keyword)
          case O._debugger:
          ...
          case O._function:
            return (
              e &&
                ...
                this.unexpected(),
              this.parseFunctionStatement(c, !1, !e)
            )
          case O._class:
            return e && this.unexpected(), this.parseClass(c, !0)
          case O._if:
          ...
          case O._import:
            ...
            return (
              ...
              a === O._import ? this.parseImport(c) : this.parseExport(c, i)
            )
          default:
            if (this.isAsyncFunction())
              return (
                e && this.unexpected(),
                this.next(),
                this.parseFunctionStatement(c, !0, !e)
              )
            var w = this.isAwaitUsing(!1)
              ? "await using"
              : this.isUsing(!1)
                ? "using"
                : null
            ...
            return a === O.name && "Identifier" === S.type && this.eat(O.colon)
              ? this.parseLabeledStatement(c, C, S, e)
              : this.parseExpressionStatement(c, S)
        }
      }),
      ...
      (oe.parseForStatement = function (e) {
        ...
        if (this.type === O._var || this.type === O._const || i) {
          ...
          return (
            ...
            this.parseForAfterInit(e, n, t)
          )
        }
        var c = this.isContextual("let"),
          l = !1,
          y = this.isUsing(!0)
            ? "using"
            : this.isAwaitUsing(!0)
        ...
        if (y) {
          ...
          return (
            ...
            this.parseForAfterInit(e, E, t)
          )
        }
        var w = this.containsEsc,
          C = new acorn_DestructuringErrors(),
          S = this.start,
          I =
            t > -1
              ? this.parseExprSubscripts(C, "await")
              : this.parseExpression(!0, C)
      ...
      (oe.parseSwitchStatement = function (e) {
        ...
        this.next(),
          ...
          this.labels.push(he),
          this.enterScope(1024)
        for (var i = !1; this.type !== O.braceR; )
    ...
    ;(oe.parseCatchClauseParam = function () {
      ...
      (oe.parseLabeledStatement = function (e, t, i, n) {
        for (var a = 0, c = this.labels; a < c.length; a += 1) {
          c[a].name === t &&
    ...
    ;(oe.parseFunction = function (e, t, i, n, a) {
      this.initFunction(e),
        (this.options.ecmaVersion >= 9 ||
          ...
          (this.type === O.star && t & ue && this.unexpected(),
          (e.generator = this.eat(O.star))),
        this.options.ecmaVersion >= 8 && (e.async = !!n),
        t & pe &&
          ((e.id = 4 & t && this.type !== O.name ? null : this.parseIdent()),
          !e.id ||
            t & ue ||
      ...
      return (
        ...
        t & pe || (e.id = this.type === O.name ? this.parseIdent() : null),
      ...
      (oe.parseClass = function (e, t) {
        ...
        for (a.body = [], this.expect(O.braceL); this.type !== O.braceR; ) {
          ...
          l &&
            (a.body.push(l),
            "MethodDefinition" === l.type && "constructor" === l.kind
              ? (c &&
                  this.raiseRecoverable(
                    l.start,
                ...
                (c = !0))
              : l.key &&
                "PrivateIdentifier" === l.key.type &&
                isPrivateNameConflicted(n, l) &&
                this.raiseRecoverable(
                  l.key.start,
        ...
        if (
          ...
          !n &&
            ...
            this.canInsertSemicolon()
              ? (n = "async")
              : (c = !0)),
          !n && (t >= 9 || !c) && this.eat(O.star) && (a = !0),
          !n && !c && !a)
        ) {
          var E = this.value
          ;(this.eatContextual("get") || this.eatContextual("set")) &&
            (this.isClassElementNameStart() ? (l = E) : (n = E))
        }
        if (
          (n
            ? ((i.computed = !1),
          ...
          t < 13 || this.type === O.parenL || "method" !== l || a || c)
        ) {
          var w = !i.static && checkKeyName(i, "constructor"),
            C = w && e
          w &&
            "method" !== l &&
            this.raise(i.key.start, "Constructor can't have get/set modifier"),
            (i.kind = w ? "constructor" : l),
            this.parseClassMethod(i, a, c, C)
      ...
      (oe.parseClassMethod = function (e, t, i, n) {
        ...
        return (
          "get" === e.kind &&
            0 !== c.params.length &&
            this.raiseRecoverable(c.start, "getter should have no params"),
          "set" === e.kind &&
            1 !== c.params.length &&
            this.raiseRecoverable(
              c.start,
        ...
        if (this.options.checkPrivateFields)
          for (
            var n = this.privateNameStack.length,
              a = 0 === n ? null : this.privateNameStack[n - 1],
              c = 0;
            c < i.length;
            ++c
          ) {
      ...
      (oe.parseExportDefaultDeclaration = function () {
        ...
        if (this.type === O._function || (e = this.isAsyncFunction())) {
          var t = this.startNode()
          return (
            this.next(), e && this.next(), this.parseFunction(t, 4 | pe, !1, e)
          )
        }
      ...
      (oe.checkExport = function (e, t, i) {
        e &&
          ...
          H(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"),
          (e[t] = !0))
      }),
      (oe.checkPatternExport = function (e, t) {
        ...
        if ("Identifier" === i) this.checkExport(e, t, t.start)
          ...
          for (var l = 0, y = t.elements; l < y.length; l += 1) {
            var E = y[l]
          ...
          "Property" === i
            ...
            : "AssignmentPattern" === i
              ...
              : "RestElement" === i && this.checkPatternExport(e, t.argument)
      }),
      ...
      (oe.parseImport = function (e) {
        return (
          this.next(),
          this.type === O.string
            ? ((e.specifiers = le), (e.source = this.parseExprAtom()))
      ...
      (oe.parseWithClause = function () {
        ...
        for (var t = {}, i = !0; !this.eat(O.braceR); ) {
          ...
          var n = this.parseImportAttribute(),
            a = "Identifier" === n.key.type ? n.key.name : n.key.value
          H(t, a) &&
            this.raiseRecoverable(
              n.key.start,
    ...
    ;(de.toAssignable = function (e, t, i) {
        ...
        switch (e.type) {
          ...
          case "ObjectExpression":
            ...
            for (var n = 0, a = e.properties; n < a.length; n += 1) {
              var c = a[n]
              this.toAssignable(c, t),
                "RestElement" !== c.type ||
                  ("ArrayPattern" !== c.argument.type &&
                    "ObjectPattern" !== c.argument.type) ||
                  this.raise(c.argument.start, "Unexpected token")
            }
            break
          case "Property":
            "init" !== e.kind &&
      ...
      (de.toAssignableList = function (e, t) {
        ...
        if (i) {
          ...
          6 === this.options.ecmaVersion &&
            ...
            c &&
            "RestElement" === c.type &&
            "Identifier" !== c.argument.type &&
            this.unexpected(c.argument.start)
        }
        return e
      }),
      ...
      (de.parseBindingList = function (e, t, i, n) {
        for (var a = [], c = !0; !this.eat(e); )
          if ((c ? (c = !1) : this.expect(O.comma), t && this.type === O.comma))
            a.push(null)
          else {
    ...
    ;(me.initialContext = function () {
      ...
      (me.braceIsBlock = function (e) {
        ...
        return (
          t === fe.f_expr ||
          t === fe.f_stat ||
          (e !== O.colon || (t !== fe.b_stat && t !== fe.b_expr)
      ...
      (O._function.updateContext = O._class.updateContext =
        function (e) {
          !e.beforeExpr ||
          e === O._else ||
          (e === O.semi && this.curContext() !== fe.p_stat) ||
          (e === O._return &&
            j.test(this.input.slice(this.lastTokEnd, this.start))) ||
          ((e === O.colon || e === O.braceL) && this.curContext() === fe.b_stat)
    ...
    function isLocalVariableAccess(e) {
      return (
        ...
        ("ParenthesizedExpression" === e.type &&
          isLocalVariableAccess(e.expression))
      )
    }
    function isPrivateFieldAccess(e) {
      return (
        ...
        ("ParenthesizedExpression" === e.type &&
          isPrivateFieldAccess(e.expression))
      )
    }
    ;(ge.checkPropClash = function (e, t, i) {
      if (
        ...
        if (this.options.ecmaVersion >= 6)
          "__proto__" === n &&
            ...
            (t.proto &&
              (i
                ? i.doubleProto < 0 && (i.doubleProto = a.start)
                : this.raiseRecoverable(
                    a.start,
          ...
          if (l)
            ("init" === c
              ? (this.strict && l.init) || l.get || l.set
              : l.init || l[c]) &&
              this.raiseRecoverable(a.start, "Redefinition of property")
          else l = t[n] = { init: !1, get: !1, set: !1 }
          l[c] = !0
        }
      }
    }),
      (ge.parseExpression = function (e, t) {
        ...
        if (this.type === O.comma) {
          ...
          for (c.expressions = [a]; this.eat(O.comma); )
      ...
      (ge.parseMaybeAssign = function (e, t, i) {
        ...
        t
          ...
          : ((t = new acorn_DestructuringErrors()), (n = !0))
        var y = this.start,
          E = this.startLoc
        ...
        if ((i && (w = i.call(this, w, y, E)), this.type.isAssign)) {
          ...
          return (
            ...
            this.type === O.eq && (w = this.toAssignable(w, !1, t)),
            n || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1),
            t.shorthandAssign >= w.start && (t.shorthandAssign = -1),
            this.type === O.eq
              ? this.checkLValPattern(w)
              : this.checkLValSimple(w),
            (C.left = w),
            this.next(),
      ...
      (ge.parseMaybeConditional = function (e, t) {
        ...
        if (this.eat(O.question)) {
          ...
          return (
            (c.test = a),
            (c.consequent = this.parseMaybeAssign()),
            this.expect(O.colon),
            (c.alternate = this.parseMaybeAssign(e)),
      ...
      (ge.parseExprOps = function (e, t) {
        ...
        return this.checkExpressionErrors(t) ||
          ...
          ? a
          : this.parseExprOp(a, i, n, -1, e)
      }),
      (ge.parseExprOp = function (e, t, i, n, a) {
        var c = this.type.binop
        if (null != c && (!a || this.type !== O._in) && c > n) {
          var l = this.type === O.logicalOR || this.type === O.logicalAND,
            y = this.type === O.coalesce
          ...
          var w = this.start,
            ...
            I = this.buildBinary(t, i, e, S, E, l || y)
          return (
            ((l && this.type === O.coalesce) ||
              (y &&
      ...
      (ge.buildBinary = function (e, t, i, n, a, c) {
        ...
        return (
          ...
          (l.operator = a),
          (l.right = n),
          this.finishNode(l, c ? "LogicalExpression" : "BinaryExpression")
        )
      }),
      (ge.parseMaybeUnary = function (e, t, i, n) {
        ...
        if (this.isContextual("await") && this.canAwait)
          ...
          var y = this.startNode(),
            E = this.type === O.incDec
          ;(y.operator = this.value),
            (y.prefix = !0),
            this.next(),
            (y.argument = this.parseMaybeUnary(null, !0, E, n)),
            this.checkExpressionErrors(e, !0),
            E
              ? this.checkLValSimple(y.argument)
              : this.strict &&
                  "delete" === y.operator &&
                  isLocalVariableAccess(y.argument)
                ? this.raiseRecoverable(
                    y.start,
                    "Deleting local variable in strict mode",
                  )
                : "delete" === y.operator && isPrivateFieldAccess(y.argument)
                  ? this.raiseRecoverable(
                      y.start,
                      "Private fields can not be deleted",
                    )
                  : (t = !0),
            (a = this.finishNode(y, E ? "UpdateExpression" : "UnaryExpression"))
        } else if (t || this.type !== O.privateId) {
          if (
            ((a = this.parseExprSubscripts(e, n)),
            this.checkExpressionErrors(e))
          )
            return a
          for (; this.type.postfix && !this.canInsertSemicolon(); ) {
            var w = this.startNodeAt(c, l)
            ;(w.operator = this.value),
              (w.prefix = !1),
              (w.argument = a),
              this.checkLValSimple(a),
              this.next(),
              (a = this.finishNode(w, "UpdateExpression"))
          }
        } else
      ...
      (ge.parseExprSubscripts = function (e, t) {
        ...
        return (
          e &&
            "MemberExpression" === c.type &&
            (e.parenthesizedAssign >= c.start && (e.parenthesizedAssign = -1),
            e.parenthesizedBind >= c.start && (e.parenthesizedBind = -1),
            e.trailingComma >= c.start && (e.trailingComma = -1)),
          c
        )
      }),
      (ge.parseSubscripts = function (e, t, i, n, a) {
        for (
          ...
          if (
            (y.optional && (l = !0),
            y === e || "ArrowFunctionExpression" === y.type)
          ) {
            if (l) {
      ...
      (ge.parseSubscript = function (e, t, i, n, a, c, l) {
        ...
        if (
          w ||
          (E && this.type !== O.parenL && this.type !== O.backQuote) ||
          this.eat(O.dot)
        ) {
          var C = this.startNodeAt(t, i)
          ;(C.object = e),
            w
              ? ((C.property = this.parseExpression()), this.expect(O.bracketR))
              : this.type === O.privateId && "Super" !== e.type
          ...
          var S = new acorn_DestructuringErrors(),
            I = this.yieldPos,
            N = this.awaitPos,
          ...
          if (a && !E && this.shouldParseAsyncArrow())
            return (
              ...
              this.parseSubscriptAsyncArrow(t, i, F, l)
            )
          this.checkExpressionErrors(S, !0),
            (this.yieldPos = I || this.yieldPos),
            (this.awaitPos = N || this.awaitPos),
            (this.awaitIdentPos = j || this.awaitIdentPos)
          var B = this.startNodeAt(t, i)
          ;(B.callee = e),
            (B.arguments = F),
            y && (B.optional = E),
            (e = this.finishNode(B, "CallExpression"))
          ...
          ;($.tag = e),
            ($.quasi = this.parseTemplate({ isTagged: !0 })),
            (e = this.finishNode($, "TaggedTemplateExpression"))
        }
        return e
      }),
      (ge.parseExprAtom = function (e, t, i) {
        ...
        switch (this.type) {
          ...
          case O.name:
            ...
            if (
              ...
              return (
                ...
                this.parseFunction(this.startNodeAt(c, l), 0, !1, !0, t)
              )
            if (a && !this.canInsertSemicolon()) {
              if (this.eat(O.arrow))
                return this.parseArrowExpression(
                  this.startNodeAt(c, l),
                  [E],
                  !1,
                  t,
                )
              if (
                ...
                return (
                  ...
                  (!this.canInsertSemicolon() && this.eat(O.arrow)) ||
                    this.unexpected(),
                  this.parseArrowExpression(this.startNodeAt(c, l), [E], !0, t)
                )
            }
            return E
          case O.regexp:
            var w = this.value
            return (
              ((n = this.parseLiteral(w.value)).regex = {
                pattern: w.pattern,
                flags: w.flags,
              }),
              n
          ...
          case O.parenL:
            var C = this.start,
              S = this.parseParenAndDistinguishExpression(a, t)
            return (
              e &&
          ...
          case O.bracketL:
            return (
              (n = this.startNode()),
              this.next(),
              (n.elements = this.parseExprList(O.bracketR, !0, !0, e)),
              this.finishNode(n, "ArrayExpression")
            )
          case O.braceL:
            return this.overrideContext(fe.b_expr), this.parseObj(!1, e)
          case O._function:
      ...
      (ge.parseParenAndDistinguishExpression = function (e, t) {
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          var l,
            ...
            C = !0,
            S = !1,
            I = new acorn_DestructuringErrors(),
            N = this.yieldPos,
            j = this.awaitPos
          for (this.yieldPos = 0, this.awaitPos = 0; this.type !== O.parenR; ) {
            if (
              (C ? (C = !1) : this.expect(O.comma),
              c && this.afterTrailingComma(O.parenR, !0))
            ) {
              S = !0
              break
            }
            if (this.type === O.ellipsis) {
              ;(l = this.start),
                w.push(this.parseParenItem(this.parseRestBinding())),
                this.type === O.comma &&
                  this.raiseRecoverable(
                    this.start,
                    "Comma is not permitted after the rest element",
          ...
          var F = this.lastTokEnd,
            B = this.lastTokEndLoc
          if (
            (this.expect(O.parenR),
            e && this.shouldParseArrow(w) && this.eat(O.arrow))
          )
            return (
              this.checkPatternErrors(I, !1),
              this.checkYieldAwaitInDefaultParams(),
              (this.yieldPos = N),
              (this.awaitPos = j),
              this.parseParenArrowList(n, a, w, t)
            )
          ;(w.length && !S) || this.unexpected(this.lastTokStart),
            l && this.unexpected(l),
            this.checkExpressionErrors(I, !0),
            (this.yieldPos = N || this.yieldPos),
            (this.awaitPos = j || this.awaitPos),
            w.length > 1
              ? (((i = this.startNodeAt(y, E)).expressions = w),
                this.finishNodeAt(i, "SequenceExpression", F, B))
              : (i = w[0])
    ...
    ;(ge.parseNew = function () {
      ...
      (ge.parseTemplate = function (e) {
        ...
        for (i.quasis = [n]; !n.tail; )
          this.type === O.eof &&
            ...
            i.quasis.push((n = this.parseTemplateElement({ isTagged: t })))
      ...
      (ge.parseProperty = function (e, t) {
        ...
        if (this.options.ecmaVersion >= 9 && this.eat(O.ellipsis))
          return e
            ...
            : ((l.argument = this.parseMaybeAssign(!1, t)),
              this.type === O.comma &&
                t &&
                t.trailingComma < 0 &&
        ...
        return (
          ...
          !e && !y && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(l)
            ? ((n = !0),
              (i = this.options.ecmaVersion >= 9 && this.eat(O.star)),
              this.parsePropertyName(l))
            : (n = !1),
          this.parsePropertyValue(l, e, i, n, a, c, t, y),
      ...
      (ge.parsePropertyValue = function (e, t, i, n, a, c, l, y) {
        ;(i || n) && this.type === O.colon && this.unexpected(),
          this.eat(O.colon)
            ? ((e.value = t
              ...
              : t ||
                ...
                ? this.options.ecmaVersion >= 6 &&
                  ...
                  ? ((i || n) && this.unexpected(),
                    ...
                    (e.shorthand = !0))
                  : this.unexpected()
                : ((i || n) && this.unexpected(), this.parseGetterSetter(e))
      }),
      ...
      (ge.parseMethod = function (e, t, i) {
        ...
        return (
          ...
          (this.awaitPos = 0),
          (this.awaitIdentPos = 0),
          this.enterScope(64 | functionFlags(t, n.generator) | (i ? 128 : 0)),
          this.expect(O.parenL),
      ...
      (ge.parseFunctionBody = function (e, t, i, n) {
        ...
        if (a)
          ...
          ;(this.labels = []),
            ...
            this.checkParams(
              e,
              !c && !l && !t && !i && this.isSimpleParamList(e.params),
            ),
            this.strict && e.id && this.checkLValSimple(e.id, 5),
            (e.body = this.parseBlock(!1, void 0, l && !c)),
            (e.expression = !1),
      ...
      (ge.checkParams = function (e, t) {
        for (
          var i = Object.create(null), n = 0, a = e.params;
          n < a.length;
          n += 1
        ) {
          var c = a[n]
        ...
        for (var a = [], c = !0; !this.eat(e); ) {
          ...
          i && this.type === O.comma
            ...
            : this.type === O.ellipsis
              ? ((l = this.parseSpread(n)),
                n &&
                  this.type === O.comma &&
                  n.trailingComma < 0 &&
                  (n.trailingComma = this.start))
              : (l = this.parseMaybeAssign(!1, n)),
            a.push(l)
        }
        return a
      }),
    ...
    var ye = acorn_Parser.prototype,
      acorn_Scope = function (e) {
        ;(this.flags = e),
          (this.var = []),
          (this.lexical = []),
          (this.functions = [])
      ...
      (ye.declareName = function (e, t, i) {
        ...
        if (2 === t) {
          ...
          ;(n = this.treatFunctionsAsVar
            ...
            : c.lexical.indexOf(e) > -1 || c.var.indexOf(e) > -1),
            c.functions.push(e)
        } else
          for (var l = this.scopeStack.length - 1; l >= 0; --l) {
            var y = this.scopeStack[l]
            if (
              (y.lexical.indexOf(e) > -1 &&
                !(32 & y.flags && y.lexical[0] === e)) ||
              (!this.treatFunctionsAsVarInScope(y) &&
                y.functions.indexOf(e) > -1)
            ) {
              n = !0
              break
            }
            if (
              (y.var.push(e),
              this.inModule && 1 & y.flags && delete this.undefinedExports[e],
              y.flags & se)
            )
              break
          }
    ...
    var acorn_Node = function (e, t, i) {
        ;(this.type = ""),
          (this.start = t),
          (this.end = 0),
          e.options.locations && (this.loc = new acorn_SourceLocation(e, i)),
    ...
    var Ee =
      ...
      be = Ee + " Extended_Pictographic",
      ke = be + " EBase EComp EMod EPres ExtPict",
      we = { 9: Ee, 10: be, 11: be, 12: ke, 13: ke, 14: ke },
      Ce = {
        9: "",
        10: "",
        11: "",
    ...
    var Me = acorn_Parser.prototype,
      acorn_BranchID = function (e, t) {
    ...
    var acorn_RegExpValidationState = function (e) {
      ;(this.parser = e),
        ...
        (this.unicodeProperties =
          De[e.options.ecmaVersion >= 14 ? 14 : e.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
    ...
    ;(acorn_RegExpValidationState.prototype.reset = function (e, t, i) {
      ...
      (acorn_RegExpValidationState.prototype.at = function (e, t) {
        ...
        if ((!t && !this.switchU) || a <= 55295 || a >= 57344 || e + 1 >= n)
          return a
      ...
      (Me.validateRegExpFlags = function (e) {
        for (
          var t = e.validFlags, i = e.flags, n = !1, a = !1, c = 0;
          c < i.length;
          c++
        ) {
          var l = i.charAt(c)
      ...
      (Me.regexp_disjunction = function (e) {
        ...
        for (
          t && (e.branchID = new acorn_BranchID(e.branchID, null)),
              ...
              if (i || n) {
                ...
                if (n) {
                  ...
                  for (var y = 0; y < l.length; y++) {
                    var E = l.charAt(y)
                    ;(l.indexOf(E, y + 1) > -1 || i.indexOf(E) > -1) &&
                      e.raise("Duplicate regular expression modifiers")
                  }
                }
              }
      ...
      (Me.regexp_eatModifiers = function (e) {
        for (
          var t = "", i = 0;
          -1 !== (i = e.current()) && isRegularExpressionModifier(i);
        )
          (t += codePointToString(i)), e.advance()
        return t
      }),
      ...
      (Me.regexp_eatPatternCharacters = function (e) {
        for (
          var t = e.pos, i = 0;
          -1 !== (i = e.current()) && !isSyntaxCharacter(i);
        )
          e.advance()
        return e.pos !== t
      }),
          ...
          if (this.regexp_eatFixedHexDigits(e, 4)) {
            ...
            if (a && c >= 55296 && c <= 56319) {
              ...
              if (
                ...
                if (y >= 56320 && y <= 57343)
                  return (
                    (e.lastIntValue = 1024 * (c - 55296) + (y - 56320) + 65536),
                    !0
                  )
              }
    ...
    ;(Me.regexp_eatCharacterClassEscape = function (e) {
      ...
      if (
        ...
        if (
          ...
          return i && 2 === n && e.raise("Invalid property name"), n
      ...
      (Me.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
        H(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
      ...
      (Me.regexp_eatClassAtom = function (e) {
        ...
        if (e.eat(92)) {
          ...
          if (e.switchU) {
            var i = e.current()
            ;(99 === i || isOctalDigit(i)) && e.raise("Invalid class escape"),
              e.raise("Invalid escape")
          }
          e.pos = t
        }
      ...
      (Me.regexp_eatDecimalDigits = function (e) {
        var t = e.pos,
          i = 0
        for (e.lastIntValue = 0; isDecimalDigit((i = e.current())); )
      ...
      (Me.regexp_eatHexDigits = function (e) {
        var t = e.pos,
          i = 0
        for (e.lastIntValue = 0; isHexDigit((i = e.current())); )
    ...
    var acorn_Token = function (e) {
        ;(this.type = e.type),
          ...
          (this.end = e.end),
          e.options.locations &&
            (this.loc = new acorn_SourceLocation(e, e.startLoc, e.endLoc)),
    ...
    ;(je.next = function (e) {
      !e &&
        ...
        this.options.onToken && this.options.onToken(new acorn_Token(this)),
      ...
      (je.skipBlockComment = function () {
        ...
        if (
          ...
          for (
            var n = void 0, a = t;
            (n = nextLineBreak(this.input, a, this.pos)) > -1;
          )
      ...
      (je.readToken_mult_modulo_exp = function (e) {
        var t = this.input.charCodeAt(this.pos + 1),
          i = 1,
          n = 42 === e ? O.star : O.modulo
        return (
          this.options.ecmaVersion >= 7 &&
            42 === e &&
            42 === t &&
            (++i, (n = O.starstar), (t = this.input.charCodeAt(this.pos + 2))),
          61 === t ? this.finishOp(O.assign, i + 1) : this.finishOp(n, i)
        )
      }),
      (je.readToken_pipe_amp = function (e) {
        ...
        return 61 === t
          ? this.finishOp(O.assign, 2)
          : this.finishOp(124 === e ? O.bitwiseOR : O.bitwiseAND, 1)
      }),
      ...
      (je.readToken_lt_gt = function (e) {
        ...
        return t === e
          ...
          : 33 !== t ||
            ...
            ? (61 === t && (i = 2), this.finishOp(O.relational, i))
      ...
      (je.readToken_eq_excl = function (e) {
        ...
        return 61 === t
          ...
          : 61 === e && 62 === t && this.options.ecmaVersion >= 6
            ...
            : this.finishOp(61 === e ? O.eq : O.prefix, 1)
      }),
      ...
      (je.readRegexp = function () {
        for (var e, t, i = this.pos; ; ) {
          ...
          if (
            (j.test(n) && this.raise(i, "Unterminated regular expression"), e)
          )
            e = !1
          else {
            if ("[" === n) t = !0
        ...
        var y =
          this.regexpState ||
          (this.regexpState = new acorn_RegExpValidationState(this))
        y.reset(i, a, l),
        ...
        return this.finishToken(O.regexp, { pattern: a, flags: l, value: E })
      }),
      (je.readInt = function (e, t, i) {
        ...
        return (
          ...
          this.pos === c || (null != t && this.pos - c !== t) ? null : l
        )
      }),
      (je.readRadixNumber = function (e) {
        ...
        return (
          ...
          110 === this.input.charCodeAt(this.pos)
            ? ((i = stringToBigInt(this.input.slice(t, this.pos))), ++this.pos)
      ...
      (je.readNumber = function (e) {
        ...
        var c,
          l =
            ((c = this.input.slice(t, this.pos)),
            i ? parseInt(c, 8) : parseFloat(c.replace(/_/g, "")))
    ...
    ;(je.tryReadTemplateToken = function () {
          ...
          default:
            if (t >= 48 && t <= 55) {
              var n = this.input.substr(this.pos - 1, 3).match(/^[0-7]+/)[0],
                a = parseInt(n, 8)
              return (
                a > 255 && ((n = n.slice(0, -1)), (a = parseInt(n, 8))),
                (this.pos += n.length - 1),
      ...
      (je.readWord1 = function () {
        this.containsEsc = !1
        for (
          var e = "", t = !0, i = this.pos, n = this.options.ecmaVersion >= 6;
          this.pos < this.input.length;
        ) {
          ...
          if (isIdentifierChar(a, n)) this.pos += a <= 65535 ? 1 : 2
            ...
            ;(t ? isIdentifierStart : isIdentifierChar)(l, n) ||
              this.invalidStringToken(c, "Invalid Unicode escape"),
              (e += codePointToString(l)),
              (i = this.pos)
          }
          t = !1
        }
    ...
    var Be = __webpack_require__("node:module"),
      $e = __webpack_require__("node:fs")
    String.fromCharCode
    const qe = /\/$|\/\?|\/#/,
      Ge = /^\.?\//
    ...
    function dist_joinURL(e, ...t) {
      let i = e || ""
      for (const e of t.filter((e) => isNonEmptyURL(e)))
        if (i) {
    ...
    const He = /^[/\\]{2}/,
      ...
      Je = /^[A-Za-z]:$/,
      Ye = /.(\.[^./]+|\.)$/,
      pathe_M_eThtNZ_normalize = function (e) {
        if (0 === e.length) return "."
        const t = (e = pathe_M_eThtNZ_normalizeWindowsPath(e)).match(He),
          i = isAbsolute(e),
          n = "/" === e[e.length - 1]
        return 0 === (e = normalizeString(e, !i)).length
          ? i
            ? "/"
            : n
              ? "./"
    ...
    const pathe_M_eThtNZ_resolve = function (...e) {
      ...
      for (
        let n =
          (e = e.map((e) => pathe_M_eThtNZ_normalizeWindowsPath(e))).length - 1;
        n >= -1 && !i;
        n--
      ) {
      ...
      return (
        (t = normalizeString(t, !i)),
        i && !isAbsolute(t) ? `/${t}` : t.length > 0 ? t : "."
      )
    }
    ...
    const isAbsolute = function (e) {
      ...
      pathe_M_eThtNZ_dirname = function (e) {
        const t = pathe_M_eThtNZ_normalizeWindowsPath(e)
          .replace(/\/$/, "")
          .split("/")
          .slice(0, -1)
        return (
          1 === t.length && Je.test(t[0]) && (t[0] += "/"),
          t.join("/") || (isAbsolute(e) ? "/" : ".")
        )
      },
      ...
      Qe = require("node:url"),
      Ze = require("node:assert"),
      Xe = require("node:process")
    var et = __webpack_require__("node:path")
    const tt = require("node:v8"),
      it = require("node:util"),
      st = new Set(Be.builtinModules)
        ...
        (function (e, t) {
          ...
          function NodeError(...i) {
            ...
            const c = (function (e, t, i) {
              const n = ct.get(e)
              if (
                (Ze.ok(void 0 !== n, "expected `message` to be found"),
                "function" == typeof n)
              )
                return (
                  Ze.ok(
                    n.length <= t.length,
                    `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${n.length}).`,
                  ),
                  Reflect.apply(n, i, t)
                )
              const a = /%[dfijoOs]/g
              ...
              return (
                Ze.ok(
                  c === t.length,
                  `Code: ${e}; The provided arguments length (${t.length}) does not match the required ones (${c}).`,
                ),
                0 === t.length
                  ? n
                  : (t.unshift(n), Reflect.apply(it.format, null, t))
              )
            })(t, i, a)
            return (
    ...
    function isErrorStackTraceLimitWritable() {
      ...
      return void 0 === e
        ...
        : rt.call(e, "writable") && void 0 !== e.writable
          ? e.writable
          : void 0 !== e.set
    }
    ;(ot.ERR_INVALID_ARG_TYPE = createError(
      "ERR_INVALID_ARG_TYPE",
      (e, t, i) => {
        Ze.ok("string" == typeof e, "'name' must be a string"),
          Array.isArray(t) || (t = [t])
        let n = "The "
        ...
        return (
          a.length > 0 &&
            ((n += `${
              a.length > 1 ? "one of type" : "of type"
            } ${formatList(a, "or")}`),
            (c.length > 0 || l.length > 0) && (n += " or ")),
          c.length > 0 &&
            ((n += `an instance of ${formatList(c, "or")}`),
            l.length > 0 && (n += " or ")),
          l.length > 0 &&
            (l.length > 1
              ? (n += `one of ${formatList(l, "or")}`)
              : (l[0].toLowerCase() !== l[0] && (n += "an "),
                (n += `${l[0]}`))),
          (n += `. Received ${(function (e) {
            if (null == e) return String(e)
            if ("function" == typeof e && e.name) return `function ${e.name}`
            if ("object" == typeof e)
              return e.constructor && e.constructor.name
                ? `an instance of ${e.constructor.name}`
                : `${(0, it.inspect)(e, { depth: -1 })}`
      ...
      (ot.ERR_INVALID_MODULE_SPECIFIER = createError(
        "ERR_INVALID_MODULE_SPECIFIER",
        (e, t, i = void 0) =>
          `Invalid module "${e}" ${t}${i ? ` imported from ${i}` : ""}`,
        TypeError,
      )),
      (ot.ERR_INVALID_PACKAGE_CONFIG = createError(
      ...
      (ot.ERR_INVALID_PACKAGE_TARGET = createError(
        "ERR_INVALID_PACKAGE_TARGET",
        (e, t, i, n = !1, a = void 0) => {
          const c =
            "string" == typeof i && !n && i.length > 0 && !i.startsWith("./")
          return "." === t
            ? (Ze.ok(!1 === n),
              `Invalid "exports" main target ${JSON.stringify(i)} defined in the package config ${e}package.json${
                a ? ` imported from ${a}` : ""
              }${c ? '; targets must start with "./"' : ""}`)
            : `Invalid "${
                n ? "imports" : "exports"
              }" target ${JSON.stringify(i)} defined for '${t}' in the package config ${e}package.json${
                a ? ` imported from ${a}` : ""
              }${c ? '; targets must start with "./"' : ""}`
        },
        Error,
      )),
      (ot.ERR_MODULE_NOT_FOUND = createError(
        "ERR_MODULE_NOT_FOUND",
        (e, t, i = !1) =>
          `Cannot find ${i ? "module" : "package"} '${e}' imported from ${t}`,
        Error,
      )),
      (ot.ERR_NETWORK_IMPORT_DISALLOWED = createError(
        "ERR_NETWORK_IMPORT_DISALLOWED",
        "import of '%s' by %s is not supported: %s",
        Error,
      )),
      (ot.ERR_PACKAGE_IMPORT_NOT_DEFINED = createError(
        "ERR_PACKAGE_IMPORT_NOT_DEFINED",
        (e, t, i) =>
      ...
      (ot.ERR_PACKAGE_PATH_NOT_EXPORTED = createError(
        "ERR_PACKAGE_PATH_NOT_EXPORTED",
        (e, t, i = void 0) =>
          "." === t
      ...
      (ot.ERR_UNSUPPORTED_DIR_IMPORT = createError(
        "ERR_UNSUPPORTED_DIR_IMPORT",
        "Directory import '%s' is not supported resolving ES modules imported from %s",
        Error,
      )),
      (ot.ERR_UNSUPPORTED_RESOLVE_REQUEST = createError(
        "ERR_UNSUPPORTED_RESOLVE_REQUEST",
        'Failed to resolve module specifier "%s" from "%s": Invalid relative URL or base scheme is not hierarchical.',
        TypeError,
      )),
      (ot.ERR_UNKNOWN_FILE_EXTENSION = createError(
        "ERR_UNKNOWN_FILE_EXTENSION",
        (e, t) => `Unknown file extension "${e}" for ${t}`,
        TypeError,
      )),
      (ot.ERR_INVALID_ARG_VALUE = createError(
    ...
    const lt = (function (e) {
      ...
      return (
        t &&
          ((ht = Error.stackTraceLimit),
          (Error.stackTraceLimit = Number.POSITIVE_INFINITY)),
        Error.captureStackTrace(e),
        t && (Error.stackTraceLimit = ht),
        e
      )
    })
    const pt = {}.hasOwnProperty,
      { ERR_INVALID_PACKAGE_CONFIG: ut } = ot,
      dt = new Map()
      ...
      if (void 0 !== a) {
        ...
        try {
          ...
          const a = n,
            c = new ut(
              e,
              (t ? `"${i}" from ` : "") + (0, Qe.fileURLToPath)(t || i),
              a.message,
            )
          throw ((c.cause = a), c)
        }
        ;(c.exists = !0),
          pt.call(n, "name") && "string" == typeof n.name && (c.name = n.name),
          pt.call(n, "main") && "string" == typeof n.main && (c.main = n.main),
          pt.call(n, "exports") && (c.exports = n.exports),
          pt.call(n, "imports") && (c.imports = n.imports),
          !pt.call(n, "type") ||
            ("commonjs" !== n.type && "module" !== n.type) ||
            (c.type = n.type)
      }
      return dt.set(e, c), c
    }
    function getPackageScopeConfig(e) {
      ...
      for (;;) {
        ...
        const n = t
        if (((t = new URL("../package.json", t)), t.pathname === n.pathname))
          break
      }
      return { pjsonPath: (0, Qe.fileURLToPath)(t), exists: !1, type: "none" }
    }
    ...
    const vt = Object.freeze(["node", "import"]),
      yt = new Set(vt)
    ...
    const _t = RegExp.prototype[Symbol.replace],
      {
        ERR_INVALID_MODULE_SPECIFIER: Et,
        ERR_INVALID_PACKAGE_CONFIG: bt,
        ERR_INVALID_PACKAGE_TARGET: kt,
        ERR_MODULE_NOT_FOUND: wt,
        ERR_PACKAGE_IMPORT_NOT_DEFINED: Ct,
        ERR_PACKAGE_PATH_NOT_EXPORTED: St,
        ERR_UNSUPPORTED_DIR_IMPORT: It,
        ERR_UNSUPPORTED_RESOLVE_REQUEST: Tt,
      } = ot,
      Rt = {}.hasOwnProperty,
      At =
    ...
    function emitInvalidSegmentDeprecation(e, t, i, n, a, c, l) {
      ...
      const y = (0, Qe.fileURLToPath)(n),
        E = null !== Vt.exec(l ? e : t)
      Xe.emitWarning(
        `Use of deprecated ${
          E ? "double slash" : "leading or trailing slash matching"
        } resolving "${e}" for module request "${t}" ${
          t === i ? "" : `matched to "${i}" `
        }in the "${
          a ? "imports" : "exports"
        }" field module resolution of the package at ${y}${
          c ? ` imported from ${(0, Qe.fileURLToPath)(c)}` : ""
        }.`,
        "DeprecationWarning",
        "DEP0166",
      )
    ...
    function emitLegacyIndexDeprecation(e, t, i, n) {
      ...
      if ("module" !== a) return
      const c = (0, Qe.fileURLToPath)(e.href),
        l = (0, Qe.fileURLToPath)(new URL(".", t)),
        y = (0, Qe.fileURLToPath)(i)
      n
        ? et.resolve(l, n) !== c &&
          Xe.emitWarning(
            `Package ${l} has a "main" field set to "${n}", excluding the full filename and extension to the resolved file at "${c.slice(l.length)}", imported from ${y}.\n Automatic extension resolution of the "main" field is deprecated for ES modules.`,
            "DeprecationWarning",
            "DEP0151",
          )
        : Xe.emitWarning(
            `No "main" or "exports" field defined in the package.json for ${l} resolving the main entry point "${c.slice(l.length)}", imported from ${y}.\nDefault "index" lookups for the main are deprecated for ES modules.`,
            "DeprecationWarning",
            "DEP0151",
          )
    }
    ...
    function fileExists(e) {
      const t = (0, $e.statSync)(e, { throwIfNoEntry: !1 }),
        i = t ? t.isFile() : void 0
      return null != i && i
    }
    function legacyMainResolve(e, t, i) {
      ...
      if (void 0 !== t.main) {
        ...
        let c = -1
        for (; ++c < a.length && ((n = new URL(a[c], e)), !fileExists(n)); )
          n = void 0
        if (n) return emitLegacyIndexDeprecation(n, e, i, t.main), n
      }
      const a = ["./index.js", "./index.json", "./index.node"]
      let c = -1
      for (; ++c < a.length && ((n = new URL(a[c], e)), !fileExists(n)); )
        n = void 0
      if (n) return emitLegacyIndexDeprecation(n, e, i, t.main), n
      throw new wt(
        (0, Qe.fileURLToPath)(new URL(".", e)),
        (0, Qe.fileURLToPath)(i),
      )
    }
    function exportsNotFound(e, t, i) {
      return new St(
        (0, Qe.fileURLToPath)(new URL(".", t)),
        e,
        i && (0, Qe.fileURLToPath)(i),
      )
    }
      ...
      return (
        (t =
          "object" == typeof t && null !== t
            ...
            : `${t}`),
        new kt(
          (0, Qe.fileURLToPath)(new URL(".", i)),
          e,
          t,
          n,
          a && (0, Qe.fileURLToPath)(a),
        )
      )
    }
    function resolvePackageTargetString(e, t, i, n, a, c, l, y, E) {
      ...
      if (!e.startsWith("./")) {
        if (l && !e.startsWith("../") && !e.startsWith("/")) {
          ...
          if (!i) {
            return packageResolve(c ? _t.call(Nt, e, () => t) : e + t, n, E)
          }
        }
        throw invalidPackageTarget(i, e, n, l, a)
      }
      if (null !== At.exec(e.slice(2))) {
        if (null !== Pt.exec(e.slice(2)))
          throw invalidPackageTarget(i, e, n, l, a)
        if (!y) {
      ...
      if (null !== At.exec(t)) {
        ...
        if (null === Pt.exec(t)) {
          ...
          !(function (e, t, i, n, a) {
            const c = `request is not a valid match in pattern "${t}" for the "${
              n ? "imports" : "exports"
            }" resolution of ${(0, Qe.fileURLToPath)(i)}`
    ...
    function resolvePackageTarget(e, t, i, n, a, c, l, y, E) {
      if ("string" == typeof t)
        return resolvePackageTargetString(t, i, n, e, a, c, l, y, E)
      if (Array.isArray(t)) {
        const w = t
    ...
    function emitTrailingSlashPatternDeprecation(e, t, i) {
      ...
      Dt.has(n + "|" + e) ||
        (Dt.add(n + "|" + e),
        Xe.emitWarning(
          `Use of deprecated trailing slash pattern mapping "${e}" in the "exports" field module resolution of the package at ${n}${
            i ? ` imported from ${(0, Qe.fileURLToPath)(i)}` : ""
    ...
    function packageExportsResolve(e, t, i, n, a) {
      ...
      if (
        ...
        Rt.call(c, t) && !t.includes("*") && !t.endsWith("/"))
      ) {
      ...
      for (; ++w < E.length; ) {
        ...
        if (-1 !== a && t.startsWith(i.slice(0, a))) {
          ...
          t.length >= i.length &&
            t.endsWith(c) &&
            1 === patternKeyCompare(l, i) &&
            i.lastIndexOf("*") === a &&
            ((l = i), (y = t.slice(a, t.length - c.length)))
        }
      }
      if (l) {
        const i = resolvePackageTarget(
          e,
          c[l],
          y,
          l,
    ...
    function packageImportsResolve(e, t, i) {
          ...
          if (Rt.call(c, e) && !e.includes("*")) {
            ...
            for (; ++E < y.length; ) {
              ...
              if (-1 !== i && e.startsWith(t.slice(0, -1))) {
                ...
                e.length >= t.length &&
                  e.endsWith(n) &&
                  1 === patternKeyCompare(a, t) &&
                  t.lastIndexOf("*") === i &&
                  ((a = t), (l = e.slice(i, e.length - n.length)))
              }
            }
            if (a) {
      ...
      throw (function (e, t, i) {
        return new Ct(
          e,
          t && (0, Qe.fileURLToPath)(new URL(".", t)),
          (0, Qe.fileURLToPath)(i),
        )
      })(e, n, t)
    }
    function packageResolve(e, t, i) {
      ...
      const {
          ...
          "@" === e[0] &&
            ((a = !0),
            -1 === i || 0 === e.length ? (n = !1) : (i = e.indexOf("/", i + 1)))
          const c = -1 === i ? e : e.slice(0, i)
          if ((null !== Lt.exec(c) && (n = !1), !n))
            throw new Et(
              e,
      ...
      if (l.exists) {
        ...
        if (l.name === n && void 0 !== l.exports && null !== l.exports)
          return packageExportsResolve(e, a, l, t, i)
      }
      let y,
        E = new URL("./node_modules/" + n + "/package.json", t),
        w = (0, Qe.fileURLToPath)(E)
      do {
        ...
        const C = read(w, { base: t, specifier: e })
        return void 0 !== C.exports && null !== C.exports
          ? packageExportsResolve(E, a, C, t, i)
          : "." === a
            ? legacyMainResolve(E, C, t)
            : new URL(a, E)
    ...
    function moduleResolve(e, t, i, n) {
      ...
      return (
        Ze.ok(void 0 !== l, "expected to be defined"),
        "file:" !== l.protocol
          ? l
          : (function (e, t) {
              if (null !== Ot.exec(e.pathname))
                throw new Et(
                  e.pathname,
              ...
              try {
                ...
                const n = i
                throw (
                  (Object.defineProperty(n, "input", { value: String(e) }),
                  Object.defineProperty(n, "module", { value: String(t) }),
                  n)
                )
              }
    ...
    function _resolve(e, t = {}) {
      ...
      if ((e.startsWith("file://") && (e = fileURLToPath(e)), isAbsolute(e)))
        try {
          if ((0, $e.statSync)(e).isFile()) return pathToFileURL(e)
        } catch (e) {
          if ("ENOENT" !== e?.code) throw e
        }
      const i = t.conditions ? new Set(t.conditions) : Ut,
        n = (Array.isArray(t.url) ? t.url : [t.url]).filter(Boolean).map(
          (e) =>
            new URL(
              (function (e) {
                return (
                  "string" != typeof e && (e = e.toString()),
                  /(?:node|data|http|https|file):/.test(e)
                    ? e
                    : st.has(e)
                      ? "node:" + e
                      : "file://" + encodeURI(normalizeSlash(e))
                )
              })(e.toString()),
            ),
        )
      ...
      for (const e of n)
        "file:" === e.protocol &&
          a.push(
            new URL("./", e),
            new URL(dist_joinURL(e.pathname, "_index.js"), e),
            new URL("node_modules", e),
          )
      let c
      for (const n of a) {
        if (((c = _tryModuleResolve(e, n, i)), c)) break
        for (const a of ["", "/index"]) {
          for (const l of t.extensions || Mt)
            if (((c = _tryModuleResolve(dist_joinURL(e, a) + l, n, i)), c))
              break
          if (c) break
        }
        if (c) break
      ...
      if (!c) {
        const t = new Error(
          `Cannot find module ${e} imported from ${a.join(", ")}`,
        )
    ...
    const $t = new Set(["/", "\\", void 0]),
      qt = Symbol.for("pathe:normalizedAlias"),
      Wt = /[/\\]/
    function normalizeAliases(e) {
      if (e[qt]) return e
      const t = Object.fromEntries(
        Object.entries(e).sort(([e], [t]) =>
          (function (e, t) {
      ...
      for (const e in t)
        for (const i in t)
          i === e ||
            ...
            (t[e]?.startsWith(i) &&
              $t.has(t[e][i.length]) &&
              (t[e] = t[i] + t[e].slice(i.length)))
      return Object.defineProperty(t, qt, { value: !0, enumerable: !1 }), t
    }
    ...
    var Gt = { rE: "2.6.1" }
    const Kt = require("node:crypto")
    var Ht = __webpack_require__.n(Kt)
    const zt = globalThis.process?.env || Object.create(null),
      Jt = globalThis.process || { env: zt },
      Yt = (void 0 !== Jt && Jt.env && Jt.env.NODE_ENV) || void 0,
      Qt = [
    ...
    const Zt = (function () {
        ...
        for (let [e, t] of Qt)
          for (let i of t)
            if ("string" == typeof i ? zt[i] : i()) return { name: e }
        return {}
      })(),
      Xt =
        (Zt.name,
        ...
        [
          ...
          ["EDGEONE_PAGES", "EO_PAGES_CI", { ci: !0 }],
        ])
    const ei = (function () {
        for (let e of Xt)
          if (zt[e[1] || e[0]]) return { name: e[0].toLowerCase(), ...e[2] }
      ...
      ii = !!zt.CI || !1 !== ei.ci,
      si = !!Jt.stdout?.isTTY,
      ri = (zt.DEBUG, "test" === Yt || !!zt.TEST),
      ni =
        ("production" === Yt || zt.MODE,
        "dev" === Yt || "development" === Yt || zt.MODE,
        zt.MINIMAL,
        /^win/i.test(ti)),
      ai =
        (/^linux/i.test(ti),
        /^darwin/i.test(ti),
        !zt.NO_COLOR && (!!zt.FORCE_COLOR || ((si || ni) && zt.TERM)),
        (Jt.versions?.node || "").replace(/^v/, "") || null),
      oi = (Number(ai?.split(".")[0]), !!Jt?.versions?.node),
      ci = "Bun" in globalThis,
      hi = "Deno" in globalThis,
      li = "fastly" in globalThis,
      pi = [
    ...
    const ui = require("node:tty"),
      di = ui?.WriteStream?.prototype?.hasColors?.() ?? !1,
      base_format = (e, t) => {
        if (!di) return (e) => e
        const i = `[${e}m`,
          n = `[${t}m`
        return (e) => {
          ...
          const E = (22 === t ? n : "") + i
          for (; -1 !== c; )
            (l += a.slice(y, c) + E), (y = c + n.length), (c = a.indexOf(n, y))
        ...
        base_format(30, 39),
        base_format(31, 39)),
      mi = base_format(32, 39),
      gi = base_format(33, 39),
      xi = base_format(34, 39),
      vi = (base_format(35, 39), base_format(36, 39)),
      yi = (base_format(37, 39), base_format(90, 39))
    base_format(40, 49),
      base_format(41, 49),
      base_format(42, 49),
      base_format(43, 49),
      ...
      return e.opts.interopDefault
        ? (function (e) {
            ...
            const i = e.default,
              n = typeof i,
              a = null == i,
              c = "object" === n || "function" === n
            if (a && e instanceof Promise) return e
            const l = "function" === n && "function" !== t,
              y = c && !(i instanceof Promise),
              E = new Map()
            return new Proxy(e, {
              get(t, n) {
                ...
                return (
                  "__esModule" === n
                    ...
                    : "default" === n
                      ? (c = a
                          ? e
                          : "function" == typeof i?.default && e.__esModule
                            ? i.default
                            : i)
                      : n in t
                        ? (c = t[n])
    ...
    function jitiResolve(e, t, i) {
      ...
      if (e.resolveTsConfigPaths && !i.skipTsConfigPaths) {
        ...
        for (const t of n) {
          const n = jitiResolve(e, t, { ...i, try: !0, skipTsConfigPaths: !0 })
          if (n) return n
        }
      }
      e.alias &&
        (t = (function (e, t) {
          ...
          for (const [e, n] of Object.entries(t)) {
            ...
            if (utils_hasTrailingSlash(i[t.length]))
              return pathe_M_eThtNZ_join(n, i.slice(e.length))
          }
          return i
        })(t, e.alias))
      ...
      const l = (
        i?.async
          ? [i?.conditions, ["node", "import"], ["node", "require"]]
          : [i?.conditions, ["node", "require"], ["node", "import"]]
      ).filter(Boolean)
      for (const i of l) {
        try {
          n = resolvePathSync(t, {
      ...
      for (const a of e.additionalExts) {
        if (
          ((n =
            tryNativeRequireResolve(e, t + a, c, i) ||
            tryNativeRequireResolve(e, t + "/index" + a, c, i)),
          n)
        )
          return n
        if (
          (ki.test(e.filename) ||
            ki.test(e.parentModule?.filename || "") ||
            bi.test(t)) &&
          ((n = tryNativeRequireResolve(e, t.replace(bi, ".$1t$2"), c, i)), n)
        )
          return n
      }
      if (!i?.try) throw a
    ...
    const wi = require("node:fs/promises"),
      Ci = require("node:perf_hooks"),
      Si = require("node:vm")
    ...
    function jitiRequire(e, t, i) {
      ...
      if (t.startsWith("file:")) t = (0, Qe.fileURLToPath)(t)
        ...
        return (
          debug(e, "[native]", "[data]", "[import]", t),
          nativeImportOrRequire(e, t, !0)
        )
      }
      if (Be.builtinModules.includes(t) || ".pnp.js" === t)
        return nativeImportOrRequire(e, t, i.async)
      if (e.opts.virtualModules && t in e.opts.virtualModules) {
        debug(e, "[virtual]", t)
        const n = e.opts.virtualModules[t]
        return i.async
          ? Promise.resolve(jitiInteropDefault(e, n))
          : jitiInteropDefault(e, n)
      }
        ...
        try {
          ...
          if (
            (debug(
              e,
              "[try-native]",
              i.async && e.nativeImport ? "[import]" : "[require]",
              t,
            ),
            i.async && e.nativeImport)
          )
            return e
              .nativeImport(t)
              .then(
                (i) => (
                  !1 === e.opts.moduleCache && delete e.nativeRequire.cache[t],
                  jitiInteropDefault(e, i)
                ),
              )
              .catch(
                (n) => (
                  debug(
                    e,
                    `[try-native] Using fallback for ${t} because of an error:`,
                    n,
                  ),
                  jitiRequire(
                    { ...e, opts: { ...e.opts, tryNative: !1 } },
                    t,
                    i,
                  )
                ),
      ...
      if (".json" === c) {
        ...
        return (
          t &&
            !("default" in t) &&
            Object.defineProperty(t, "default", { value: t, enumerable: !1 }),
          t
        )
      }
      if (c && !e.opts.extensions.includes(c))
        return (
          debug(
            e,
            "[native]",
            "[unknown]",
            i.async ? "[import]" : "[require]",
            a,
          ),
          nativeImportOrRequire(e, a, i.async)
        )
      if (e.isNativeRe.test(a))
        return (
          debug(e, "[native]", i.async ? "[import]" : "[require]", a),
          nativeImportOrRequire(e, a, i.async)
        )
      ...
      const l = (0, $e.readFileSync)(a, "utf8")
      return eval_evalModule(e, l, {
        id: t,
        filename: a,
        ext: c,
        cache: n,
    ...
    function getCache(e, t, i) {
      ...
      let a =
        `${basename(pathe_M_eThtNZ_dirname(t.filename))}-${(function (e) {
          const t = e.split(Wt).pop()
          if (!t) return
          const i = t.lastIndexOf(".")
          return i <= 0 ? t : t.slice(0, i)
        })(t.filename)}` +
        (e.opts.sourceMaps ? "+map" : "") +
        (t.interopDefault ? ".i" : "") +
        `.${utils_hash(t.filename)}` +
        (t.async ? ".mjs" : ".cjs")
      t.jsx && t.filename.endsWith("x") && (a += "x")
      const c = e.opts.fsCache,
        l = pathe_M_eThtNZ_join(c, a)
      if (!e.opts.rebuildFsCache && (0, $e.existsSync)(l)) {
        const i = (0, $e.readFileSync)(l, "utf8")
        if (i.endsWith(n))
          return debug(e, "[cache]", "[hit]", t.filename, "~>", l), i
      }
      debug(e, "[cache]", "[miss]", t.filename)
      const y = i()
      return (
        y.includes("__JITI_ERROR__") ||
          ((0, $e.writeFileSync)(l, y + n, "utf8"),
          debug(e, "[cache]", "[store]", t.filename, "~>", l)),
        y
      )
    }
    function prepareCacheDir(t) {
      if (
        (!0 === t.opts.fsCache &&
          (t.opts.fsCache = (function (t) {
            const i =
              t.filename &&
              pathe_M_eThtNZ_resolve(t.filename, "../node_modules")
            if (i && (0, $e.existsSync)(i))
              return pathe_M_eThtNZ_join(i, ".cache/jiti")
            let n = (0, e.tmpdir)()
            if (
              process.env.TMPDIR &&
              n === process.cwd() &&
        ...
        try {
          if (
            ((0, $e.mkdirSync)(t.opts.fsCache, { recursive: !0 }),
            !(function (e) {
              try {
          ...
          debug(t, "Error creating cache directory at ", t.opts.fsCache, e),
            (t.opts.fsCache = !1)
        }
    }
    function transform(e, t) {
      let i = getCache(e, t, () => {
        const i = e.opts.transform({
          ...
          babel: {
            ...(e.opts.sourceMaps
              ? { sourceFileName: t.filename, sourceMaps: "inline" }
              : {}),
    ...
    function eval_evalModule(t, i, n = {}) {
      const a =
          ...
          (n.filename
            ? basename(n.filename)
            : `_jitiEval.${n.ext || (n.async ? "mjs" : "js")}`),
        c = n.filename || jitiResolve(t, a, { async: n.async }),
        l = n.ext || extname(c),
        y = n.cache || t.parentCache || {},
        E = /\.[cm]?tsx?$/.test(l),
        w =
          ".mjs" === l ||
          (".js" === l &&
                ...
                for (; e && "." !== e && "/" !== e; ) {
                  ...
                  try {
                    const t = (0, $e.readFileSync)(
                      pathe_M_eThtNZ_join(e, "package.json"),
                      "utf8",
                    )
                    try {
                      return JSON.parse(t)
        ...
        S =
          ...
          (!C &&
            !(w && n.async) &&
            (E || w || t.isTransformRe.test(c) || hasESMSyntax(i))),
        I = Ci.performance.now()
      if (S) {
        i = transform(t, {
          filename: c,
          source: i,
        ...
        if (
          (debug(t, "[native]", n.async ? "[import]" : "[require]", c), n.async)
        )
          return Promise.resolve(nativeImportOrRequire(t, c, n.async)).catch(
            (e) => (
              debug(t, "Native import error:", e),
              debug(t, "[fallback]", c),
              eval_evalModule(t, i, { ...n, forceTranspile: !0 })
            ),
          )
        try {
          return nativeImportOrRequire(t, c, n.async)
        } catch (e) {
          debug(t, "Native require error:", e),
            debug(t, "[fallback]", c),
            (i = transform(t, {
              filename: c,
              source: i,
      ...
      ;(N.filename = c),
        t.parentModule &&
          ((N.parent = t.parentModule),
          Array.isArray(t.parentModule.children) &&
            !t.parentModule.children.includes(N) &&
            t.parentModule.children.push(N))
      const O = createJiti(
        c,
        t.opts,
        {
      ...
      let j
      ;(N.require = O),
        (N.path = pathe_M_eThtNZ_dirname(c)),
        (N.paths = Be.Module._nodeModulePaths(N.path)),
        (y[c] = N),
        t.opts.moduleCache && (t.nativeRequire.cache[c] = N)
      const F = (function (e, t) {
        return `(${
          t?.async ? "async " : ""
        }function (exports, require, module, __filename, __dirname, jitiImport, jitiESMResolve) { ${e}\n});`
      })(i, { async: n.async })
      try {
        ...
        "SyntaxError" === i.name && n.async && t.nativeImport
          ? (debug(t, "[esm]", "[import]", "[fallback]", c),
            (j = (function (t, i, n, a, c) {
              const l = `export default ${i}`,
                y = c
                  ? void 0
                  : `data:text/javascript;base64,${Buffer.from(l).toString("base64")}`
              return (...i) => {
                let c
                const importViaTempFile = () => (
                    (c = (function (t, i) {
                      ...
                      const a = pathe_M_eThtNZ_join(
                        n,
                        `${basename(i, extname(i))}-${Date.now()}-${Math.random().toString(36).slice(2)}.mjs`,
                      )
                      return (0, $e.writeFileSync)(a, t), a
                    })(l, n)),
                    debug(t, "[esm]", "[tempfile]", c),
                    a(pathToFileURL(c))
                  ),
                  E = y
                    ? a(y).catch((e) => {
                    ...
                    : importViaTempFile()
                return E.then((e) => e.default(...i)).finally(() => {
                  c && (0, wi.unlink)(c).catch(() => {})
                })
              }
            })(t, F, c, t.nativeImport, t.opts.esmEvalTempFile)))
          : (t.opts.moduleCache && delete t.nativeRequire.cache[c],
            t.onError(i))
      }
      let B
      try {
        B = j(
          ...
          N,
          N.filename,
          pathe_M_eThtNZ_dirname(N.filename),
          O.import,
          O.esmResolve,
        )
      } catch (e) {
    ...
    function createJiti(e, t = {}, i, n = !1) {
      const a = n
        ...
        : (function (e) {
            ...
            const i = {}
            return (
              void 0 !== e.cache && (i.fsCache = e.cache),
              void 0 !== e.requireCache && (i.moduleCache = e.requireCache),
              { ...t, ...i, ...e }
            )
          })(t)
      "string" == typeof e && e.startsWith("file://") && (e = fileURLToPath(e))
      const c =
        a.alias && Object.keys(a.alias).length > 0
          ? normalizeAliases(a.alias || {})
          : void 0
      let l
      if (a.tsconfigPaths) {
        const { getTsconfig: t, createPathsMatcher: i } = __webpack_require__(
            "./node_modules/.pnpm/get-tsconfig@4.14.0/node_modules/get-tsconfig/dist/index.cjs",
          ),
          n = t(
            "string" == typeof a.tsconfigPaths
              ? a.tsconfigPaths
              : pathe_M_eThtNZ_dirname(e),
          )
        n && (l = i(n))
      }
      const y = ["typescript", "jiti", ...(a.nativeModules || [])],
        E = new RegExp(
          `node_modules/(${y.map((e) => escapeStringRegexp(e)).join("|")})/`,
        ),
        w = [...(a.transformModules || [])],
        C = new RegExp(
          `node_modules/(${w.map((e) => escapeStringRegexp(e)).join("|")})/`,
        )
      e || (e = process.cwd()),
        !n && isDir(e) && (e = pathe_M_eThtNZ_join(e, "_index.js"))
      const S = pathToFileURL(e),
        I = [...a.extensions].filter((e) => ".js" !== e),
        N = i.createRequire(Ri ? e.replace(/\//g, "\\") : e),
        O = {
          filename: e,
          url: S,
          opts: a,
      ...
      const j = Object.assign(
        ...
        },
        {
          ...
          resolve: Object.assign(
            function (e, t) {
              return jitiResolve(O, e, { ...t, async: !1 })
            },
          ...
          async import(e, t) {
            const i = await jitiRequire(O, e, { ...t, async: !0 })
            return t?.default ? (i?.default ?? i) : i
          },
          esmResolve(e, t) {
            "string" == typeof t && (t = { parentURL: t })
            const i = jitiResolve(O, e, { parentURL: S, ...t, async: !0 })
            return !i || "string" != typeof i || i.startsWith("file://")
              ? i
              : pathToFileURL(i)
          },
        },
