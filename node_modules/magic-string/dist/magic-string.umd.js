;(function (global, factory) {
  ...
  var StringWriter = class {
    ...
    flush() {
      ...
      return pos >
        0
        ? out +
            td.decode(buffer.subarray(0, pos))
        : out
    }
  }
  ...
  class SourceMap {
    constructor(properties) {
      ...
      if (
        typeof properties.x_google_ignoreList !==
        "undefined"
      ) {
        this.x_google_ignoreList = properties.x_google_ignoreList
      }
      if (
        typeof properties.debugId !==
        "undefined"
      ) {
  ...
  class Bundle {
    ...
    addSource(source) {
      ...
      ;["filename", "ignoreList", "indentExclusionRanges", "separator"].forEach(
        (option) => {
    ...
    getIndentString() {
      ...
      return (
        Object.keys(indentStringCounts).sort((a, b) => {
          return (
            indentStringCounts[a] -
            indentStringCounts[b]
          )
        })[0] ||
        "\t"
      )
