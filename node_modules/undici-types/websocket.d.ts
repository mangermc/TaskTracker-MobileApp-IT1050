...
interface WebSocket extends EventTarget {
  ...
  onclose: ((ev: WebSocketEventMap["close"]) => any) | null
  onerror: ((ev: WebSocketEventMap["error"]) => any) | null
  onmessage: ((ev: WebSocketEventMap["message"]) => any) | null
  onopen: ((ev: WebSocketEventMap["open"]) => any) | null
