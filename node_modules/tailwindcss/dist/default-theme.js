...
function u(e, c) {
  ...
  return g.push(e.slice(k)), g
}
var l = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
  z = new RegExp(`^${l.source}$`)
var T = new RegExp(`^${l.source}%$`)
var I = new RegExp(`^${l.source}\\s*/\\s*${l.source}$`)
var A = [
    "cm",
    "mm",
    "Q",
  ...
  D = new RegExp(`^${l.source}(${A.join("|")})$`)
var C = ["deg", "rad", "grad", "turn"],
  F = new RegExp(`^${l.source}(${C.join("|")})$`)
...
var r = s((e) => {
  ...
  y = {
    ...
    aspectRatio: { auto: "auto", square: "1 / 1", video: "16 / 9", ...S },
    backdropBlur: ({ theme: e }) => e("blur"),
    backdropBrightness: ({ theme: e }) => ({ ...e("brightness"), ...o }),
    backdropContrast: ({ theme: e }) => ({ ...e("contrast"), ...o }),
    backdropGrayscale: ({ theme: e }) => ({ ...e("grayscale"), ...o }),
    backdropHueRotate: ({ theme: e }) => ({ ...e("hueRotate"), ...p }),
    backdropInvert: ({ theme: e }) => ({ ...e("invert"), ...o }),
    backdropOpacity: ({ theme: e }) => ({ ...e("opacity"), ...o }),
    backdropSaturate: ({ theme: e }) => ({ ...e("saturate"), ...o }),
    backdropSepia: ({ theme: e }) => ({ ...e("sepia"), ...o }),
    ...
    divideWidth: ({ theme: e }) => ({ ...e("borderWidth"), ...a }),
    dropShadow: {
    ...
    outlineOffset: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...a },
    outlineWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...a },
    padding: ({ theme: e }) => e("spacing"),
    placeholderColor: ({ theme: e }) => e("colors"),
    placeholderOpacity: ({ theme: e }) => e("opacity"),
    ringColor: ({ theme: e }) => ({ DEFAULT: "currentcolor", ...e("colors") }),
    ringOffsetColor: ({ theme: e }) => e("colors"),
    ringOffsetWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...a },
    ...
    saturate: { 0: "0", 50: ".5", 100: "1", 150: "1.5", 200: "2", ...o },
    scale: {
      0: "0",
      50: ".5",
      75: ".75",
