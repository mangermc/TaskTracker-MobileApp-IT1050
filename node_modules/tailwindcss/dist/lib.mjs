import {
  ...
  i as Ae,
  j as br,
} from "./chunk-C2OYBFIH.mjs"
import { a as kr } from "./chunk-DCG7AFIE.mjs"
import { a as _e, b as Ie, c as vr } from "./chunk-5JIJA4QV.mjs"
var yr = "4.3.3"
function mn(e) {
    ...
    switch (m) {
      case Vr: {
        for (
          l.length > 0 && (c(be(l)), (l = ""));
          p + 1 < e.length &&
          ((d = e.charCodeAt(p + 1)), !(d !== Dt && d !== Kt && d !== Ut));
          p++
        );
      ...
      case Er: {
        ...
        if (
          h === "" &&
          (r.length === 0 || v >= e.length || e.charCodeAt(v) === Vr)
        )
          break
        r.push(mn(h === "" ? " " : h)), (t = !0)
        break
      ...
      case Tr: {
        ...
        if (
          ...
          if (u.value === ":nth-child" || u.value === ":nth-last-child") {
            let S = y.indexOf("of ")
            if (S !== -1) {
              u.nodes.push(Ar(y.slice(0, S + 3)), ...fe(y.slice(S + 3))),
                (l = ""),
                (p = k),
                c(u)
              break
      ...
      case Sr: {
        l.length > 0 && (c(be(l)), (l = "")),
          s ? s.nodes.push(f()) : t && r.splice(0, r.length, It(r.splice(0)))
        let u = n.pop()
        ;(r = u?.target ?? i),
          (s = u?.currentList ?? null),
          (t = u?.containsCombinator ?? !1)
        break
      }
      case Rr:
      case Lt:
...
function Te(e, i) {
  ...
  for (let u = 0; u < e.length; u++) {
    ...
    if (!(v === mt && ((m = e.charCodeAt(u + 1)), m === me)))
      if (v === He) f === "" && (p = u), (f += e.slice(u, u + 2)), (u += 1)
      else if (v === ct && e.charCodeAt(u + 1) === pt) {
        let h = u
        for (let y = u + 2; y < e.length; y++)
          if (((m = e.charCodeAt(y)), m === He)) y += 1
        ...
        if (v === me) {
          ...
          r && ((S.src = [r, k, u]), (S.dst = [r, k, u])),
            l ? l.nodes.push(S) : t.push(S),
            (f = "")
        } else if (v === dt && f.charCodeAt(0) === Wt)
          (d = Qe(f)),
            r && ((d.src = [r, p, u]), (d.dst = [r, p, u])),
            l ? l.nodes.push(d) : t.push(d),
            (f = ""),
            (d = null)
          ...
          if (!h) {
            if (f.length === 0) continue
            throw new ge(
              `Invalid declaration: \`${f.trim()}\``,
              r ? [r, p, u] : null,
            )
          }
          r && ((h.src = [r, p, u]), (h.dst = [r, p, u])),
          ...
          if (c === "") throw new ge("Missing opening {", r ? [r, u, u] : null)
          ...
          if (c[c.length - 1] !== ")")
            throw new ge("Missing opening (", r ? [r, u, u] : null)
          ;(c = c.slice(0, -1)), (f += ")")
        } else {
...
function Lr(e, i, r, t = null) {
  ...
  for (let s = i + 1; s < e.length; s++)
    if (((n = e.charCodeAt(s)), n === He)) s += 1
    else {
      if (n === r) return s
      if (
        n === dt &&
        (e.charCodeAt(s + 1) === me ||
          (e.charCodeAt(s + 1) === mt && e.charCodeAt(s + 2) === me))
      )
        throw new ge(
...
function Hr(e, i = () => V.Continue, r = () => V.Continue) {
  ...
  for (; t !== null; ) {
    ...
    if (((n.parent = f), (n.siblings = l), d >= 0)) {
      ...
      switch (v.kind) {
        case 0: {
          u.nodes &&
            u.nodes.length > 0 &&
            ((n.depth += 1), (t = { value: [u.nodes, 0, u], prev: t })),
            (s[1] = ~d)
          continue
        }
        case 2:
        ...
        default:
          throw new Error(
            `Invalid \`WalkAction.${qt[v.kind] ?? `Unknown(${v.kind})`}\` in enter.`,
          )
      }
    }
    let c = ~d
    ...
    switch (m.kind) {
      ...
      default:
        throw new Error(
          `Invalid \`WalkAction.${qt[m.kind] ?? `Unknown(${m.kind})`}\` in exit.`,
        )
    }
  }
}
  ...
  function u(h, k, y = {}, S = 0) {
    if (h.kind === "declaration") {
      ...
      if (h.value.includes("var("))
        if (y.theme && h.property[0] === "-" && h.property[1] === "-")
          for (let x of ht(h.value)) m.get(x).add(h.property)
        ...
        for (let L of h.nodes)
          L.kind === "declaration" &&
            (L.property === "initial-value"
              ? (I = L.value)
              : L.property === "inherits" && (D = L.value === "true"))
        let O = a(b, I ?? "initial")
      ...
      let x = { ...h, nodes: [] }
      for (let b of h.nodes) u(b, x.nodes, y, S + 1)
      h.name === "@keyframes" && y.theme && d.add(x),
        (x.nodes.length > 0 ||
          x.name === "@layer" ||
          x.name === "@charset" ||
          x.name === "@custom-media" ||
      ...
      for (let x of h.nodes) u(x, k, { ...y, ...h.context }, S)
    ...
    for (let y of k) {
      if (Jr(y.property, i.theme, m)) {
        if (y.property.startsWith(i.theme.prefixKey("--animate-")))
          for (let b of Zr(y.value)) f.add(b)
        continue
      }
      let x = h.indexOf(y)
              ...
              (P(O.nodes, (j) => {
                ...
                do {
                  ...
                  if (
                    (ee.add(o),
                    (b = !0),
                    (G = i.theme.resolveValue(null, [ie.value])),
                    !G)
                  ) {
                    L = !0
                    return
                ...
                return V.Replace({ kind: "word", value: G })
              }),
              L || E)
            ) {
              let j = O.nodes.findIndex(
                (G) => G.kind === "separator" && G.value.trim().includes(","),
              )
              if (j === -1) return
...
function _n(e) {
      ...
      switch (p.kind) {
          ...
          if (((n = null), r.length === 0))
            if (p.selector.includes("&")) {
              ...
              P(m, (v) => {
                ...
                u
                  ? r.push([oe(m), p.src, p.dst])
                  : r.push([p.selector, p.src, p.dst])
            } else r.push([p.selector, p.src, p.dst])
          else {
            if (p.selector === "&") {
              f.add(p)
              return
                      ...
                      (P(h, {
                        ...
                        exit(S, x) {
                          if (
                            ...
                            let b = x.siblings[1]
                            return b.kind === "selector" &&
                              b.value.charCodeAt(0) === On
                              ? void 0
                              : V.ReplaceSkip([])
                          }
                        },
        ...
        case "at-rule": {
          if (((n = null), p.nodes.length === 0 && !Dn.has(p.name)))
            return c(p), f.add(p), V.Skip
          if (In.has(p.name)) t.push([p.name, p.params, p.src, p.dst])
  ...
  function c(p) {
    if (n) {
      p.kind === "declaration" &&
        (s.has(p.property) ? l.add(n) : s.add(p.property)),
        n.push(p)
      return
    }
    {
      ...
      if (r.length > 0) {
        ...
        ;(m = Z(h, n)), (k || y) && Object.assign(m, { src: k, dst: y })
      }
  ...
  for (let [m, u] of p) {
    ...
    }
    {
      ...
      if (h !== -1) {
        ...
        let y =
          d === null || v.modifier?.kind === "arbitrary" ? null : `${u}/${d}`
...
function Qt(e) {
  if (e[0] === "[" && e[e.length - 1] === "]") {
    ...
    return !ye(i) || i.length === 0 || i.trim().length === 0
      ? null
  ...
  return e[0] === "(" && e[e.length - 1] === ")"
    ? ((e = e.slice(1, -1)),
      e[0] !== "-" || e[1] !== "-" || !ye(e)
        ? null
        : ((e = `var(${e})`), { kind: "arbitrary", value: Ce(e) }))
    : er.test(e)
      ? { kind: "named", value: e }
      : null
}
      ...
      switch (i.variants.kind(l)) {
        ...
        case "functional": {
          ...
          if (d[d.length - 1] === "]") {
            ...
            return !ye(c) || c.length === 0 || c.trim().length === 0
              ? null
              : {
                  kind: "functional",
                  root: l,
        ...
        case "compound": {
          ...
          return t !== null && c === null
            ? null
            : { kind: "compound", root: l, modifier: c, variant: f }
        }
      }
  }
  return null
...
function ni(e, i) {
  ...
  if (
    ...
    if (i.value.kind === "arbitrary") {
      if (i.value !== null) {
        let n = tr(i.value.value),
          s = n ? i.value.value.slice(4, -1) : i.value.value,
          [l, d] = n ? ["(", ")"] : ["[", "]"]
        i.value.dataType
          ? (t += `-${l}${i.value.dataType}:${Se(s)}${d}`)
          : (t += `-${l}${Se(s)}${d}`)
      }
    } else i.value.kind === "named" && (t += `-${i.value.value}`)
  return (
    i.kind === "arbitrary" && (t += `[${i.property}:${Se(i.value)}]`),
...
function vt(e) {
  ...
  return (
    e.kind === "compound" && ((i += e.root), (i += "-"), (i += vt(e.variant))),
    (e.kind === "functional" || e.kind === "compound") && (i += rt(e.modifier)),
    i
  )
}
var zn = new U((e) => {
  ...
  return (
    P(i, (n, s) => {
      if (n.kind === "word" && t.has(n.value)) {
        ...
        return f && !t.has(f.value)
          ? void 0
          : V.ReplaceSkip({ kind: "function", value: "", nodes: [n] })
      }
    }),
    r.size > 0 &&
      P(i, (n) => {
...
var Yn = new Set(["inset", "inherit", "initial", "revert", "unset"]),
  Gn = new Set(["calc", "clamp", "max", "min", "--spacing"]),
  qn = new Set([
    "color",
    "color-mix",
    "contrast-color",
        ...
        P(s, (p) => {
          switch (p.kind) {
            case "word": {
              ...
              if (p.value[0] === "#" || wr(p.value))
                return (c = !0), V.ReplaceStop(r(p))
              ;(l = p), d++
              break
            }
            case "function":
              return qn.has(p.value.toLowerCase())
                ? ((c = !0), V.ReplaceStop(r(p)))
                : Gn.has(p.value.toLowerCase())
                  ? (f++, V.Skip)
                  : ((l = p), d++, V.Skip)
            case "separator":
              return V.Continue
        ...
        c
          ...
          : f < 2
            ...
            : d === 0
              ...
              : (d === 1 &&
                  P(s, (p) =>
                    p === l ? ((c = !0), V.ReplaceStop(r(p))) : V.Skip,
                  ),
                c ? F(s) : n)
      )
    })
...
function te(e, i, r) {
  ...
  return t ? X(e, t) : Ae(i.value) ? X(e, `${i.value}%`) : null
}
function ae(e, i, r) {
  let t = null
...
function si(e) {
  ...
  function r(o, g) {
    ...
    i.suggest(o, () => {
      ...
      for (let T of g()) {
        ...
        let K = [...(T.values ?? []), ...w(T.valueThemeKeys ?? [])],
          N = [...(T.modifiers ?? []), ...w(T.modifierThemeKeys ?? [])]
        T.supportsFractions && K.push(...C),
          T.hasDefaultValue && K.unshift(null),
          A.push({
  ...
  function t(o, g) {
    i.static(o, () =>
      g.map((w) => (typeof w == "function" ? w() : a(w[0], w[1]))),
    )
  }
  function n(o, g) {
    g.staticValues &&
    ...
    function w({ negative: C }) {
      return (A) => {
        ...
        if (A.value)
          if (A.value.kind === "arbitrary") {
            ...
            if (
              ...
              T === null && g.supportsFractions && A.value.fraction)
            ) {
              let [N, R] = z(A.value.fraction, "/")
              if (!_(N) || !_(R)) return
              T = `calc(${N} / ${R} * 100%)`
            }
            if (T === null && C && g.handleNegativeBareValue) {
              if (
                ((T = g.handleNegativeBareValue(A.value)),
                !T?.includes("/") && A.modifier)
              )
                return
        ...
        if (T !== null) return g.handle(C ? st(`calc(${T} * -1)`) : T, K)
      }
    }
    if (
      (g.supportsNegative && i.functional(`-${o}`, w({ negative: !0 })),
      i.functional(o, w({ negative: !1 })),
      r(o, () => [
        {
    ...
    i.functional(o, (w) => {
      ...
      if (
        (w.value.kind === "arbitrary"
          ? ((C = w.value.value), (C = te(C, w.modifier, e)))
          : (C = ae(w, e, g.themeKeys)),
        C !== null)
      )
        return g.handle(C)
    }),
    ...
    C && i.static(`-${o}-px`, () => w("-1px")),
      ...
      n(o, {
        ...
        handleBareValue: ({ value: K }) =>
          !e.resolve(null, ["--spacing"]) || !Q(K) ? null : `--spacing(${K})`,
  ...
  t("isolate", [["isolation", "isolate"]]),
    ...
    n("z", {
      supportsNegative: !0,
      handleBareValue: ({ value: o }) => (_(o) ? o : null),
      themeKeys: ["--z-index"],
  ...
  for (let [o, g] of [
    ...
    t(`size-${o}`, [
      ...
      t(`w-${o}`, [["width", g]]),
      t(`h-${o}`, [["height", g]]),
      t(`min-w-${o}`, [["min-width", g]]),
      t(`min-h-${o}`, [["min-height", g]]),
      t(`max-w-${o}`, [["max-width", g]]),
      t(`max-h-${o}`, [["max-height", g]])
  t("size-auto", [
    ["--tw-sort", "size"],
    ["width", "auto"],
    ["height", "auto"],
    ...
    l(
      "size",
      ["--size", "--spacing"],
      (o) => [a("--tw-sort", "size"), a("width", o), a("height", o)],
      { supportsFractions: !0 },
    )
  for (let [o, g, w] of [
  ...
  for (let [o, g] of [
    ...
    t(`inline-${o}`, [["inline-size", g]]),
      t(`block-${o}`, [["block-size", g]]),
      t(`min-inline-${o}`, [["min-inline-size", g]]),
      t(`min-block-${o}`, [["min-block-size", g]]),
      t(`max-inline-${o}`, [["max-inline-size", g]]),
      t(`max-block-${o}`, [["max-block-size", g]])
  for (let [o, g] of [
    ["svw", "100svw"],
    ["lvw", "100lvw"],
    ["dvw", "100dvw"],
    ...
    i.functional("flex", (o) => {
      if (o.value) {
        if (o.value.kind === "arbitrary")
          return o.modifier ? void 0 : [a("flex", o.value.value)]
        if (o.value.fraction) {
          let [g, w] = z(o.value.fraction, "/")
          return !_(g) || !_(w)
            ? void 0
  ...
  let c = () =>
    Y([$("--tw-scale-x", "1"), $("--tw-scale-y", "1"), $("--tw-scale-z", "1")])
    ...
    return (g) => {
      ...
      return g.value.kind === "arbitrary"
        ? ((w = g.value.value),
          (w = o ? `calc(${w} * -1)` : w),
          [a("scale", w)])
        : ((w = e.resolve(g.value.value, ["--scale"])),
          !w && _(g.value.value) && (w = `${g.value.value}%`),
          w
            ? ((w = o ? `calc(${w} * -1)` : w),
              [
                c(),
  ...
  i.functional("-scale", p({ negative: !0 })),
    i.functional("scale", p({ negative: !1 })),
    r("scale", () => [
      {
        supportsNegative: !0,
        values: [
  ...
  for (let o of ["x", "y", "z"])
    n(`scale-${o}`, {
      supportsNegative: !0,
      themeKeys: ["--scale"],
      handleBareValue: ({ value: g }) => (_(g) ? `${g}%` : null),
      handle: (g) => [
        c(),
        a(`--tw-scale-${o}`, g),
        a(
  ...
  function m({ negative: o }) {
    return (g) => {
      ...
      if (g.value.kind === "arbitrary") {
        w = g.value.value
        let C = g.value.dataType ?? J(w, ["angle", "vector"])
        if (C === "vector") return [a("rotate", `${w} var(--tw-rotate)`)]
        if (C !== "angle") return [a("rotate", o ? `calc(${w} * -1)` : w)]
      } else if (
        ((w = e.resolve(g.value.value, ["--rotate"])),
        !w && _(g.value.value) && (w = `${g.value.value}deg`),
        !w)
      )
        return
    ...
    ])
  {
    ...
    for (let w of ["x", "y", "z"])
      n(`rotate-${w}`, {
        supportsNegative: !0,
        themeKeys: ["--rotate"],
        handleBareValue: ({ value: C }) => (_(C) ? `${C}deg` : null),
        handle: (C) => [
          g(),
    ...
    n("skew", {
      supportsNegative: !0,
      themeKeys: ["--skew"],
      handleBareValue: ({ value: w }) => (_(w) ? `${w}deg` : null),
      handle: (w) => [
        g(),
        a("--tw-skew-x", `skewX(${w})`),
        a("--tw-skew-y", `skewY(${w})`),
      ...
      i.functional("transform", (w) => {
        ...
        if (
          (w.value
            ? w.value.kind === "arbitrary" && (C = w.value.value)
            : (C = o),
          C !== null)
        )
          return [g(), a("transform", C)]
      }),
      r("transform", () => [{ hasDefaultValue: !0 }]),
      t("transform-cpu", [["transform", o]]),
      t("transform-gpu", [["transform", `translateZ(0) ${o}`]]),
  ...
  for (let o of [
    ...
    t(`cursor-${o}`, [["cursor", o]])
  n("cursor", { themeKeys: ["--cursor"], handle: (o) => [a("cursor", o)] })
  for (let o of ["auto", "none", "manipulation"])
    t(`touch-${o}`, [["touch-action", o]])
  let u = () => Y([$("--tw-pan-x"), $("--tw-pan-y"), $("--tw-pinch-zoom")])
  ...
  for (let [o, g] of [
    ...
    l(o, ["--scroll-margin", "--spacing"], (w) => [a(g, w)], {
      supportsNegative: !0,
    })
  for (let [o, g] of [
  ...
  t("grid-flow-row", [["grid-auto-flow", "row"]]),
    ...
    n("auto-cols", {
      ...
      handleBareValue: ({ value: o }) =>
        !e.resolve(null, ["--spacing"]) || !Q(o) ? null : `--spacing(${o})`,
    ...
    n("grid-cols", {
      ...
      handleBareValue: ({ value: o }) =>
        _t(o) ? `repeat(${o}, minmax(0, 1fr))` : null,
    ...
    l("gap", ["--gap", "--spacing"], (o) => [a("gap", o)]),
    l("gap-x", ["--gap", "--spacing"], (o) => [a("column-gap", o)]),
    l("gap-y", ["--gap", "--spacing"], (o) => [a("row-gap", o)]),
    l(
      "space-x",
      ["--space", "--spacing"],
      (o) => {
        ...
        return [
          ...
          H(":where(& > :not(:last-child))", [
            ...
            a(
              "margin-inline-start",
              g ? "0" : `calc(${o} * var(--tw-space-x-reverse))`,
            ),
            a(
              "margin-inline-end",
              g ? "0" : `calc(${o} * calc(1 - var(--tw-space-x-reverse)))`,
            ),
          ]),
        ]
      },
      ...
      (o) => {
        ...
        return [
          ...
          H(":where(& > :not(:last-child))", [
            ...
            a(
              "margin-block-start",
              g ? "0" : `calc(${o} * var(--tw-space-y-reverse))`,
            ),
            a(
              "margin-block-end",
              g ? "0" : `calc(${o} * calc(1 - var(--tw-space-y-reverse)))`,
            ),
          ]),
        ]
      },
  ...
  for (let o of ["auto", "hidden", "clip", "visible", "scroll"])
    t(`overflow-${o}`, [["overflow", o]]),
      t(`overflow-x-${o}`, [["overflow-x", o]]),
      t(`overflow-y-${o}`, [["overflow-y", o]])
  for (let o of ["auto", "contain", "none"])
    t(`overscroll-${o}`, [["overscroll-behavior", o]]),
      t(`overscroll-x-${o}`, [["overscroll-behavior-x", o]]),
      t(`overscroll-y-${o}`, [["overscroll-behavior-y", o]])
    ...
    t("scrollbar-none", [["scrollbar-width", "none"]])
  {
    let o = () =>
      Y([
        $("--tw-scrollbar-thumb", "#0000", "<color>"),
        $("--tw-scrollbar-track", "#0000", "<color>"),
      ])
    s("scrollbar-thumb", {
      themeKeys: ["--color"],
      handle: (g) => [
    ...
    ])
  {
    let g = function (w, C) {
      i.functional(w, (A) => {
        ...
        if (A.value.kind === "arbitrary") {
          let T = A.value.value
          switch (A.value.dataType ?? J(T, ["color", "line-width", "length"])) {
            case "line-width":
            case "length": {
              if (A.modifier) return
              let N = C.width(T)
            ...
            default:
              return (
                (T = te(T, A.modifier, e)), T === null ? void 0 : C.color(T)
              )
          }
        }
        {
    ...
    g("border", {
      ...
      n("divide-x", {
        ...
        handleBareValue: ({ value: w }) => (_(w) ? `${w}px` : null),
        handle: (w) => [
          ...
          H(":where(& > :not(:last-child))", [
            ...
            a(
              ...
              `calc(${w} * var(--tw-divide-x-reverse))`,
            ),
            a(
              "border-inline-end-width",
              `calc(${w} * calc(1 - var(--tw-divide-x-reverse)))`,
            ),
          ]),
        ],
      }),
      n("divide-y", {
        ...
        handle: (w) => [
          ...
          H(":where(& > :not(:last-child))", [
            ...
            a(
              "border-bottom-width",
              `calc(${w} * calc(1 - var(--tw-divide-y-reverse)))`,
            ),
          ]),
        ],
      }),
      ...
      t("divide-x-reverse", [
        () => Y([$("--tw-divide-x-reverse", "0")]),
        () =>
          H(":where(& > :not(:last-child))", [a("--tw-divide-x-reverse", "1")]),
      ]),
      t("divide-y-reverse", [
        () => Y([$("--tw-divide-y-reverse", "0")]),
        () =>
          H(":where(& > :not(:last-child))", [a("--tw-divide-y-reverse", "1")]),
      ])
      ...
      C = function ({ negative: T }) {
        return (K) => {
          ...
          if (K.value.kind === "arbitrary") {
            ...
            let W = K.value.value
            return (K.value.dataType ?? J(W, ["angle"])) === "angle"
              ? ((W = T ? `calc(${W} * -1)` : `${W}`),
                [
                  a("--tw-gradient-position", W),
                  a(
                    "background-image",
          ...
          else if (_(N)) N = T ? `calc(${N}deg * -1)` : `${N}deg`
          else return
          let R = w(K.modifier)
          return [
        ...
        return (K) => {
          ...
          if (_(R))
            return (
              ...
              [
                a("--tw-gradient-position", `from ${R} ${N}`),
                a(
                  "background-image",
      ...
      i.functional("bg-radial", (T) => {
        ...
        if (T.value.kind === "arbitrary") {
          ...
          return [
            ...
            a(
              "background-image",
              `radial-gradient(var(--tw-gradient-stops,${K}))`,
            ),
          ]
        }
      }),
      r("bg-radial", () => [{ hasDefaultValue: !0, modifiers: o }])
  }
  i.functional("bg", (o) => {
    if (o.value) {
      if (o.value.kind === "arbitrary") {
        ...
        switch (
          ...
          case "percentage":
          case "position":
            return o.modifier ? void 0 : [a("background-position", g)]
          case "bg-size":
          case "length":
          case "size":
            return o.modifier ? void 0 : [a("background-size", g)]
          case "image":
          case "url":
            return o.modifier ? void 0 : [a("background-image", g)]
          default:
            return (
              (g = te(g, o.modifier, e)),
              g === null ? void 0 : [a("background-color", g)]
            )
        }
      }
      {
    ...
    i.functional(o, (w) => {
      if (w.value) {
        if (w.value.kind === "arbitrary") {
          let C = w.value.value
          switch (w.value.dataType ?? J(C, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return w.modifier ? void 0 : g.position(C)
            default:
              return (
                (C = te(C, w.modifier, e)), C === null ? void 0 : g.color(C)
              )
          }
        }
        {
        ...
        }
        {
          ...
          if (
            w.value.value[w.value.value.length - 1] === "%" &&
            _(w.value.value.slice(0, -1))
          )
  ...
  k("from", {
    ...
    i.functional("mask", (o) => {
      ...
      switch (
        o.value.dataType ??
        J(g, ["image", "percentage", "position", "bg-size", "length", "url"])
      ) {
        case "percentage":
        case "position":
          return o.modifier ? void 0 : [a("mask-position", g)]
        case "bg-size":
        case "length":
        case "size":
          return [a("mask-size", g)]
        default:
          return [a("mask-image", g)]
      }
    }),
  ...
  function S(o, g) {
    i.functional(o, (w) => {
      if (w.value) {
        if (w.value.kind === "arbitrary") {
          let C = w.value.value
          switch (w.value.dataType ?? J(C, ["length", "percentage", "color"])) {
            case "color":
              return (
                (C = te(C, w.modifier, e)), C === null ? void 0 : g.color(C)
              )
            case "percentage":
              return w.modifier || !_(C.slice(0, -1)) ? void 0 : g.position(C)
            default:
              return w.modifier ? void 0 : g.position(C)
          }
        }
        ...
        {
          if (w.modifier) return
          let C = J(w.value.value, ["number", "percentage"])
          if (!C) return
          switch (C) {
            case "number":
              return !e.resolve(null, ["--spacing"]) || !Q(w.value.value)
                ? void 0
                : g.position(`--spacing(${w.value.value})`)
            case "percentage":
              return _(w.value.value.slice(0, -1))
                ? g.position(w.value.value)
                : void 0
            default:
              return
          }
  ...
  b("mask-x-from", "from", { top: !1, right: !0, bottom: !1, left: !0 }),
    b("mask-x-to", "to", { top: !1, right: !0, bottom: !1, left: !0 }),
    b("mask-y-from", "from", { top: !0, right: !1, bottom: !0, left: !1 }),
    b("mask-y-to", "to", { top: !0, right: !1, bottom: !0, left: !1 }),
    b("mask-t-from", "from", { top: !0, right: !1, bottom: !1, left: !1 }),
    b("mask-t-to", "to", { top: !0, right: !1, bottom: !1, left: !1 }),
    b("mask-r-from", "from", { top: !1, right: !0, bottom: !1, left: !1 }),
    b("mask-r-to", "to", { top: !1, right: !0, bottom: !1, left: !1 }),
    b("mask-b-from", "from", { top: !1, right: !1, bottom: !0, left: !1 }),
    b("mask-b-to", "to", { top: !1, right: !1, bottom: !0, left: !1 }),
    b("mask-l-from", "from", { top: !1, right: !1, bottom: !1, left: !0 }),
    b("mask-l-to", "to", { top: !1, right: !1, bottom: !1, left: !0 })
  let I = () =>
    Y([
  ...
  for (let o of [
    ...
    t(`bg-blend-${o}`, [["background-blend-mode", o]]),
      t(`mix-blend-${o}`, [["mix-blend-mode", o]])
  t("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
    ...
    i.functional("stroke", (o) => {
      if (o.value) {
        if (o.value.kind === "arbitrary") {
          let g = o.value.value
          switch (
            o.value.dataType ??
            J(g, ["color", "number", "length", "percentage"])
          ) {
            case "number":
            case "length":
            case "percentage":
              return o.modifier ? void 0 : [a("stroke-width", g)]
            default:
              return (
                (g = te(o.value.value, o.modifier, e)),
                g === null ? void 0 : [a("stroke", g)]
              )
          }
        }
        {
        ...
        }
        {
          ...
          if (_(o.value.value)) return [a("stroke-width", o.value.value)]
        }
      }
    }),
    r("stroke", () => [
  ...
  t("text-left", [["text-align", "left"]]),
    ...
    l("indent", ["--text-indent", "--spacing"], (o) => [a("text-indent", o)], {
      supportsNegative: !0,
    }),
    ...
    n("align", { themeKeys: [], handle: (o) => [a("vertical-align", o)] }),
    i.functional("font", (o) => {
      if (!(!o.value || o.modifier)) {
        if (o.value.kind === "arbitrary") {
          ...
          switch (
            o.value.dataType ??
            J(g, ["number", "generic-name", "family-name"])
          ) {
            case "generic-name":
            case "family-name":
              return [a("font-family", g)]
            default:
              return [
                Y([$("--tw-font-weight")]),
                a("--tw-font-weight", g),
        ...
        {
          let g = e.resolveWith(o.value.value, ["--font"], [
    ...
    n("font-stretch", {
      handleBareValue: ({ value: o }) => {
        ...
        return !_(g) || Number.isNaN(g) || g < 50 || g > 200 ? null : o
      },
    ...
    i.functional("decoration", (o) => {
      if (o.value) {
        if (o.value.kind === "arbitrary") {
          let g = o.value.value
          switch (o.value.dataType ?? J(g, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return o.modifier ? void 0 : [a("text-decoration-thickness", g)]
            default:
              return (
                (g = te(g, o.modifier, e)),
                g === null ? void 0 : [a("text-decoration-color", g)]
              )
          }
        }
        {
    ...
    i.functional("filter", (A) => {
      ...
      i.functional("backdrop-filter", (A) => {
        if (!A.modifier) {
          ...
          if (A.value.kind === "arbitrary")
            return [
              a("-webkit-backdrop-filter", A.value.value),
              a("backdrop-filter", A.value.value),
            ]
      ...
      n("blur", {
        themeKeys: ["--blur"],
        handle: (A) => [w(), a("--tw-blur", `blur(${A})`), a("filter", o)],
        staticValues: { none: [w(), a("--tw-blur", " "), a("filter", o)] },
      }),
      n("backdrop-blur", {
      ...
      n("brightness", {
        ...
        handleBareValue: ({ value: A }) => (_(A) ? `${A}%` : null),
        handle: (A) => [
          w(),
      ...
      n("hue-rotate", {
        ...
        handleBareValue: ({ value: A }) => (_(A) ? `${A}deg` : null),
        handle: (A) => [
          w(),
      ...
      n("invert", {
        ...
        handleBareValue: ({ value: A }) => (_(A) ? `${A}%` : null),
        defaultValue: "100%",
        handle: (A) => [w(), a("--tw-invert", `invert(${A})`), a("filter", o)],
      }),
      n("backdrop-invert", {
      ...
      n("sepia", {
        ...
        handleBareValue: ({ value: A }) => (_(A) ? `${A}%` : null),
        defaultValue: "100%",
        handle: (A) => [w(), a("--tw-sepia", `sepia(${A})`), a("filter", o)],
      }),
      n("backdrop-sepia", {
      ...
      t("drop-shadow-none", [w, ["--tw-drop-shadow", " "], ["filter", o]]),
      i.functional("drop-shadow", (A) => {
        ...
        if (
          (A.modifier &&
            (A.modifier.kind === "arbitrary"
              ? (T = A.modifier.value)
              : Ae(A.modifier.value) && (T = `${A.modifier.value}%`)),
          !A.value)
        ) {
          let K = e.get(["--drop-shadow"]),
            N = e.resolve(null, ["--drop-shadow"])
          return K === null || N === null
            ? void 0
            : [
                w(),
        ...
        if (A.value.kind === "arbitrary") {
          let K = A.value.value
          return (A.value.dataType ?? J(K, ["color"])) === "color"
            ? ((K = te(K, A.modifier, e)),
              K === null
                ? void 0
                : [
        ...
        {
          let K = e.get([`--drop-shadow-${A.value.value}`]),
      ...
      n("backdrop-opacity", {
        ...
        handleBareValue: ({ value: A }) => (Ae(A) ? `${A}%` : null),
        handle: (A) => [
          C(),
  ...
  {
    let o = `var(--tw-ease, ${e.resolve(null, ["--default-transition-timing-function"]) ?? "ease"})`,
    ...
    n("transition", {
      ...
      n("delay", {
        handleBareValue: ({ value: w }) => (_(w) ? `${w}ms` : null),
        themeKeys: ["--transition-delay"],
        handle: (w) => [a("transition-delay", w)],
      })
    {
      let w = () => Y([$("--tw-duration")])
      t("duration-initial", [w, ["--tw-duration", "initial"]]),
          ...
          if (
            (C.value.kind === "arbitrary"
              ...
              : ((A = e.resolve(C.value.fraction ?? C.value.value, [
                ...
                A === null && _(C.value.value) && (A = `${C.value.value}ms`)),
            A !== null)
          )
            return [w(), a("--tw-duration", A), a("transition-duration", A)]
        })
    }
    r("delay", () => [
      {
  ...
  t("will-change-auto", [["will-change", "auto"]]),
    ...
    n("will-change", { themeKeys: [], handle: (o) => [a("will-change", o)] }),
    t("content-none", [
      ["--tw-content", "none"],
      ["content", "none"],
    ]),
    ...
    })
  {
    ...
    t("contain-none", [["contain", "none"]]),
      ...
      t("contain-size", [g, ["--tw-contain-size", "size"], ["contain", o]]),
      ...
      t("contain-paint", [g, ["--tw-contain-paint", "paint"], ["contain", o]]),
      t("contain-style", [g, ["--tw-contain-style", "style"], ["contain", o]]),
      n("contain", { themeKeys: [], handle: (w) => [a("contain", w)] })
  }
    ...
    i.static("outline-hidden", () => [
      ...
      i.functional("outline", (g) => {
        ...
        if (g.value.kind === "arbitrary") {
          ...
          switch (
            g.value.dataType ??
            J(w, ["color", "length", "number", "percentage"])
          ) {
            case "length":
            case "number":
            case "percentage":
            ...
            default:
              return (
                (w = te(w, g.modifier, e)),
                w === null ? void 0 : [a("outline-color", w)]
              )
          }
        }
        {
      ...
      n("outline-offset", {
        ...
        handleBareValue: ({ value: g }) => (_(g) ? `${g}px` : null),
  ...
  n("opacity", {
    themeKeys: ["--opacity"],
    handleBareValue: ({ value: o }) => (Ae(o) ? `${o}%` : null),
    ...
    n("underline-offset", {
      ...
      handleBareValue: ({ value: o }) => (_(o) ? `${o}px` : null),
              ...
              if (o.modifier) {
                let C =
                  o.modifier.kind === "arbitrary"
                    ? o.modifier.value
                    : e.resolve(o.modifier.value, ["--leading"])
                if (!C && Q(o.modifier.value)) {
                  if (!e.resolve(null, ["--spacing"])) return null
                  C = `--spacing(${o.modifier.value})`
                }
                return (
                  !C && o.modifier.value === "none" && (C = "1"),
                  C ? [a("font-size", g), a("line-height", C)] : null
                )
              }
  ...
  t("text-shadow-initial", [L, ["--tw-text-shadow-color", "initial"]]),
    i.functional("text-shadow", (o) => {
      let g
      if (
        (o.modifier &&
          (o.modifier.kind === "arbitrary"
            ? (g = o.modifier.value)
            : Ae(o.modifier.value) && (g = `${o.modifier.value}%`)),
        !o.value)
      ) {
      ...
      if (o.value.kind === "arbitrary") {
        let w = o.value.value
        return (o.value.dataType ?? J(w, ["color"])) === "color"
          ? ((w = te(w, o.modifier, e)),
            w === null
              ? void 0
              : [
      ...
      switch (o.value.value) {
        case "none":
          return o.modifier ? void 0 : [L(), a("text-shadow", "none")]
        case "inherit":
          return o.modifier
            ? void 0
            : [L(), a("--tw-text-shadow-color", "inherit")]
      }
      {
      ...
      }
      {
        ...
        if (w)
          return [
            L(),
            a("--tw-text-shadow-color", X(w, "var(--tw-text-shadow-alpha)")),
          ]
      }
    }),
    r("text-shadow", () => [
    ...
    ])
  {
    ...
    t("shadow-initial", [w, ["--tw-shadow-color", "initial"]]),
      i.functional("shadow", (N) => {
        ...
        if (
          (N.modifier &&
            (N.modifier.kind === "arbitrary"
              ? (R = N.modifier.value)
              : Ae(N.modifier.value) && (R = `${N.modifier.value}%`)),
          !N.value)
        ) {
          let W = e.get(["--shadow"])
          return W === null
        ...
        if (N.value.kind === "arbitrary") {
          let W = N.value.value
          return (N.value.dataType ?? J(W, ["color"])) === "color"
            ? ((W = te(W, N.modifier, e)),
              W === null
                ? void 0
                : [w(), a("--tw-shadow-color", X(W, "var(--tw-shadow-alpha)"))])
            : [
                w(),
                a("--tw-shadow-alpha", R),
                ...xe(
        ...
        switch (N.value.value) {
          case "none":
            return N.modifier
              ? void 0
              : [w(), a("--tw-shadow", g), a("box-shadow", o)]
          case "inherit":
            return N.modifier
              ? void 0
              : [w(), a("--tw-shadow-color", "inherit")]
        }
        {
        ...
        }
        {
          ...
          if (W)
            return [w(), a("--tw-shadow-color", X(W, "var(--tw-shadow-alpha)"))]
        }
      }),
      r("shadow", () => [
        {
      ...
      t("inset-shadow-initial", [w, ["--tw-inset-shadow-color", "initial"]]),
      i.functional("inset-shadow", (N) => {
          ...
          return W === null
            ...
            : [
                ...
                ...xe(
                  ...
                  W,
                  R,
                  (he) => `var(--tw-inset-shadow-color, ${he})`,
                ),
                a("box-shadow", o),
              ]
        }
          ...
          return (N.value.dataType ?? J(W, ["color"])) === "color"
            ...
            : [
                ...
                ...xe(
                  ...
                  W,
                  R,
                  (Ot) => `var(--tw-inset-shadow-color, ${Ot})`,
                  "inset",
                ),
                a("box-shadow", o),
              ]
        ...
        switch (N.value.value) {
          case "none":
            return N.modifier
              ? void 0
              : [w(), a("--tw-inset-shadow", `inset ${g}`), a("box-shadow", o)]
          case "inherit":
            return N.modifier
              ? void 0
              : [w(), a("--tw-inset-shadow-color", "inherit")]
        }
        {
    ...
    i.functional("ring", (N) => {
      if (!N.value) {
        ...
        return [w(), a("--tw-ring-shadow", A(R)), a("box-shadow", o)]
      }
      if (N.value.kind === "arbitrary") {
        let R = N.value.value
        return (N.value.dataType ?? J(R, ["color", "length"])) === "length"
          ? N.modifier
            ? void 0
            : [w(), a("--tw-ring-shadow", A(R)), a("box-shadow", o)]
          : ((R = te(R, N.modifier, e)),
            R === null ? void 0 : [a("--tw-ring-color", R)])
      }
      {
      ...
      }
      {
        ...
        if ((R === null && _(N.value.value) && (R = `${N.value.value}px`), R))
          return [w(), a("--tw-ring-shadow", A(R)), a("box-shadow", o)]
      }
    }),
      r("ring", () => [
      ...
      i.functional("inset-ring", (N) => {
        if (!N.value)
          return N.modifier
            ? void 0
            : [w(), a("--tw-inset-ring-shadow", T("1px")), a("box-shadow", o)]
        if (N.value.kind === "arbitrary") {
          let R = N.value.value
          return (N.value.dataType ?? J(R, ["color", "length"])) === "length"
            ? N.modifier
              ? void 0
              : [w(), a("--tw-inset-ring-shadow", T(R)), a("box-shadow", o)]
            : ((R = te(R, N.modifier, e)),
              R === null ? void 0 : [a("--tw-inset-ring-color", R)])
        }
        {
          let R = ae(N, e, ["--ring-color", "--color"])
        ...
        }
        {
          ...
          let R = e.resolve(N.value.value, ["--ring-width"])
          if ((R === null && _(N.value.value) && (R = `${N.value.value}px`), R))
            return [w(), a("--tw-inset-ring-shadow", T(R)), a("box-shadow", o)]
        }
      }),
      r("inset-ring", () => [
        {
      ...
      if (N.value) {
        if (N.value.kind === "arbitrary") {
          ...
          return (N.value.dataType ?? J(R, ["color", "length"])) === "length"
            ...
            : ((R = te(R, N.modifier, e)),
              R === null ? void 0 : [a("--tw-ring-offset-color", R)])
        }
        {
      ...
      if (
        (o.value === null
          ...
          : o.value.kind === "arbitrary"
            ? (g = o.value.value)
            : o.value.kind === "named" && o.value.value === "normal"
              ? (g = "normal")
              : o.value.kind === "named" &&
                o.value.value === "size" &&
                (g = "size"),
        ...
        return o.modifier
          ? [a("container-type", g), a("container-name", o.modifier.value)]
          : [a("container-type", g)]
    }),
    r("@container", () => [
          ...
          P(s, (l) => {
            ...
            for (let f of l.nodes)
              if (
                f.kind === "word" &&
                (f.value[0] === '"' || f.value[0] === "'") &&
                f.value[0] === f.value[f.value.length - 1]
              ) {
...
`)
                ...
                P(p.nodes, (k) => {
                  if (k.kind === "word" && k.value === c)
                    return V.ReplaceSkip({ kind: "word", value: m })
                })
                let u = "^".repeat(F([f]).length),
                  v = F([p]).indexOf(m),
                  h = ["```css", F([l]), " ".repeat(v) + u, "```"].join(`
`)
                console.warn(h)
              }
          }),
                  ...
                  (P(x, (b) => {
                    if (b.kind === "function") {
                      if (b.value === "--value") {
                        ...
                        return I
                          ? ((c = !0),
                            I.ratio ? (v = !0) : u.set(h, y),
                            V.ReplaceSkip(I.nodes))
                          : ((S = !0), V.Stop)
                      } else if (b.value === "--modifier") {
                        p = !0
                        let I = li(d, b, r)
                        return I
                          ? ((m = !0), V.ReplaceSkip(I.nodes))
                          : ((S = !0), V.Stop)
                      }
                    }
                  }),
          ...
          r.utilities.suggest(i.slice(0, -2), () => {
            ...
            for (let [
              ...
              if (f) l.push(...yt)
              else if (c) for (let m of yt) _(m) && l.push(m)
  ...
  for (let t of i.nodes) {
    ...
    if (
      ...
      if (n.endsWith("-*")) {
        ...
        let l = [s.shift()],
          d = r.theme.resolveWith(e.value, l, s)
        if (d) {
          let [, f = {}] = d
          {
            let c = f[s.pop()]
      ...
      if (s === null) continue
      if (s === "ratio") {
        let [l, d] = z(n, "/").map(Number)
        if (!_(l) || !_(d)) continue
      } else {
        if (s === "number" && !Q(n)) continue
        if (s === "percentage" && !_(n.slice(0, -1))) continue
      }
      if (s === "ratio") {
        let [l, d] = z(n, "/")
        return { nodes: M(`${l.trim()} / ${d.trim()}`), ratio: !0 }
      }
      return { nodes: M(n), ratio: !1 }
    } else if (
      e.kind === "arbitrary" &&
      t.kind === "word" &&
      t.value[0] === "[" &&
      ...
      if (J(e.value, [n]) !== null) return { nodes: M(e.value) }
    }
  }
}
function xe(e, i, r, t, n = "") {
    ...
    l = it(i, (f) =>
      r == null
        ...
        : f.startsWith("current")
          ? t(X(f, r))
          : ((f.startsWith("var(") || r.startsWith("var(")) && (s = !0),
            t(ai(f, r))),
    )
  function d(f) {
    return n
  ...
  return s
    ? [
        a(e, d(it(i, t))),
        Z("@supports (color: lab(from red l a b))", [a(e, d(l))]),
      ]
    : [a(e, d(l))]
}
  ...
  return s
    ? [
        a(
          ...
          n +
            z(i, ",")
              .map((d) => `drop-shadow(${it(d, t)})`)
              .join(" "),
        ),
        Z("@supports (color: lab(from red l a b))", [a(e, n + l)]),
      ]
    : [a(e, n + l)]
}
  ...
  return (
    P(t, (n) => {
      if (n.kind === "function" && n.value in nr) {
        let s = z(F(n.nodes).trim(), ",").map((d) => d.trim()),
          l = nr[n.value](r, i, ...s)
...
function Me(e) {
  ...
  return i !== t
    ? null
    : { attribute: n, operator: s, quote: f, value: d, sensitivity: c }
}
function je(e) {
  switch (e) {
    case 32:
    ...
    let t = 5
    {
      ...
      n &&
        ...
        e.theme.add(
          ...
          Fe(i.fontFamily.sans, "fontFeatureSettings") ?? "normal",
          t,
        ),
        e.theme.add(
          "--default-font-variation-settings",
          Fe(i.fontFamily.sans, "fontVariationSettings") ?? "normal",
          t,
        ))
    }
    {
      ...
      n &&
        ...
        e.theme.add(
          ...
          Fe(i.fontFamily.mono, "fontFeatureSettings") ?? "normal",
          t,
        ),
        e.theme.add(
          "--default-mono-font-variation-settings",
          Fe(i.fontFamily.mono, "fontVariationSettings") ?? "normal",
          t,
        ))
    }
  }
      ...
      exit(n, s) {
        if (n.kind === "word" && n.value !== "0") {
          ...
          let l = n.nodes[0],
            d = n.nodes[2].value,
            f = n.nodes[4],
            c = l.kind === "word" ? le.get(l.value) : null,
            p = f.kind === "word" ? le.get(f.value) : null
          if (
            d === "*" &&
            ((c?.[0] === 0 && c?.[1] === null) ||
              (p?.[0] === 0 && p?.[1] === null))
          )
            return (t = !0), V.ReplaceSkip(ne("0"))
          if (d === "*" && c?.[0] === 0 && c?.[1] !== null && p?.[1] === null)
            return (
              (t = !0),
              s.parent?.kind === "function"
                ? V.ReplaceSkip(ne(`0${c[1]}`))
                : V.ReplaceSkip(ne("0"))
            )
          if (d === "*" && p?.[0] === 0 && p?.[1] !== null && c?.[1] === null)
            return (
              (t = !0),
              s.parent?.kind === "function"
                ? V.ReplaceSkip(ne(`0${p[1]}`))
                : V.ReplaceSkip(ne("0"))
            )
          if (d === "*") {
            if (c?.[0] === 1 && c?.[1] === null)
              return (t = !0), V.ReplaceSkip(f)
            if (p?.[0] === 1 && p?.[1] === null)
              return (t = !0), V.ReplaceSkip(l)
          }
          if (d === "*" || d === "+") {
            let m = c ?? p,
              u = c === null ? l : p === null ? f : null
            if (
              m !== null &&
              u !== null &&
              u.kind === "function" &&
              (u.value === "calc" || u.value === "") &&
              u.nodes.length === 5 &&
              u.nodes[2].kind === "word" &&
              u.nodes[2].value === d
            ) {
              let v = u.nodes[0],
                h = u.nodes[4],
                k = v.kind === "word" ? le.get(v.value) : null,
                y = h.kind === "word" ? le.get(h.value) : null,
                S = k ?? y,
                x = k === null ? v : y === null ? h : null
              if (S !== null && x !== null) {
                if (
                  (d === "*" &&
                    !(
                ...
                let I = {
                  kind: "function",
                  value: n.value,
                  nodes: [ne(b), n.nodes[1], n.nodes[2], n.nodes[3], x],
                }
          ...
          switch (d) {
            case "*": {
              if (
                ...
                return (
                  (t = !0),
                  V.ReplaceSkip(ne(`${c[0] * p[0]}${c[1] ?? p[1] ?? ""}`))
                )
              break
            }
            case "+": {
              if (c[1] === p[1])
                return (
                  (t = !0), V.ReplaceSkip(ne(`${c[0] + p[0]}${c[1] ?? ""}`))
                )
              break
            }
            case "-": {
...
function xi(e, i) {
  if (i & 2) {
    ...
    if (e.property in bi)
      return bi[e.property]?.map((r) => a(r, e.value, e.important))
  }
  if (e.property in wi) {
    let r = z(e.value, " ")
...
var Ti = Symbol()
function bl() {
  return new U((e) => new U((i) => ({ rem: e, features: i })))
}
var lt = Symbol()
function yl(e) {
  return new U((i) => {
    ...
    return function (n, s) {
      ...
      let f = typeof s == "string" ? s : e.printCandidate(s),
        c = r.get(f)
...
function Al(e) {
  return new U(
    (i) =>
      new U((r) => ({ features: r, designSystem: e, signatureOptions: i })),
  )
}
function Cl(e, i, r) {
  let t = 0
...
function Sl(e, i) {
  ...
  return Array.from(s)
  function l(d) {
    let f = e.signatureOptions,
      c = r.storage[$t].get(f),
      p = r.storage[sr].get(f),
      m = d.map((x) => c.get(x))
          ...
          if (O.has("font-size")) {
            for (let L of O.get("font-size"))
              if (!D.has(L)) {
                D.add(L)
                for (let E of b)
                  Q(E) ? c.get(`text-[${L}]/${E}`) : c.get(`text-[${L}]/[${E}]`)
              }
          }
      }
    }
    let u = new U((x) => {
        let b = new U((D) => new U((O) => new Set())),
          I = new Set(c.get(x).keys())
        if (I.size === 0) return b
        for (let D of de(r, x))
          if (!(D.kind !== "functional" || D.value === null)) {
            for (let O of r.utilities.keys("functional")) {
              if (O === D.root) continue
              let L = Oi(r, { ...Ue(D), root: O }),
                E = c.get(L)
              for (let [j, q] of E)
                if (I.has(j)) for (let G of q) b.get(j).get(G).add(L)
            }
            return b
          }
        return b
      ...
      v = m.map((x, b) => {
        ...
        for (let D of x.keys()) {
          ...
          for (let L of x.get(D))
            for (let E of u.get(d[b]).get(D).get(L)) O.add(E)
    ...
    for (let x of k.values())
      for (let b of sa(x)) {
        ...
        let I = b.flatMap((O) => v[O]).reduce($i),
          D = r.storage[we].get(f).get(
            b
              .map((O) => d[O])
    ...
    return new U((s, l) => {
      for (let d of i.parseCandidate(s)) {
        let f = d.variants
          ...
          c = d.important
        if (c || f.length > 0) {
          let u = l.get(i.printCandidate({ ...d, variants: [], important: !1 }))
          return (
            i.theme.prefix !== null && f.length > 0 && (u = u.slice(r.length)),
            f.length > 0 &&
              (u = `${f.map((v) => i.printVariant(v)).join(":")}:${u}`),
            c && (u += "!"),
            i.theme.prefix !== null && f.length > 0 && (u = `${r}${u}`),
            u
          )
        }
        let p = n.get(s)
...
function Il(e, i) {
  return (
    e.kind === "arbitrary"
      ? (e.value = Ai(e.value, i.designSystem))
      : e.kind === "functional" &&
        e.value?.kind === "arbitrary" &&
        (e.value.value = Ai(e.value.value, i.designSystem)),
    e
  )
}
function Ai(e, i) {
  ...
  return (
    P(t, (n) => {
      if (
        ...
        return V.Replace(M(`--spacing(${F([n.nodes[4]])})`))
    }),
    F(t)
  )
}
...
function Dl(e) {
  ...
  function i(r) {
    function t(d, f = 0) {
      ...
      if (
        (P(c, (h) => {
          h.kind === "function" &&
            ...
            ((p += 1),
            P(h.nodes, (k) =>
              k.kind === "separator" && k.value.includes(",")
                ? V.Stop
                : k.kind === "word" && k.value === "/"
                  ? ((m += 1), V.Stop)
                  : V.Skip,
      ...
      return [
        Ct(c, (h, k) => {
          let y = z(h, "/").map((S) => S.trim())
          if (y.length > 2) return null
          if (c.length === 1 && y.length === 2 && f & 1) {
            let [S, x] = y
            if (/^\d+%$/.test(x)) u = { kind: "named", value: x.slice(0, -1) }
            else if (/^0?\.\d+$/.test(x)) {
              let b = Number(x) * 100
              u = {
    ...
    function n(d, f = !0) {
      let c = `--${We(Pe(d))}`
      return r.theme.get([c])
        ? f && r.theme.prefix
          ? `--${r.theme.prefix}-${c.slice(2)}`
          : c
        : null
    }
    function s(d, f) {
      ...
      if (p[0] === "spacing" && r.theme.get(["--spacing"])) {
        let m = p[1]
        return Q(m) ? `--spacing(${m})` : null
      }
      return null
    }
    function l(d, f) {
      let c = z(d, "/").map((u) => u.trim())
      d = c.shift()
      let p = n(d, !1)
      if (!p) return null
  ...
  return (
    P(e, (r, t) => {
      if (r.kind === "function" && r.value === "theme") {
        ...
        for (
          let c = l;
          c < r.nodes.length && !r.nodes[c].value.includes(",");
          c++
        )
          (s += F([r.nodes[c]])), (l = c + 1)
        s = Kl(s)
        let d = r.nodes.slice(l + 1),
          f = d.length > 0 ? i(s, F(d)) : i(s)
        if (f === null) return
        {
          let c = t.index - 1
          for (; c !== -1; ) {
...
function zl(e, i) {
  ...
  let r = i.designSystem,
    t = r.storage[ur].get(i.signatureOptions),
    n = r.storage[we].get(i.signatureOptions),
    s = r.storage[lt].get(i.signatureOptions),
  ...
  function* f(c, p) {
    ...
    if (m.length === 1) for (let u of de(r, m[0])) yield u
      ...
      if (
        ...
        k !== null &&
          Q(k) &&
          Ci(k, r, i.signatureOptions.rem) &&
          (yield Object.assign({}, p, {
            value: { kind: "named", value: k, fraction: null },
          }))
      }
      let v = r.storage[Vt]?.get(u) ?? null,
        h = ""
      v !== null && v < 0 && ((h = "-"), (v = Math.abs(v)))
      for (let k of Array.from(r.utilities.keys("functional")).sort(
        (y, S) => +(y[0] === "-") - +(S[0] === "-"),
      )) {
        h && (k = `${h}${k}`)
        for (let y of de(r, `${k}-${u}`)) yield y
        if (p.modifier) for (let y of de(r, `${k}-${u}${p.modifier}`)) yield y
        if (v !== null && Q(v) && Ci(v, r, i.signatureOptions.rem)) {
          for (let y of de(r, `${k}-${v}`)) yield y
          if (p.modifier)
            for (let y of de(r, `${k}-${v}${rt(p.modifier)}`)) yield y
        }
        for (let y of de(r, `${k}-[${u}]`)) yield y
        if (p.modifier)
          for (let y of de(r, `${k}-[${u}]${rt(p.modifier)}`)) yield y
      }
    }
  }
}
...
function Yl(e, i) {
  let r = i.designSystem,
    t = r.storage[lt].get(i.signatureOptions),
    n = Oi(r, e)
  for (let s of Bl(n)) {
    if (!t(e, s)) continue
    let [l] = de(r, s)
...
function* Ii(e, i = e.value?.value ?? "", r = new Set()) {
  ...
  if (
    ...
    let [s, l] = i.split("/")
    _(s) && _(l) && (yield { kind: "named", value: s, fraction: `${s}/${l}` })
  }
  let t = new Set()
...
function Jl(e, i) {
  ...
  for (let [l, d] of s)
    if (
      ...
      if (!Si(f)) continue
      if (
        (f.length === 1 && f[0].kind === "complex" && (f = f[0].nodes),
        d === null &&
          f.length === 3 &&
          f[0].kind === "selector" &&
          f[0].value === "&" &&
      ...
      if (
        ...
        f[0].kind === "compound" &&
        f[0].nodes.length === 2 &&
        f[0].nodes[0].kind === "selector" &&
        f[0].nodes[0].value === "&" &&
        f[0].nodes[1].kind === "function" &&
        f[0].nodes[1].value === ":has" &&
        f[0].nodes[1].nodes.length === 1 &&
        f[0].nodes[1].nodes[0].kind === "selector"
      ) {
      ...
      if (
        d === null &&
        f[0].kind === "selector" &&
        (f[0].value === "@media" || f[0].value === "@supports")
      ) {
        let u = n.get(t.printVariant(l)),
          v = M(oe(f, !0)),
          h = !1
        if (
          (P(v, (k) => {
            if (k.kind === "word" && k.value === "not")
              return (h = !0), V.Replace([])
          }),
          (v = M(F(v))),
          P(v, (k) => {
            k.kind === "separator" &&
      ...
      if (m.kind === "function" && m.value === ":is") {
        if (
          !Si(m.nodes) ||
          m.nodes.length !== 1 ||
          (m.nodes[0].kind === "selector" && !St(m.nodes[0]))
        )
          continue
        m = m.nodes[0]
      }
      if (
        ...
        let u = m,
          v = !1
        if (u.kind === "function" && u.value === ":not") {
          if (
            ((v = !0),
            u.nodes.length !== 1 ||
              (u.nodes[0].kind !== "selector" &&
                u.nodes[0].kind !== "function") ||
              u.nodes[0].value[0] !== ":")
          )
            continue
          u = u.nodes[0]
        ...
        let h = ((y) => {
          ...
          for (let [S, x] of [
            ...
            if (y === S && u.kind === "function" && u.nodes.length === 1)
              return u.nodes.length === 1 &&
                u.nodes[0].kind === "value" &&
                _(u.nodes[0].value)
                ? `${x}-${u.nodes[0].value}`
                : `${x}-[${oe(u.nodes, !0)}]`
        ...
        if (h === null) {
          if (c)
            return (
              pe(l, { kind: "arbitrary", selector: m.value, relative: !1 }),
              [c, l]
            )
          continue
        }
          ...
          pe(l, {
            ...
            value:
              u.value === null
                ...
                : {
                    kind: "arbitrary",
                    value: `${v}${u.operator}${u.quote ?? ""}${u.value}${u.quote ?? ""}${
            ...
            value:
              u.value === null
                ...
                : u.operator === "=" &&
                  ...
                  : {
                      kind: "arbitrary",
                      value: `${u.attribute}${u.operator}${u.quote ?? ""}${u.value}${u.quote ?? ""}${
                        u.sensitivity ? ` ${u.sensitivity}` : ""
                      }`,
                    },
          })
        } else pe(l, { kind: "arbitrary", selector: m.value, relative: !1 })
      }
      if (c) return [c, l]
    }
  return r
...
function Ql(e, i) {
  if (e.kind !== "functional" || e.value?.kind !== "arbitrary") return e
  let t = i.designSystem.storage[lt].get(i.signatureOptions),
    n = M(e.value.value)
  ...
  if (e.root[0] === "-") {
    if (n.length === 1 && n[0].kind === "function" && n[0].value === "var")
      return e
    let s = M(`calc(${e.value.value} * -1)`),
      [l, d] = nt(s, null, !1)
    if (l) {
      let f = Ue(e)
      ;(f.root = f.root.slice(1)),
        (f.value.value = F(d)),
        t(e, f) && ((e = f), (n = d))
    }
  }
        ...
        if (n.kind === "rule" || n.kind === "at-rule") {
          if (n.nodes.length > 1) {
            ...
            for (let l = n.nodes.length - 1; l >= 0; l--) {
              ...
              d.kind === "declaration" &&
                d.value !== void 0 &&
                (s.has(d.property) && n.nodes.splice(l, 1), s.add(d.property))
            }
          }
          n.nodes.sort((s, l) =>
          ...
          ;(Vi.lastIndex = 0),
            (n.value = n.value.replace(Vi, (s) => s.toLowerCase()))
        }
      },
    }),
    i
  ...
  return (
    P(t, (s) => {
      ...
      if (
        ...
        (n.add(l),
        d !== void 0 &&
          (s.nodes.length === 1 && ((r = !0), s.nodes.push(...M(`,${d}`))),
          s.nodes.length >= 3))
      ) {
        let f = F(s.nodes),
          c = `${s.nodes[0].value},${d}`
        if (f === c) return (r = !0), V.Replace(M(d))
      }
    }),
    r ? F(t) : e
  )
...
var sr = Symbol()
function ra() {
  return new U((e) => new U((i) => new U((r) => new Set())))
}
var $t = Symbol()
function ia(e) {
  return new U(
        ...
        try {
          ...
          P(Di(e, s, i), (l) => {
            l.kind === "declaration" &&
              ...
              e.storage[sr].get(i).get(l.property).get(l.value).add(r))
          })
        } catch {}
        return t
      }),
      ...
      if (typeof l == "string") {
        ...
        for (let d of s.modifiers) {
          ...
          let f = `${n}/${d}`,
            c = r.get(f)
          typeof c == "string" &&
            (t.get(c).push(f), e.storage[$t].get(i).get(f))
        }
      }
    }
    return t
          ...
          if (n.kind === "at-rule" && n.params.includes(" "))
            ...
            P(s, (d) => {
              if (d.kind === "list" || d.kind === "combinator") l = !0
                ...
                if (
                  d.nodes.length === 2 &&
                  d.nodes[0].kind === "selector" &&
                  d.nodes[0].value === "*" &&
                  d.nodes[1].kind === "selector" &&
                  d.nodes[1].value[0] === ":"
                )
                  return (l = !0), V.Replace(d.nodes[1])
              } else
                d.kind === "function" &&
                  d.value[0] === ":" &&
                  d.nodes[0]?.kind === "selector" &&
                  d.nodes[0]?.value[0] === ":" &&
                  ((l = !0), d.nodes.unshift({ kind: "selector", value: "*" }))
            }),
              l && (n.selector = oe(s, !0))
          }
        }),
...
var fa = /^\d+\/\d+$/
function Ui(e) {
  let i = new U((n) => ({ name: n, utility: n, fraction: !1, modifiers: [] }))
  ...
  for (let n of e.utilities.keys("functional")) {
    ...
    for (let l of s)
      for (let d of l.values) {
        let f = d !== null && fa.test(d),
          c = d === null ? n : `${n}-${d}`,
          p = i.get(c)
        if (
          ((p.utility = n),
          (p.fraction ||= f),
          p.modifiers.push(...l.modifiers),
          l.supportsNegative)
        ) {
          let m = i.get(`-${c}`)
          ;(m.utility = `-${n}`),
...
function ca(e) {
  ...
  for (let l of e) {
    ...
    r || ((r = { utility: d, items: [] }), t.set(d, r)),
      d !== r.utility &&
        (i.push(r), (r = { utility: d, items: [] }), t.set(d, r)),
      f ? n.get(d).push(l) : r.items.push(l)
  }
  ...
  let s = []
  for (let l of i)
    for (let d of l.items) s.push([d.name, { modifiers: d.modifiers }])
  return s
}
function Li(e) {
  let i = []
...
function zi(e, i) {
  let { astNodes: r, nodeSorting: t } = $e(Array.from(i), e),
...
var fr = class {
  ...
  compare(i, r) {
    ...
    return d === null
      ? -1
      : f === null || (d.kind === "arbitrary" && f.kind !== "arbitrary")
        ? 1
        : (d.kind !== "arbitrary" && f.kind === "arbitrary") ||
            d.value < f.value
          ? -1
          : 1
  }
  ...
  set(i, { kind: r, applyFn: t, compounds: n, compoundsWith: s, order: l }) {
    ...
    d
      ? Object.assign(d, { kind: r, applyFn: t, compounds: n })
      : (l === void 0 &&
...
function Mi(e) {
  ...
  function t(c, p) {
    return p.map((m) => {
      if (c === "@container") {
        let u = M(m.trim())
        return u.length >= 1 && u[0].kind === "function"
          ? `not ${m}`
          : u.length >= 3 &&
              u[0].kind === "word" &&
              u[0].value === "not" &&
            ...
            : u.length >= 5 &&
              ...
              : u.length >= 3 &&
                  ...
                  u[0].value !== "not" &&
                  u[2].kind === "function"
                ? (u.splice(1, 0, { kind: "separator", value: " " }, {
                    kind: "word",
                    value: "not",
                  }),
                  F(u))
  ...
  i.compound("not", 3, (c, p) => {
    ...
    i.suggest("not", () =>
      Array.from(i.keys()).filter((c) => i.compoundsWith("not", c)),
    ),
    i.compound("group", 2, (c, p) => {
      if (p.variant.kind === "arbitrary" && p.variant.relative) return null
      let m = p.modifier
          ? `:where(.${
              e.prefix ? `${e.prefix}\\:` : ""
            }group\\/${p.modifier.value})`
    ...
    i.suggest("group", () =>
      Array.from(i.keys()).filter((c) => i.compoundsWith("group", c)),
    ),
    i.compound("peer", 2, (c, p) => {
      if (p.variant.kind === "arbitrary" && p.variant.relative) return null
      let m = p.modifier
          ? `:where(.${
              e.prefix ? `${e.prefix}\\:` : ""
            }peer\\/${p.modifier.value})`
    ...
    i.suggest("peer", () =>
      Array.from(i.keys()).filter((c) => i.compoundsWith("peer", c)),
    ),
    ...
    r("details-content", ["&::details-content"])
  {
    ...
    i.static(
      ...
      (p) => {
        p.nodes = [
          H("&::before", [c(), a("content", "var(--tw-content)"), ...p.nodes]),
        ]
      },
      { compounds: 0 },
    ),
      i.static(
        ...
        (p) => {
          p.nodes = [
            H("&::after", [c(), a("content", "var(--tw-content)"), ...p.nodes]),
          ]
        },
        { compounds: 0 },
      )
  ...
  r("first", ["&:first-child"]),
    ...
    i.compound("in", 2, (c, p) => {
      ...
      if (
        (P([c], (u, v) => {
          ...
          ;(u.selector = `:where(${u.selector.replaceAll("&", "*")}) &`),
            (m = !0)
        }),
        !m)
      )
    ...
    i.suggest("in", () =>
      Array.from(i.keys()).filter((c) => i.compoundsWith("in", c)),
    ),
    i.compound("has", 2, (c, p) => {
      if (p.modifier) return null
      let m = !1
      if (
        (P([c], (u, v) => {
    ...
    i.suggest("has", () =>
      Array.from(i.keys()).filter((c) => i.compoundsWith("has", c)),
    ),
    i.functional("aria", (c, p) => {
    ...
    i.functional("nth", (c, p) => {
      if (
        !p.value ||
        p.modifier ||
        (p.value.kind === "named" && !_(p.value.value))
      )
        return null
    ...
    i.functional(
      ...
      (c, p) => {
        ...
        if (/^[\w-]*\s*\(/.test(m)) {
          ...
          c.nodes = [B("@supports", u, c.nodes)]
          return
        }
        m.includes(":") || (m = `${m}: var(--tw)`),
          (m[0] !== "(" || m[m.length - 1] !== ")") && (m = `(${m})`),
          (c.nodes = [B("@supports", m, c.nodes)])
      },
      { compounds: 1 },
    ),
    ...
    r("contrast-less", ["@media (prefers-contrast: less)"])
  {
    ...
    var f = c
    {
            ...
            case "functional": {
              ...
              return (
                u.value.kind === "arbitrary"
                  ? (v = u.value.value)
                  : u.value.kind === "named" &&
                    (v = e.resolveValue(u.value.value, ["--breakpoint"])),
      ...
      i.group(
        ...
        i.suggest("max", () => Array.from(p.keys()).filter((u) => u !== null)),
        i.group(
          () => {
        ...
        i.suggest("min", () => Array.from(p.keys()).filter((u) => u !== null))
    }
    {
      let p = e.namespace("--container"),
        m = new U((u) => {
          switch (u.kind) {
            case "functional": {
              ...
              return (
                u.value.kind === "arbitrary"
                  ? (v = u.value.value)
                  : u.value.kind === "named" &&
                    (v = e.resolveValue(u.value.value, ["--container"])),
                !v || v.includes("var(") ? null : v
              )
            }
            case "static":
      ...
      i.group(
        ...
        i.suggest("@min", () => Array.from(p.keys()).filter((u) => u !== null)),
        i.suggest("@", () => Array.from(p.keys()).filter((u) => u !== null))
    }
  }
  return (
...
function cr(e, i) {
  P(e, (r) => {
    ...
    if (
      ...
      return Object.assign(r, Y([B(r.name, r.params, r.nodes)])), V.Skip
  })
}
function at(e, i) {
  let r = 0
  return (
    P(e, (t) => {
      ...
      for (let [l, d] of s.entries()) {
        let f = H("&", l === s.length - 1 ? t.nodes : t.nodes.map(re)),
          c = z(d, ":")
...
function Fi(e, i) {
  ...
  let p = {
    ...
    getVariantOrder() {
      ...
      for (let k of m)
        k !== null &&
          (v !== void 0 && this.variants.compare(v, k) !== 0 && h++,
          u.set(k, h),
          (v = k))
      return u
    },
  ...
  return (
    s.sort((c, p) => {
      ...
      for (
        ...
        m.properties.order[v] === u.properties.order[v];
      )
        v += 1
      return (
        (m.properties.order[v] ?? 1 / 0) - (u.properties.order[v] ?? 1 / 0) ||
        u.properties.count - m.properties.count ||
        xt(m.candidate, u.candidate)
      )
    }),
...
function Yi(e) {
  for (let i of e)
    i.kind !== "at-root" &&
      (i.kind === "declaration"
        ? (i.important = !0)
        : (i.kind === "rule" || i.kind === "at-rule") && Yi(i.nodes))
}
function da(e) {
  let i = new Set(),
    r = 0,
  ...
  P([t], (m, u) => {
    if (m.kind === "at-rule") {
      ...
      if (m.name === "@apply") {
        ...
        ;(r |= 1), n.add(u.parent)
        for (let v of Gi(m, i))
          for (let h of u.path()) n.has(h) && s.get(h).add(v)
      }
    }
  })
  let d = new Set(),
...
${se([v])}`))
      ...
      for (let v of s.get(m))
        for (let h of l.get(v)) u.push(m), p(h, u), u.pop()
      d.add(m), c.delete(m), f.push(m)
    }
  }
  for (let m of n) p(m)
  for (let m of f)
    "nodes" in m &&
      P(m.nodes, (u) => {
        ...
        for (let [b, I] of v.entries())
          b % 2 === 0 &&
            (I[0] === "-" && I[1] === "-" ? y.push(I) : k.push(I), (h[I] = S)),
            (S += I.length)
        if (y.length) {
          if (k.length === 0) return V.Skip
          let b = y.join(" ")
          throw new Error(
            `You cannot use \`@apply\` with both mixins and utilities. Please move \`@apply ${b}\` into a separate rule.`,
          )
        }
        ...
        }
        {
          let b = Object.keys(h),
              ...
              onInvalidCandidate: (E) => {
                ...
                if (j.length > 1) {
                  ...
                  if (i.candidatesToCss([q])[0]) {
                    let G = i.candidatesToCss(
                        j.map((ie) => `${ie}:[--tw-variant-check:1]`),
                      ),
                      ee = j.filter((ie, o) => G[o] === null)
                    if (ee.length > 0) {
                      if (ee.length === 1)
                        throw new Error(
                        ...
                        )
                      {
                        ...
                        throw new Error(
                          `Cannot apply utility class \`${E}\` because the ${ie.format(ee.map((o) => `\`${o}\``))} variants do not exist.`,
                        )
                      }
                    }
                  }
            ...
            D = u.src,
            O = I.astNodes.map((E) => {
              let j = I.nodeSorting.get(E)?.candidate,
                q = j ? h[j] : void 0
              if (((E = re(E)), !D || !j || q === void 0))
                return (
                  P([E], (ee) => {
                    ee.src = D
                  }),
            ...
            L = []
          for (let E of O)
            if (E.kind === "rule") for (let j of E.nodes) L.push(j)
            else L.push(E)
          return V.Replace(L)
        }
      })
        ...
        return (
          l.push(
            (async () => {
              if (t > 100)
                throw new Error(
                  `Exceeded maximum recursion depth while resolving \`${c}\` in \`${i}\`)`,
                )
              let h = await r(c, i),
                k = Te(h.content, { from: n ? h.path : void 0 })
              await dr(k, h.base, r, t + 1, n),
                (v.nodes = ga(d, [ve({ base: h.base }, k)], p, m, u))
            })(),
          ),
          V.ReplaceSkip(v)
        )
  ...
  return function (n, s) {
    ...
    let f = (() => {
      let c = Pe(n),
        ...
        u = r(qi(i() ?? {}, c) ?? null)
      if (
        (typeof u == "string" && (u = u.replace("<alpha-value>", "1")),
        typeof p != "object")
      )
      ...
      if (u !== null && typeof u == "object" && !Array.isArray(u)) {
        ...
        for (let h in p)
          h !== "__CSS_VALUES__" &&
            ((u?.__CSS_VALUES__?.[h] & 4 && qi(v, h.split("-")) !== void 0) ||
              (v[Ie(h)] = p[h]))
        return v
      }
...
function ha(e, i) {
  ...
  for (let [p, m] of s) {
    ...
    let u = p.indexOf("--"),
      v = p.slice(0, u),
      h = p.slice(u + 2)
    ;(h = h.replace(/-([a-z])/g, (k, y) => y.toUpperCase())),
      n.get(v === "" ? null : v).set(h, [m, e.getOptions(`--${r}${p}`)])
  }
  ...
  return i[i.length - 1] === "DEFAULT"
    ? [f?.DEFAULT ?? null, c.DEFAULT ?? 0]
    : "DEFAULT" in f && Object.keys(f).length === 1
      ? [f.DEFAULT, c.DEFAULT ?? 0]
      : ((f.__CSS_VALUES__ = c), [f, c])
}
function qi(e, i) {
    ...
    addVariant(d, f) {
      ...
      if (typeof f == "string") {
        ...
        let p = function (m, u) {
          return Object.entries(m).some(
            ([v, h]) => v.includes(u) || (typeof h == "object" && p(h, u)),
          )
        }
        var c = p
        if (p(f, ":merge(")) return
      ...
      typeof f == "string" || Array.isArray(f)
        ? e.variants.static(
            ...
            { compounds: Oe(typeof f == "string" ? [f] : f) },
          )
        : typeof f == "object" && e.variants.fromAst(d, ke(f), e)
    },
    matchVariant(d, f, c) {
      function p(u, v, h) {
      ...
      e.variants.group(
        ...
        (u, v) => {
          ...
          let h = u.value ? u.value.value : "DEFAULT",
            k = v.value ? v.value.value : "DEFAULT",
            y =
              (c?.values && Object.hasOwn(c.values, h)
                ? c.values[h]
                : void 0) ?? h,
            S =
              (c?.values && Object.hasOwn(c.values, k)
                ? c.values[k]
                : void 0) ?? k
          if (c && typeof c.sort == "function")
            return c.sort({ value: y, modifier: u.modifier?.value ?? null }, {
              value: S,
        ...
        e.variants.suggest(d, () =>
          Object.keys(c?.values ?? {}).filter((u) => u !== "DEFAULT"),
        )
    },
    addUtilities(d) {
      d = Array.isArray(d) ? d : [d]
      let f = d.flatMap((p) => Object.entries(p))
      f = f.flatMap(([p, m]) => z(p, ",").map((u) => [u.trim(), m]))
      let c = new U(() => [])
      for (let [p, m] of f) {
        ...
        if (
          ...
          throw new Error(
            `\`addUtilities({ '${p}' : \u2026 })\` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar-none\`.`,
          )
      }
      for (let [p, m] of c)
        e.theme.prefix &&
    ...
    matchUtilities(d, f) {
      ...
      for (let [m, u] of Object.entries(d)) {
        let v = function ({ negative: h }) {
          return (k) => {
            if (
              ...
              c.length > 0 &&
              !c.includes("any") &&
              ((k.value.dataType && !c.includes(k.value.dataType)) ||
                (!k.value.dataType && !J(k.value.value, c)))
            )
              return
            let y = c.includes("color"),
              S = null,
              x = !1
            {
              let D = f?.values ?? {}
              y &&
                ...
                k.value
                  ? k.value.kind === "arbitrary"
                    ? (S = k.value.value)
                    : k.value.fraction && Object.hasOwn(D, k.value.fraction)
                      ? ((S = D[k.value.fraction]), (x = !0))
                      : Object.hasOwn(D, k.value.value)
                        ? (S = D[k.value.value])
                        : D.__BARE_VALUE__ &&
                          ((S = D.__BARE_VALUE__(k.value) ?? null),
                          (x =
                            (k.value.fraction !== null && S?.includes("/")) ??
                            !1))
                  : (S = D.DEFAULT ?? null)
            }
            if (S === null) return
            let b
            {
              ...
              k.modifier
                ? D === "any" || k.modifier.kind === "arbitrary"
                  ? (b = k.modifier.value)
                  : D && Object.hasOwn(D, k.modifier.value)
                    ? (b = D[k.modifier.value])
                    : y && !Number.isNaN(Number(k.modifier.value))
                      ? (b = `${k.modifier.value}%`)
                      : (b = null)
                : (b = null)
            }
        ...
        f?.supportsNegativeValues &&
          e.utilities.functional(`-${m}`, v({ negative: !0 }), { types: c }),
          e.utilities.functional(m, v({ negative: !1 }), { types: c }),
          e.utilities.suggest(m, () => {
            let h = f?.values ?? {},
              k = new Set(Object.keys(h))
            k.delete("__BARE_VALUE__"),
              k.delete("__CSS_VALUES__"),
  ...
  for (let [t, n] of r)
    if (n != null && n !== !1)
      if (typeof n != "object") {
        ...
        for (let s of n)
          typeof s == "string" ? i.push(a(t, s)) : i.push(Z(t, ke(s)))
...
function Qi(e, i, r) {
  P(e, (t) => {
    if (t.kind === "rule") {
      let n = fe(t.selector)
      P(n, (s) => {
        s.kind === "selector" && s.value === `.${i}` && (s.value = `.${_e(r)}`)
      }),
        (t.selector = oe(n))
    }
  })
...
function gr(e, { config: i, base: r, path: t, reference: n, src: s }) {
  ...
  for (let c of i.plugins ?? [])
    "__isOptionsFunction" in c
      ? l.push({ ...c(), reference: n, src: s })
      : "handler" in c
        ? l.push({ ...c, reference: n, src: s })
        : l.push({ handler: c, reference: n, src: s })
...
function ba(e) {
  let i = new Set(),
    r = Rt(e.design, () => e.theme, n),
    t = Object.assign(r, { theme: r, colors: kr })
  function n(s) {
...
function ya({ center: e, padding: i, screens: r }, t) {
  let n = [],
    s = null
  if (
    (e && n.push(a("margin-inline", "auto")),
    (typeof i == "string" ||
      (typeof i == "object" && i !== null && "DEFAULT" in i)) &&
      n.push(a("padding-inline", typeof i == "string" ? i : i.DEFAULT)),
    ...
    if ((l.sort((d, f) => Ee(d[1], f[1], "asc")), l.length > 0)) {
      let [d] = l[0]
      n.push(
        B("@media", `(width >= --theme(--breakpoint-${d}))`, [
          a("max-width", "none"),
        ]),
      )
    }
  ...
  if (typeof i == "object" && i !== null) {
    let l = Object.entries(i)
      .filter(([d]) => d !== "DEFAULT")
      .map(([d, f]) => [d, t.theme.resolveValue(d, ["--breakpoint"]), f])
      .filter(Boolean)
    l.sort((d, f) => Ee(d[1], f[1], "asc"))
    for (let [d, , f] of l)
      if (s && s.has(d)) s.get(d).nodes.push(a("padding-inline", f))
      else {
        if (s) continue
        n.push(
          B("@media", `(width >= theme(--breakpoint-${d}))`, [
  ...
  for (let [r, t] of [
    ...
    e.utilities.suggest(`bg-gradient-to-${r}`, () => []),
      e.utilities.static(`bg-gradient-to-${r}`, () => [
        a("--tw-gradient-position", `to ${t} in oklab`),
        a("background-image", "linear-gradient(var(--tw-gradient-stops))"),
      ])
  e.utilities.suggest("bg-left-top", () => []),
    ...
    e.utilities.functional("flex-shrink", (r) => {
      if (!r.modifier) {
        ...
        if (_(r.value.value)) return [a("flex-shrink", r.value.value)]
      }
    }),
    ...
    e.utilities.functional("flex-grow", (r) => {
      if (!r.modifier) {
        ...
        if (_(r.value.value)) return [a("flex-grow", r.value.value)]
      }
    }),
    e.utilities.suggest("order-none", () => []),
    e.utilities.static("order-none", () => [a("order", "0")]),
    e.utilities.suggest("break-words", () => []),
    e.utilities.static("break-words", () => [a("overflow-wrap", "break-word")])
  for (let [r, t] of [
    ...
    let n = function ({ negative: s }) {
      return (l) => {
        ...
        let d = e.theme.resolve(l.value.fraction ?? l.value.value, [
          "--inset",
          "--spacing",
        ])
        if (d === null && l.value.fraction) {
          let [f, c] = z(l.value.fraction, "/")
          if (!_(f) || !_(c)) return
          d = `calc(${l.value.fraction} * 100%)`
        }
        if (d === null && s) {
          ...
          if (
            f &&
            Q(l.value.value) &&
            ((d = `calc(${f} * -${l.value.value})`), d !== null)
          )
            return [a(t, d)]
        }
        if (d === null) {
          let f = e.theme.resolve(null, ["--spacing"])
          f && Q(l.value.value) && (d = `calc(${f} * ${l.value.value})`)
        }
        if (d !== null) return [a(t, s ? `calc(${d} * -1)` : d)]
      }
    }
    var i = n
    e.utilities.static(`${r}-auto`, () => [a(t, "auto")]),
      e.utilities.static(`${r}-full`, () => [a(t, "100%")]),
      e.utilities.static(`-${r}-full`, () => [a(t, "-100%")]),
      e.utilities.static(`${r}-px`, () => [a(t, "1px")]),
      e.utilities.static(`-${r}-px`, () => [a(t, "-1px")]),
...
function ln(e, i) {
  ...
  for (let [l, d] of Object.entries(r)) {
    ...
    var s = u
    let f = i.variants.get(l),
      c = i.theme.resolveValue(l, ["--breakpoint"])
...
function an(e, i) {
  ...
  if (Object.keys(r).length > 0) {
    ...
    i.variants.functional(
      ...
      (f, c) => {
        let p = c.value
        return p && p.kind === "named" && p.value in r
          ? l?.(f, { ...c, value: { kind: "arbitrary", value: r[p.value] } })
          : l?.(f, c)
      },
      { compounds: d },
    )
  ...
  if (Object.keys(t).length > 0) {
    ...
    i.variants.functional(
      ...
      (f, c) => {
        let p = c.value
        return p && p.kind === "named" && p.value in t
          ? l?.(f, { ...c, value: { kind: "arbitrary", value: t[p.value] } })
          : l?.(f, c)
      },
      { compounds: d },
    )
    ...
    i.variants.functional(
      ...
      (f, c) => {
        ...
        return p && p.kind === "named" && p.value in n
          ? l?.(f, { ...c, value: { kind: "arbitrary", value: n[p.value] } })
          : l?.(f, c)
      },
      { compounds: d },
    )
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`)
  ...
  if (
    ((e.resolveThemeValue = function (u, v) {
      return u.startsWith("--")
        ? f(u, v)
        : ((s |= on({
            designSystem: e,
  ...
  let [c, p] = await Promise.all([
    Promise.all(
      d.map(async ({ id: m, base: u, reference: v, src: h }) => {
        let k = await t(m, u, "config")
        return { path: m, base: k.base, config: k.module, reference: v, src: h }
      }),
    ),
    Promise.all(
      l.map(async ([{ id: m, base: u, reference: v, src: h }, k]) => {
...
function on({
  ...
  let l = 0,
    ...
    { resolvedConfig: c } = hr(e, [
      { config: en(e.theme), base: i, reference: !0, src: void 0 },
      ...f,
      { config: { plugins: [rn] }, base: i, reference: !0, src: void 0 },
    ]),
    { resolvedConfig: p, replacedThemeKeys: m } = hr(e, f),
    u = {
      designSystem: e,
      ast: r,
      resolvedConfig: c,
    ...
    v = mr({ ...u, referenceMode: !1, src: void 0 }),
  ...
  for (let { handler: k, reference: y, src: S } of c.plugins) {
    let x = mr({ ...u, referenceMode: y ?? !1, src: S })
    k(x)
  }
  if (
    (gi(e, p, m),
  ...
  if (
    ...
    P(r, (y, S) => {
      if (
        ...
        return
      let x = et(S)
      return x.parent?.kind === "rule" && x.parent.selector === k
        ? V.Stop
        : V.ReplaceStop(H(k, [y]))
    })
  }
...
This feature is not currently supported.`)
    let y = !1
    k.pattern[0] == "!" && ((y = !0), (k.pattern = k.pattern.slice(1))),
      t.push({ ...k, negated: y })
  }
  return l
}
function un({ ast: e }) {
  let i = new U((n) => ft(n.code)),
    r = new U((n) => ({ url: n.file, content: n.code, ignore: !1 })),
  ...
  P(e, (n) => {
    ...
    let l = i.get(n.src[0]),
      d = i.get(n.dst[0]),
      f = s.content.slice(n.src[1], n.src[2]),
      c = 0
    for (let u of f.split(`
`)) {
      if (u.trim() !== "") {
        let v = l.find(n.src[1] + c),
          h = d.find(n.dst[1])
        t.mappings.push({
          name: null,
...
function Pt(e) {
  ...
  let d = n.slice(1, l),
    f = n.slice(l + 1),
    c
  Ca(d) ? (c = Sa(d)) : (c = z(d, ",")), (c = c.flatMap((m) => Pt(m)))
  let p = Pt(f)
...
var ze = ((f) => (
  (f[f.None = 0] = "None"),
  (f[f.AtApply = 1] = "AtApply"),
  (f[f.AtImport = 2] = "AtImport"),
  (f[f.JsPluginCompat = 4] = "JsPluginCompat"),
  (f[f.ThemeFunction = 8] = "ThemeFunction"),
  (f[f.Utilities = 16] = "Utilities"),
  (f[f.Variants = 32] = "Variants"),
  (f[f.AtTheme = 64] = "AtTheme"),
  f
))(ze || {})
async function pn(
  e,
  { base: i = "", from: r, loadModule: t = $a, loadStylesheet: n = Ta } = {},
) {
  let s = 0
  ...
  P(e, (b, I) => {
    ...
    if (b.name === "@utility") {
      ...
      if (O === null) {
        if (!b.params.endsWith("-*")) {
          if (b.params.endsWith("*"))
            throw new Error(
              `\`@utility ${b.params}\` defines an invalid utility name. A functional utility must end in \`-*\`.`,
            )
          if (b.params.includes("*"))
            throw new Error(
              `\`@utility ${b.params}\` defines an invalid utility name. The dynamic portion marked by \`-*\` must appear once at the end.`,
            )
        }
        throw new Error(
    ...
    if (b.name === "@source") {
      ...
      } else h.push({ base: D.context.base, pattern: j, negated: O })
      return V.ReplaceSkip([])
    }
    if (
      (b.name === "@variant" &&
          ...
          ? b.nodes.length === 0
            ...
            : (P(b.nodes, (O) => {
                if (O.kind === "at-rule" && O.name === "@slot")
                  return (b.name = "@custom-variant"), V.Stop
              }),
              b.name === "@variant" && v.push(b))
          : v.push(b)),
      b.name === "@custom-variant")
    ) {
      if (D.parent !== null)
      ...
      if (b.nodes.length === 0) {
        ...
        if (E.length === 0 || E.some((G) => G.trim() === ""))
          throw new Error(
            `\`@custom-variant ${O} (${E.join(",")})\` selector is invalid.`,
          )
        let j = [],
          q = []
        ...
        if (E.startsWith("source(")) {
          ...
          P(b.nodes, (q) => {
            if (
              ...
              return (
                (q.params += ` source(${j})`),
                V.ReplaceStop([ve({ sourceBase: D.context.base }, [q])])
              )
          })
          ...
          P(b.nodes, (q) => {
            if (q.kind === "at-rule" && q.name === "@theme")
              return (q.params += ` prefix(${j})`), V.Skip
          })
        } else
          E === "important"
            ? (l = !0)
            : E === "reference"
              ? (b.nodes = [ve({ reference: !0 }, b.nodes)])
              : L.push(E)
      ...
      return (
        P(b.nodes, (E) => {
          if (E.kind === "at-rule" && E.name === "@keyframes")
            return d.addKeyframes(E), V.Skip
          if (E.kind === "comment") return
          if (E.kind === "declaration" && E.property.startsWith("--")) {
            d.add(Ie(E.property), E.value ?? "", O, E.src)
            return
          }
          let j = se([B(b.name, b.params, [E])])
            .split(`
`)
            .map(
              (q, G, ee) => `${G === 0 || G >= ee.length - 2 ? " " : ">"} ${q}`,
            )
            .join(`
`)
...
${j}`)
        ...
        m
          ? V.ReplaceSkip([])
          : ((m = H(":root, :host", [])), (m.src = b.src), V.ReplaceSkip(m))
      )
    }
  })
  let x = Fi(d, u?.src)
  if ((l && (x.important = l), y.length > 0))
    for (let b of y) x.invalidCandidates.add(b)
  ...
  for (let b of cn(c, {
    onCircularDependency(I, D) {
      let O = se(
        I.map((L, E) =>
          B("@custom-variant", L, [B("@variant", I[E + 1] ?? D, [])]),
        ),
      )
        .replaceAll(";", " { \u2026 }")
        .replace(
...
${O}`)
  ...
  return (
    P(e, (b) => {
      if (b.kind === "at-rule")
        return b.name === "@utility" ? V.Replace([]) : V.Skip
    }),
    {
      designSystem: x,
      ast: e,
  ...
  return {
    ...
    build(h) {
      ...
      return (
        ...
        !y && u === x.length
          ? ((m ??= Ne(t, r, i.polyfills)), m)
          : ((u = x.length), (l.nodes = x), (m = Ne(t, r, i.polyfills)), m)
      )
    },
  }
}
async function zf(e, i = {}) {
  let r = Te(e, { from: i.from }),
    t = await Ea(r, i),
    n = r,
    s = e
  return {
...
export {
  ze as Features,
  Ht as Polyfills,
  jf as __unstable__loadDesignSystem,
  zf as compile,
  Ea as compileAst,
  Ra as default,
}
