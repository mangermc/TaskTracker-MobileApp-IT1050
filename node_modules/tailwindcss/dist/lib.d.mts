...
declare function compileAstNodes(
  candidate: Candidate,
...
declare class Utilities {
  ...
  functional(
    name: string,
    compileFn: CompileFn<"functional">,
    options?: UtilityOptions,
  ): void
...
declare function __unstable__loadDesignSystem(
  css: string,
  opts?: CompileOptions,
...
export {
  ...
  compile,
  compileAst,
  postcssPluginWarning as default,
}
