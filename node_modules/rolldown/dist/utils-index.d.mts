...
} from "./shared/binding-D26QphWG.mjs"
import {
  a as MinifyOptions,
  c as minifySync,
  d as parse,
  ...
  u as ParserOptions,
} from "./shared/transform-BPrUvqEZ.mjs"
...
interface VisitorObject$1 {
  ...
  Literal?: (
    node: ESTree.BooleanLiteral | ESTree.NullLiteral | ESTree.NumericLiteral | ESTree.StringLiteral | ESTree.BigIntLiteral | ESTree.RegExpLiteral,
  ) => void
  "Literal:exit"?: (
    node: ESTree.BooleanLiteral | ESTree.NullLiteral | ESTree.NumericLiteral | ESTree.StringLiteral | ESTree.BigIntLiteral | ESTree.RegExpLiteral,
  ) => void
  ...
  Identifier?: (
    node: ESTree.IdentifierName | ESTree.IdentifierReference | ESTree.BindingIdentifier | ESTree.LabelIdentifier | ESTree.TSThisParameter | ESTree.TSIndexSignatureName,
  ) => void
  "Identifier:exit"?: (
    node: ESTree.IdentifierName | ESTree.IdentifierReference | ESTree.BindingIdentifier | ESTree.LabelIdentifier | ESTree.TSThisParameter | ESTree.TSIndexSignatureName,
  ) => void
  ...
  Property?: (
    node: ESTree.ObjectProperty | ESTree.AssignmentTargetProperty | ESTree.AssignmentTargetPropertyProperty | ESTree.BindingProperty,
  ) => void
  "Property:exit"?: (
    node: ESTree.ObjectProperty | ESTree.AssignmentTargetProperty | ESTree.AssignmentTargetPropertyProperty | ESTree.BindingProperty,
  ) => void
