import {
  n as __toESM,
  t as require_binding,
} from "./shared/binding-TuFFIE_J.mjs"
import {
  n as BuiltinPlugin,
  t as normalizedStringOrRegex,
} from "./shared/normalize-string-or-regex-dnh67V_w.mjs"
...
import {
  ...
  r as normalizeBindingResult,
} from "./shared/error-BHRSI0R7.mjs"
...
import {
  ...
  p as viteWebWorkerPostPlugin,
  r as oxcRuntimePlugin,
  s as viteJsonPlugin,
  u as viteReactRefreshWrapperPlugin,
} from "./shared/constructors-D_3i7dpX.mjs"
import {
  a as minify$1,
...
} from "./shared/resolve-tsconfig-DxqIJB3x.mjs"
...
var DevEngine = class DevEngine {
  ...
  static async create(inputOptions, outputOptions = {}, devOptions = {}) {
    ...
    const bindingOnOutput = userOnOutput
      ? function (rawResult) {
          const result = normalizeBindingResult(rawResult)
          if (result instanceof Error) {
            userOnOutput(result)
    ...
    const bindingDevOptions = {
      ...
      onAdditionalAssets: userOnAdditionalAssets
        ? function (output) {
    ...
    const inner = new import_binding.BindingDevEngine(
  ...
  async invalidate(file, firstInvalidatedBy) {
    return unwrapBindingResult(
      await this.#inner.invalidate(file, firstInvalidatedBy),
    )
  }
