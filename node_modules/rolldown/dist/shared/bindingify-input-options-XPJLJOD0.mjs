...
} from "./normalize-string-or-regex-dnh67V_w.mjs"
import {
  a as unreachable,
  o as unsupported,
  r as noop,
  t as arraify,
} from "./misc-CoQm4NHO.mjs"
import {
  a as bindingifySourcemap,
  i as unwrapBindingResult,
  t as aggregateBindingErrorsIntoJsError,
} from "./error-BHRSI0R7.mjs"
...
__decorate(
  [lazyProp],
  NormalizedInputOptionsImpl.prototype,
  "shimMissingExports",
  null,
)
...
var NormalizedOutputOptionsImpl = class extends PlainObjectLike {
  ...
  get sourcemapFileNames() {
    return (
      this.inner.sourcemapFilenames || this.outputOptions.sourcemapFileNames
    )
  }
...
__decorate(
  [lazyProp],
  NormalizedOutputOptionsImpl.prototype,
  "entryFileNames",
  null,
)
__decorate(
...
Object.defineProperty(
  import_binding.BindingMagicString.prototype,
...
const nativeAppendRight =
  import_binding.BindingMagicString.prototype.appendRight
const nativePrependLeft =
  import_binding.BindingMagicString.prototype.prependLeft
const nativePrependRight =
  import_binding.BindingMagicString.prototype.prependRight
...
import_binding.BindingMagicString.prototype.appendLeft = function (
  index,
  content,
) {
...
import_binding.BindingMagicString.prototype.appendRight = function (
  index,
  content,
) {
  assertString(content, "inserted content must be a string")
...
import_binding.BindingMagicString.prototype.prependLeft = function (
  index,
  content,
) {
  assertString(content, "inserted content must be a string")
...
import_binding.BindingMagicString.prototype.prependRight = function (
  index,
  content,
) {
  assertString(content, "inserted content must be a string")
...
import_binding.BindingMagicString.prototype.overwrite = function (
  start,
  end,
  content,
  options,
...
import_binding.BindingMagicString.prototype.update = function (
  start,
  end,
  content,
  options,
...
import_binding.BindingMagicString.prototype.replace = function (
  searchValue,
  replacement,
) {
...
import_binding.BindingMagicString.prototype.replaceAll = function (
  searchValue,
  replacement,
) {
  if (typeof searchValue === "string")
  ...
  async load(options) {
    ...
    if (!loadPromise) {
      loadPromise = this.context
        .load(
          id,
          options.moduleSideEffects ?? void 0,
          options.packageJsonPath ?? void 0,
        )
        .catch(() => {
    ...
    plugin: async (ctx, code, id, meta) => {
      ...
      return {
        ...
        map:
          ...
          (mapHandledByNativeChannel || ret.map === null ? null : void 0),
    ...
    return {
      alias: alias
        ? Object.entries(alias).map(([name, replacement]) => ({
            find: name,
            replacements:
              replacement === false ? [void 0] : arraify(replacement),
          }))
        : void 0,
...
function bindingifyWatch(watch) {
  if (watch) {
    if (watch.notify)
      console.warn(
        'The "watch.notify" option is deprecated. Please use "watch.watcher" instead.',
      )
    const watcher = {
      ...watch.notify,
      ...watch.watcher,
...
function bindingifyTreeshakeOptions(config) {
  ...
  if (config.moduleSideEffects === void 0)
...
export {
  ...
  PluginContextData as i,
  transformAssetSource as l,
  normalizeLog as m,
  bindingifyPlugin as n,
  transformToRollupOutput as o,
  normalizeHook as p,
  RolldownMagicString as r,
