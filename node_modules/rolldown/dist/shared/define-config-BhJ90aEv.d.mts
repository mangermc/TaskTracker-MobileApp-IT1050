...
type MakeAsync<Function_,> = Function_ extends ((
  ...
  ? (...parameters: Arguments) => Return | Promise<Return>
  : never
...
/** @category Plugin APIs */
type CodeSplittingNameFunction = (
  moduleId: string,
  ctx: ChunkingContext,
) => string | NullValue
/** @inline */
...
type RolldownMagicStringConstructor = Omit<typeof BindingMagicString, "prototype"> & {
  new (
    ...args: ConstructorParameters<typeof BindingMagicString>
  ): RolldownMagicString
...
interface TransformOptions
  extends Omit<TransformOptions$1, "sourceType" | "lang" | "cwd" | "sourcemap" | "define" | "inject" | "jsx"> {
  /**
...
type ModuleSideEffectsOption = boolean | readonly string[] | ModuleSideEffectsRule[] | ((
  id: string,
  external: boolean,
) => boolean | undefined) | "no-external"
/**
...
interface PartialResolvedId
  extends SpecifiedModuleOptions,
    Partial<PartialNull<ModuleOptions>> {
    /**
...
interface FunctionPluginHooks {
   ...
   * @group Build Hooks
   */
  [DEFINED_HOOK_NAMES.buildStart]: (options: NormalizedInputOptions) => void
  /**
   ...
   * @group Build Hooks
   */
  [DEFINED_HOOK_NAMES.load]: (id: string) => MaybePromise<LoadResult>
  /**
   ...
   * @group Build Hooks
   */
  [DEFINED_HOOK_NAMES.moduleParsed]: (moduleInfo: ModuleInfo) => void
  /**
   ...
   * @group Build Hooks
   */
  [DEFINED_HOOK_NAMES.buildEnd]: (err?: Error) => void
  /**
  ...
  ) => NullValue | string | RolldownMagicString | {
    code: string | RolldownMagicString
    map?: SourceMapInput
  }
  /**
   ...
   * @group Output Generation Hooks
   */
  [DEFINED_HOOK_NAMES.augmentChunkHash]: (chunk: RenderedChunk) => string | void
  /**
   ...
   * @group Output Generation Hooks
   */
  [DEFINED_HOOK_NAMES.renderError]: (error: Error) => void
  /**
   ...
   * @group Output Generation Hooks
   */
  [DEFINED_HOOK_NAMES.closeBundle]: (error?: Error) => void
  /**
   ...
   * @group Build Hooks
   */
  [DEFINED_HOOK_NAMES.closeWatcher]: () => void
}
  ...
  : K extends "load"
    ...
    : K extends "resolveId"
      ...
      : K extends "renderChunk"
        ...
        : {}
type PluginHooks = {
  [K in keyof FunctionPluginHooks]: ObjectHook<K extends AsyncPluginHooks
    ? MakeAsync<FunctionPluginHooks[K]>
    : FunctionPluginHooks[K], HookFilterExtension<K> & K extends ParallelPluginHooks
    ? {
      /**
       * @deprecated
...
type AddonHookFunction = (chunk: RenderedChunk) => string | Promise<string>
...
type OnwarnFunction = (
  warning: RolldownLog,
  defaultHandler: (
    warning: RolldownLogWithString | (() => RolldownLogWithString),
  ) => void,
) => void
...
//#endregion
export {
  MinimalPluginContext as $,
  SourcemapIgnoreListOption as $t,
  RolldownPlugin as A,
  ChunkingContext as At,
  SourceMapInput as B,
  OutputOptions as Bt,
  ParallelPluginHooks as C,
  BuildOptions as Ct,
  ResolveIdExtraOptions as D,
  AdvancedChunksOptions as Dt,
  PluginMeta as E,
  AdvancedChunksGroup as Et,
  BuiltinPlugin as F,
  GeneratedCodeOptions as Ft,
  EmittedChunk as G,
  OutputAsset as Gt,
  TreeshakingOptions as H,
  MaybePromise as Ht,
  RUNTIME_MODULE_ID as I,
  GeneratedCodePreset as It,
  GetModuleInfo as J,
  RenderedModule as Jt,
  EmittedFile as K,
  OutputChunk as Kt,
  VERSION as L,
  GlobalsFunction as Lt,
  SourceDescription as M,
  CodeSplittingNameFunction as Mt,
  TransformResult as N,
  CodeSplittingOptions as Nt,
  ResolveIdResult as O,
  BuiltinModuleTag as Ot,
  withFilter as P,
  CommentsOptions as Pt,
  defineParallelPlugin as Q,
  ModuleInfo as Qt,
  BundleError as R,
  MinifyOptions as Rt,
  ObjectHook as S,
  ...
  Plugin as T,
  AddonFunction as Tt,
  TransformPluginContext as U,
  PartialNull as Ut,
  OutputBundle as V,
  PreRenderedAsset as Vt,
  EmittedAsset as W,
  StringOrRegExp as Wt,
  PluginContextResolveOptions as X,
  SourceMap as Xt,
  PluginContext as Y,
  RolldownOutput as Yt,
  DefineParallelPluginResult as Z,
  freeExternalMemory as Zt,
  HookFilterExtension as _,
  RolldownWatcher as _t,
  ChunkOptimizationOptions as a,
  RolldownDirectoryEntry as at,
  ModuleOptions as b,
  WatchOptions as bt,
  InputOption as c,
  InternalModuleFormat as ct,
  OptimizationOptions as d,
  TransformOptions as dt,
  PluginContextMeta as et,
  WatcherFileWatcherOptions as f,
  ChecksOptions as ft,
  FunctionPluginHooks as g,
  watch as gt,
  CustomPluginOptions as h,
  RolldownMagicString as ht,
  RolldownOptions as i,
  BufferEncoding as it,
  RolldownPluginOption as j,
  CodeSplittingGroup as jt,
  ResolvedId as k,
  ChunkFileNamesFunction as kt,
  InputOptions as l,
  NormalizedOutputOptions as lt,
  AsyncPluginHooks as m,
  WarningHandlerWithDefault as mt,
  RolldownOptionsFunction as n,
  HookFilter as nt,
  ExternalOption as o,
  RolldownFileStats as ot,
  WatcherOptions as p,
  LoggingFunction as pt,
  EmittedPrebuiltChunk as q,
  RenderedChunk as qt,
  defineConfig as r,
  ModuleTypeFilter as rt,
  ExternalOptionFunction as s,
  RolldownFsModule as st,
  ConfigExport as t,
  GeneralHookFilter as tt,
  ModuleTypes as u,
  NormalizedInputOptions as ut,
  ImportKind as v,
  RolldownWatcherEvent as vt,
  PartialResolvedId as w,
  build as wt,
  ModuleType as x,
  rolldown as xt,
  LoadResult as y,
  RolldownWatcherWatcherEventMap as yt,
  ExistingRawSourceMap as z,
  ModuleFormat as zt,
}
