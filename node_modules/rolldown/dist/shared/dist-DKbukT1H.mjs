    ...
    async collect(specifier) {
      ...
      try {
        const result = await import(
          specifier + formatTrackingQuery(queryName, id, specifier)
        )
