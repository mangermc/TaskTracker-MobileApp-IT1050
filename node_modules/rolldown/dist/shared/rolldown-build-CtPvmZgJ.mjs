...
} from "./bindingify-input-options-XPJLJOD0.mjs"
...
const normalizePluginOption = async (plugins) =>
...
function _subIssues(datasets) {
  ...
  if (datasets)
    for (const dataset of datasets)
      if (issues) for (const issue of dataset.issues) issues.push(issue)
...
function partial(schema, keys) {
  ...
  for (const key in schema.entries)
    entries$1[key] =
      !keys || keys.includes(key) /* @__PURE__ */
...
const TransformOptionsSchema = /* @__PURE__ */ object({
  ...
  decorator: /* @__PURE__ */ optional(
    /* @__PURE__ */ object({
      legacy: /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
      emitDecoratorMetadata: /* @__PURE__ */ optional(
        /* @__PURE__ */ boolean(),
      ),
  ...
  define: /* @__PURE__ */ pipe(
    ...
    /* @__PURE__ */ description(
      "Define global variables (syntax: key:value,key2:value2)",
    ),
  ),
  ...
  plugins: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(
      /* @__PURE__ */ object({
        ...
        taggedTemplateEscape: /* @__PURE__ */ optional(
          /* @__PURE__ */ boolean(),
        ),
      }),
    ),
...
const WatcherFileWatcherOptionsSchema = /* @__PURE__ */ strictObject({
  usePolling: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
    /* @__PURE__ */ description(
      "Use polling-based file watching instead of native OS events",
    ),
  ),
  ...
  useDebounce: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
    /* @__PURE__ */ description(
      "Use debounced event delivery at the filesystem level",
    ),
  ),
...
const ChecksOptionsSchema = /* @__PURE__ */ strictObject({
  ...
  invalidAnnotation: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
    /* @__PURE__ */ description(
        ...
        treeshake: /* @__PURE__ */ optional(
          /* @__PURE__ */ strictObject({
            ...
            propertyReadSideEffects: /* @__PURE__ */ optional(
              /* @__PURE__ */ union([
                /* @__PURE__ */ boolean(),
                /* @__PURE__ */ literal("always"),
              ]),
            ),
            propertyWriteSideEffects: /* @__PURE__ */ optional(
              /* @__PURE__ */ boolean(),
            ),
            unknownGlobalSideEffects: /* @__PURE__ */ optional(
              /* @__PURE__ */ boolean(),
            ),
            invalidImportSideEffects: /* @__PURE__ */ optional(
              /* @__PURE__ */ boolean(),
            ),
          }),
        ),
  ...
  codegen: /* @__PURE__ */ optional(
    /* @__PURE__ */ union([
      ...
      /* @__PURE__ */ strictObject({
        ...
        legalComments: /* @__PURE__ */ optional(
          /* @__PURE__ */ union([
...
const ResolveOptionsSchema = /* @__PURE__ */ strictObject({
  ...
  conditionNames: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(/* @__PURE__ */ string()),
  ),
  ...
  extensions: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(/* @__PURE__ */ string()),
  ),
  mainFields: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(/* @__PURE__ */ string()),
  ),
  mainFiles: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(/* @__PURE__ */ string()),
  ),
  modules: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(/* @__PURE__ */ string()),
  ),
...
const LogOrStringHandlerSchema = /* @__PURE__ */ pipe(
  vFunction(),
  /* @__PURE__ */ args(
    /* @__PURE__ */ tuple([LogLevelWithErrorSchema, RollupLogWithStringSchema]),
  ),
)
        ...
        /* @__PURE__ */ args(
          /* @__PURE__ */ tuple([
            /* @__PURE__ */ union([
              ...
              /* @__PURE__ */ pipe(
                vFunction(),
                /* @__PURE__ */ returns(RollupLogWithStringSchema),
              ),
            ]),
          ]),
        ),
...
const InputOptionsSchema = /* @__PURE__ */ strictObject({
  ...
  makeAbsoluteExternalsRelative: /* @__PURE__ */ optional(
    /* @__PURE__ */ union([
      /* @__PURE__ */ boolean(),
      /* @__PURE__ */ literal("ifRelativeSource"),
    ]),
  ),
  ...
  experimental: /* @__PURE__ */ optional(
    /* @__PURE__ */ strictObject({
      ...
      chunkOptimization: /* @__PURE__ */ optional(
        /* @__PURE__ */ union([
          /* @__PURE__ */ boolean(),
          /* @__PURE__ */ strictObject({
            mergeCommonChunks: /* @__PURE__ */ optional(
              /* @__PURE__ */ boolean(),
            ),
            avoidRedundantChunkLoads: /* @__PURE__ */ optional(
              /* @__PURE__ */ boolean(),
            ),
          }),
        ]),
  ...
  context: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ string()),
    /* @__PURE__ */ description(
      "The value of `this` at the top level of each module.",
    ),
  ),
...
const AddonFunctionSchema = /* @__PURE__ */ pipe(
  vFunction(),
  /* @__PURE__ */ args(
    /* @__PURE__ */ tuple([/* @__PURE__ */ custom(() => true)]),
  ),
...
const AdvancedChunksSchema = /* @__PURE__ */ strictObject({
  includeDependenciesRecursively: /* @__PURE__ */ optional(
    /* @__PURE__ */ boolean(),
  ),
  ...
  groups: /* @__PURE__ */ optional(
    /* @__PURE__ */ array(
      /* @__PURE__ */ strictObject({
        ...
        entriesAwareMergeThreshold: /* @__PURE__ */ optional(
          /* @__PURE__ */ number(),
        ),
        includeDependenciesRecursively: /* @__PURE__ */ optional(
          /* @__PURE__ */ boolean(),
        ),
        tags: /* @__PURE__ */ optional(
          /* @__PURE__ */ array(/* @__PURE__ */ string()),
        ),
      }),
    ),
...
const OutputOptionsSchema = /* @__PURE__ */ strictObject({
  ...
  hashCharacters: /* @__PURE__ */ pipe(
    ...
    /* @__PURE__ */ description(
      "Use the specified character set for file hashes",
    ),
  ),
  ...
  sourcemapFileNames: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(ChunkFileNamesSchema),
    /* @__PURE__ */ description("Name pattern for emitted sourcemaps"),
  ),
  sourcemapDebugIds: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
    /* @__PURE__ */ description("Inject sourcemap debug IDs"),
  ),
  sourcemapExcludeSources: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
    /* @__PURE__ */ description("Exclude source content from sourcemaps"),
  ),
  ...
  sourcemapPathTransform: /* @__PURE__ */ optional(
    /* @__PURE__ */ custom(() => true),
  ),
  ...
  esModule: /* @__PURE__ */ optional(
    /* @__PURE__ */ union([
      /* @__PURE__ */ boolean(),
      /* @__PURE__ */ literal("if-default-prop"),
    ]),
  ),
  ...
  generatedCode: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(
      /* @__PURE__ */ partial(GeneratedCodeOptionsSchema),
    ),
  ...
  hoistTransitiveImports: /* @__PURE__ */ optional(
    /* @__PURE__ */ literal(false),
  ),
...
const CliOptionsSchema = /* @__PURE__ */ strictObject({
  ...
  configLoader: /* @__PURE__ */ pipe(
    /* @__PURE__ */ optional(
      /* @__PURE__ */ union([
        /* @__PURE__ */ literal("bundle"),
        /* @__PURE__ */ literal("native"),
      ]),
    ),
    /* @__PURE__ */ description("How to load the config file (bundle, native)"),
  ),
  ...
  if (!parsed.success) {
    const errors = parsed.issues
      .map((issue) => {
        ...
        return `- For the "${stringPath}". ${helper?.issueMsg || issueMsg + "."} ${
          helper?.help ? `\n  Help: ${helper.help}` : ""
        }`
      })
      .filter(Boolean)
...
function box(text, _opts = {}) {
  ...
  if (_color)
    for (const key in borderStyle) borderStyle[key] = _color(borderStyle[key])
  const paddingOffset =
  ...
  if (opts.title) {
    ...
    const right = borderStyle.h.repeat(
      width -
        stripAnsi$1(opts.title).length -
        stripAnsi$1(left).length +
        paddingOffset,
    )
    boxLines.push(
...
function createConsola(options = {}) {
  ...
  return createConsola$1({
    ...
    prompt: (...args) =>
      import("./prompt--dNycKSZ.mjs").then((m) => m.prompt(...args)),
    reporters: options.reporters || [
...
async function initializeParallelPlugins(plugins) {
  ...
  const parallelJsPluginRegistry = new import_binding.ParallelJsPluginRegistry(
    count,
  )
...
async function createBundlerOptions(inputOptions, outputOptions, watchMode) {
  ...
  const normalizedInputPlugins = normalizePlugins(
    inputPlugins,
  ...
  try {
    ...
    return {
      bundlerOptions: {
        ...
        outputOptions: bindingifyOutputOptions(
          outputOptions,
          pluginContextData,
        ),
