...
var require_replaceValueSymbols = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_replaceSymbols = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_createICSSRules = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    ...
    const createExports = (exports$6, postcss, mode = "rule") => {
      const declarations = Object.keys(exports$6).map((key) =>
        postcss.decl({
          prop: key,
          value: exports$6[key],
          raws: { before: "\n  " },
    ...
    const createICSSRules = (imports, exports$7, postcss, mode) => [
      ...createImports(imports, postcss, mode),
      ...createExports(exports$7, postcss, mode),
    ]
    ...
    async fetchImport(importNode, relativeTo, depNr) {
      ...
      try {
        importNode.each((decl) => {
          if (decl.type == "decl")
            this.translations[decl.prop] = exports1[decl.value]
        })
        importNode.remove()
      } catch (err) {
        console.log(err)
...
var require_localsConvention = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const _lodashcamelcase = /*#__PURE__*/ _interop_require_default(
...
var require_FileSystemLoader = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const _postcss$1 = /*#__PURE__*/ _interop_require_default(
    __require("postcss"),
  )
  ...
  var Core = class Core {
    ...
    async load(sourceString, sourcePath, trace, pathFetcher) {
      ...
      return {
        injectableSource: (
          await (0, _postcss$1.default)(plugins).process(sourceString, {
            from: sourcePath,
          })
        ).css,
  ...
  var FileSystemLoader = class {
    ...
    async fetch(_newPath, relativeTo, _trace) {
      ...
      const rootRelativePath =
        fileResolvedPath || _path.default.resolve(relativeDir, newPath)
      let fileRelativePath =
        fileResolvedPath ||
        _path.default.resolve(
          _path.default.resolve(this.root, relativeDir),
          newPath,
        )
      if (
        !useFileResolve &&
        newPath[0] !== "." &&
        !_path.default.isAbsolute(newPath)
      )
        try {
...
var require_topologicalSort = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
        ...
        return {
          Once(root, postcss) {
            ...
            if (importsOrder instanceof Error) {
              ...
              throw importDecls[importPath].error(
...
var require_BulkUpdateDecorator = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    const BULK_SIZE = 2e3
    const digestCaches = {}
...
var require_interpolateName = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var require_util = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.ensureObject = _interopRequireDefault(require_ensureObject())[
    "default"
  ]
  exports.stripComments = _interopRequireDefault(require_stripComments())[
    "default"
  ]
      ...
      if (numSingleQuotes + numDoubleQuotes === 0) {
        ...
        if (escaped === v) return Attribute.NO_QUOTE
          ...
          if (pref === Attribute.NO_QUOTE) {
            ...
            if (
              (0, _cssesc["default"])(v, CSSESC_QUOTE_OPTIONS[quote]).length <
              escaped.length
            )
              return quote
          }
          ...
          case tokens.space:
            ...
            if (lastAdded) {
              ...
              node.spaces[lastAdded].after =
                (node.spaces[lastAdded].after || "") + content
              var existingComment =
                (0, _util.getProp)(
                  node,
                  "raws",
...
var require_processor = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  exports["default"] = /* @__PURE__ */ (function () {
    ...
    _proto._shouldUpdateSelector = function _shouldUpdateSelector(
      ...
      if (options === void 0) options = {}
      if (Object.assign({}, this.options, options).updateSelector === false)
        return false
      else return typeof rule !== "string"
    }
    _proto._isLossy = function _isLossy(options) {
      if (options === void 0) options = {}
      if (Object.assign({}, this.options, options).lossless === false)
        return true
      else return false
    }
    ...
    const transform = (node, context) => {
      ...
      switch (node.type) {
        ...
        case "pseudo": {
          ...
          if (node.value === ":import" || node.value === ":export")
...
var require_scoping = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const _postcssmodulesextractimports = /*#__PURE__*/ _interop_require_default(
    require_src$3(),
  )
  const _genericnames = /*#__PURE__*/ _interop_require_default(
    require_generic_names(),
  )
  const _postcssmoduleslocalbydefault = /*#__PURE__*/ _interop_require_default(
    require_src$2(),
  )
  const _postcssmodulesscope = /*#__PURE__*/ _interop_require_default(
    require_src$1(),
  )
  const _stringhash = /*#__PURE__*/ _interop_require_default(
    require_string_hash(),
  )
  const _postcssmodulesvalues = /*#__PURE__*/ _interop_require_default(
    require_src(),
  )
  function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : { default: obj }
  ...
  function getDefaultScopeBehaviour(scopeBehaviour) {
    return scopeBehaviour && isValidBehaviour(scopeBehaviour)
      ? scopeBehaviour
      : behaviours.LOCAL
  }
  function makeDefaultScopedNameGenerator(hashPrefix) {
    return function generateScopedNameDefault(name, filename, css) {
      ...
      return `_${name}_${(0, _stringhash.default)(`${hashPrefix || ""}${css}`)
        .toString(36)
        .substr(0, 5)}_${lineNumber}`
    }
  }
  function getScopedNameGenerator(generateScopedName, hashPrefix) {
    const scopedNameGenerator =
      generateScopedName || makeDefaultScopedNameGenerator(hashPrefix)
...
var require_pluginFactory = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const _FileSystemLoader = /*#__PURE__*/ _interop_require_default(
    require_FileSystemLoader(),
  )
  ...
  function getDefaultPluginsList(opts, inputFile) {
    ...
    const defaultBehaviour = (0, _scoping.getDefaultScopeBehaviour)(
      opts.scopeBehaviour,
    )
  ...
  function makePlugin(opts) {
    return {
      ...
      async OnceExit(css, { result }) {
        ...
        await (0, _postcss.default)([...pluginList, parser.plugin()]).process(
          css,
          { from: inputFile },
        )
        css.walkRules((rule) => {
