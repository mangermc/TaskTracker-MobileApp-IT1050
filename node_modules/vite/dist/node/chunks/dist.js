...
var Tokenizer = class {
  ...
  resume(writeCallback) {
    ...
    if (!this.paused)
      writeCallback === null || writeCallback === void 0 || writeCallback()
  }
  ...
  _emitCodePoint(cp) {
    ...
    this._appendCharToCurrentCharacterToken(
      type,
      cp < 65536 ? String.fromCharCode(cp) : String.fromCodePoint(cp),
    )
  }
  _emitChars(ch) {
...
const SCOPING_ELEMENTS_HTML_BUTTON = /* @__PURE__ */ new Set([
  ...SCOPING_ELEMENTS_HTML,
  TAG_ID.BUTTON,
])
...
var OpenElementStack = class {
  ...
  generateImpliedEndTags() {
    while (
      ...
      IMPLICIT_END_TAG_REQUIRED.has(this.currentTagId)
    )
      this.pop()
  }
...
var Parser = class {
  ...
  onItemPush(node, tid, isTop) {
    var _a, _b
    ;(_b = (_a = this.treeAdapter).onItemPush) === null ||
      _b === void 0 ||
      _b.call(_a, node)
