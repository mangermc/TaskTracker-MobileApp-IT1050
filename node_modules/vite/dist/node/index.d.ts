...
type ErrorCallback<TIncomingMessage extends typeof http.IncomingMessage = typeof http.IncomingMessage,
...
type ProxyServerEventMap<TIncomingMessage extends typeof http.IncomingMessage = typeof http.IncomingMessage,
TServerResponse extends typeof http.ServerResponse = typeof http.ServerResponse,
TError = Error,> = {
...
type ProxyMethodArgs<TIncomingMessage extends typeof http.IncomingMessage = typeof http.IncomingMessage,
TServerResponse extends typeof http.ServerResponse = typeof http.ServerResponse,
TError = Error,> = {
...
type PassFunctions<TIncomingMessage extends typeof http.IncomingMessage = typeof http.IncomingMessage,
TServerResponse extends typeof http.ServerResponse = typeof http.ServerResponse,
TError = Error,> = {
  ws: (
    req: InstanceType<TIncomingMessage>,
...
> extends EventEmitter<ProxyServerEventMap<TIncomingMessage, TServerResponse, TError>> {
   ...
   */
  static createProxyServer<TIncomingMessage extends typeof http.IncomingMessage,
   ...
   * @returns Proxy object with handlers for `ws` and `web` requests
   */
  static createServer<TIncomingMessage extends typeof http.IncomingMessage,
  TServerResponse extends typeof http.ServerResponse,
  TError = Error,>(
    options?: ServerOptions$3,
  ): ProxyServer<TIncomingMessage, TServerResponse, TError>
   ...
   * @returns Proxy object with handlers for `ws` and `web` requests
   */
  static createProxy<TIncomingMessage extends typeof http.IncomingMessage,
  TServerResponse extends typeof http.ServerResponse,
  TError = Error,>(
    options?: ServerOptions$3,
  ): ProxyServer<TIncomingMessage, TServerResponse, TError>
 ...
 * @api public
 */
declare function createProxyServer<TIncomingMessage extends typeof http.IncomingMessage = typeof http.IncomingMessage,
TServerResponse extends typeof http.ServerResponse = typeof http.ServerResponse,
TError = Error,>(
  options?: ServerOptions$3,
): ProxyServer<TIncomingMessage, TServerResponse, TError>
...
declare class WebSocket extends EventEmitter {
  ...
  off(event: "upgrade", listener: (request: http.IncomingMessage) => void): this
  off(
    event: "message",
    listener: (data: WebSocket.RawData, isBinary: boolean) => void,
  ): this
...
declare namespace WebSocket {
  ...
  class Server<T extends WebSocket = WebSocket> extends EventEmitter {
    ...
    on(
      event: "connection",
      cb: (socket: T, request: http.IncomingMessage) => void,
    ): this
    ...
    off(event: "close" | "listening", cb: () => void): this
    off(event: string | symbol, listener: (...args: any[]) => void): this
    addListener(
      event: "connection",
...
interface WebSocketClient
  extends NormalizedHotChannelClient {
  /**
...
interface RollupCommonJSOptions {
   ...
   * @default true
   */
  ignoreTryCatch?: boolean | "remove" | ReadonlyArray<string> | ((
    id: string,
  ) => boolean | "remove")
  /**
   ...
   * @default false
   */
  requireReturnsDefault?: boolean | "auto" | "preferred" | "namespace" | ((
    id: string,
  ) => boolean | "auto" | "preferred" | "namespace")
  /**
   * @default "auto"
   */
...
interface ResolveOptions
  extends EnvironmentResolveOptions {
  /**
   * @default false
   */
  /**
...
type BuildAppHook = (builder: ViteBuilder) => Promise<void>
//#endregion
...
interface ResolvedServerOptions
  extends Omit<RequiredExceptFor<ServerOptions$1, "host" | "https" | "proxy" | "hmr" | "ws" | "watch" | "origin" | "hotUpdateEnvironments">, "fs" | "middlewareMode" | "sourcemapIgnoreList" | "forwardConsole"> {
...
interface Plugin<A = any>
  ...
  shouldTransformCachedModule?: ObjectHook<(options: {
    code: string
    id: string
...
type PreprocessorAdditionalData = string | ((
  source: string,
  filename: string,
...
interface ESBuildOptions
  extends esbuildOptions_EsbuildTransformOptions {
  /**
...
interface OxcOptions
  extends Omit<rolldown_utils_TransformOptions, "cwd" | "sourceType" | "lang" | "sourcemap" | "helpers" | "inject" | "tsconfig" | "inputMap"> {
  include?: string | RegExp | ReadonlyArray<string | RegExp>
  exclude?: string | RegExp | ReadonlyArray<string | RegExp>
  jsxInject?: string
...
interface EnvironmentOptions
  extends SharedEnvironmentOptions {
  /**
...
interface UserConfig
  extends DefaultEnvironmentOptions {
  /**
...
interface ResolvedConfig
  extends Readonly<Omit<UserConfig, "plugins" | "css" | "json" | "assetsInclude" | "optimizeDeps" | "worker" | "build" | "dev" | "environments" | "experimental" | "future" | "server" | "preview" | "devtools"> & {
...
declare function resolveConfig(
  ...
  isPreview?: boolean,
  patchConfig?: ((config: ResolvedConfig) => void) | undefined,
  patchPlugins?: ((resolvedPlugins: Plugin[]) => void) | undefined,
...
interface ServerModuleRunnerOptions
  extends Omit<ModuleRunnerOptions, "root" | "fetchModule" | "hmr" | "transport"> {
  /**
...
declare function mergeConfig<D extends Record<string, any>,
 ...
 */
declare function isFileLoadingAllowed(
  config: ResolvedConfig,
  filePath: string,
): boolean
//#endregion
