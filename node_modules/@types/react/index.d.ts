...
declare namespace React {
  ...
  type JSXElementConstructor<P,> = ((
    props: P,
  ) => ReactNode | Promise<ReactNode>) | // constructor signature must match React.Component
  (new (
    props: P,
    context: any,
  ) => Component<any, any>)
  ...
  type ElementRef<C extends ForwardRefExoticComponent<any> | {
    ...
    props: any,
  ) => ReactNode) | keyof JSX.IntrinsicElements,> = ComponentRef<C>
