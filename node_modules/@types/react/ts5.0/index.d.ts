...
type AwaitedReactNode = React.ReactElement | string | number | bigint | Iterable<React.ReactNode> | React.ReactPortal | boolean | null | undefined | React.DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_REACT_NODES[keyof React.DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_REACT_NODES]
...
declare namespace React {
  ...
  type JSXElementConstructor<P,> = ((
    props: P,
  ) => ReactElement<any, any> | null) | // constructor signature must match React.Component
  (new (
    props: P,
    context: any,
  ) => Component<any, any>)
  ...
  type ElementRef<C extends ForwardRefExoticComponent<any> | {
    ...
    props: any,
  ) => ReactElement | null) | keyof JSX.IntrinsicElements,> = ComponentRef<C>
   ...
   */
  type Key = string | number | bigint | DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_KEY_TYPES[keyof DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_KEY_TYPES]
   ...
   */
  type CElement<P,
  T extends Component<P, ComponentState>,> = ComponentElement<P, T>
  /**
   * @deprecated Use `ReactElement<P, React.ComponentClass<P>>`
   */
  ...
  type ForwardedRef<T,> = ((
    instance: T | null,
  ) => void) | MutableRefObject<T | null> | null
  ...
  type ClassType<P,
  T extends Component<P, ComponentState>,
  C extends ComponentClass<P>,> = C & new (
    props: P,
    context: any,
  ) => T
  ...
  type GetDerivedStateFromProps<P,
  S,> = /**
  ...
  type GetDerivedStateFromError<P,
  S,> = /**
   ...
   */
  type PropsWithoutRef<Props,> = // Omit would not be sufficient for this. We'd like to avoid unnecessary mapping and need a distributive conditional to support unions.
   ...
   * ```
   */
  type ComponentRef<T extends ElementType,> = ComponentPropsWithRef<T> extends RefAttributes<infer Method>
    ? Method
    : never
   ...
   */
  interface ChangeEvent<CurrentTarget = Element, Target = Element>
  ...
  interface SubmitEvent<T = Element>
    extends SyntheticEvent<T, NativeSubmitEvent> {
  ...
  type ChangeEventHandler<CurrentTarget = Element,
  Target = Element,> = EventHandler<ChangeEvent<CurrentTarget, Target>>
  ...
  type DetailedHTMLProps<E extends HTMLAttributes<T>,
  T,> = ClassAttributes<T> & E
  ...
  interface AllHTMLAttributes<T>
    ...
    action?: string | undefined | ((
      formData: FormData,
    ) => void | Promise<void>) | DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_FORM_ACTIONS[keyof DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_FORM_ACTIONS]
  ...
  interface ButtonHTMLAttributes<T> extends HTMLAttributes<T> {
    ...
    formAction?: string | ((
      formData: FormData,
    ) => void | Promise<void>) | DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_FORM_ACTIONS[keyof DO_NOT_USE_OR_YOU_WILL_BE_FIRED_EXPERIMENTAL_FORM_ACTIONS] | undefined
    formEncType?: string | undefined
    formMethod?: string | undefined
    formNoValidate?: boolean | undefined
    formTarget?: string | undefined
  ...
  interface InputHTMLAttributes<T>
    extends HTMLAttributes<T> { // https://www.w3.org/TR/html-media-capture/#the-capture-attribute
  ...
  namespace JSX {
    ...
    type LibraryManagedAttributes<C,
    P,> = C extends React.MemoExoticComponent<infer T> | React.LazyExoticComponent<infer T>
...
type ReactManagedAttributes<C,
P,> = C extends { defaultProps: infer D } ? Defaultize<P, D> : P
