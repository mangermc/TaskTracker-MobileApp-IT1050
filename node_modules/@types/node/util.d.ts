...
declare module "util" {
  ...
  type ForegroundColors = "black" | "blackBright" | "blue" | "blueBright" | "cyan" | "cyanBright" | "gray" | "green" | "greenBright" | "grey" | "magenta" | "magentaBright" | "red" | "redBright" | "white" | "whiteBright" | "yellow" | "yellowBright"
  // https://nodejs.org/docs/latest/api/util.html#background-colors
  type BackgroundColors = "bgBlack" | "bgBlackBright" | "bgBlue" | "bgBlueBright" | "bgCyan" | "bgCyanBright" | "bgGray" | "bgGreen" | "bgGreenBright" | "bgGrey" | "bgMagenta" | "bgMagentaBright" | "bgRed" | "bgRedBright" | "bgWhite" | "bgWhiteBright" | "bgYellow" | "bgYellowBright"
  // https://nodejs.org/docs/latest/api/util.html#modifiers
  type Modifiers = "blink" | "bold" | "dim" | "doubleunderline" | "framed" | "hidden" | "inverse" | "italic" | "none" | "overlined" | "reset" | "strikethrough" | "underline"
  ...
  /*
    ...
    */
  type IfDefaultsTrue<T,
  IfTrue,
  IfFalse,> = T extends true ? IfTrue : T extends false ? IfFalse : IfTrue

  // we put the `extends false` condition first here because `undefined` compares like `any` when `strictNullChecks: false`
  type IfDefaultsFalse<T,
  IfTrue,
  IfFalse,> = T extends false ? IfFalse : T extends true ? IfTrue : IfFalse

  type ExtractOptionValue<T extends ParseArgsConfig,
  ...
  type ApplyOptionalModifiers<O extends ParseArgsOptionsConfig,
  ...
  type ParsedValues<T extends ParseArgsConfig,> = IfDefaultsTrue<T["strict"], unknown, {
    [longOption: string]: undefined | string | boolean
  }> & T["options"] extends ParseArgsOptionsConfig
    ? ApplyOptionalModifiers<T["options"], {
      [LongOption in keyof T["options"]]: IfDefaultsFalse<T["options"][LongOption]["multiple"], Array<ExtractOptionValue<T, T["options"][LongOption]>>, ExtractOptionValue<T, T["options"][LongOption]>>
    }>
    : {}

  type ParsedPositionals<T extends ParseArgsConfig,> = IfDefaultsTrue<T["strict"], IfDefaultsFalse<T["allowPositionals"], string[], []>, IfDefaultsTrue<T["allowPositionals"], string[], []>>
  ...
  type TokenForOptions<T extends ParseArgsConfig,
  K extends keyof T["options"] = keyof T["options"],> = K extends unknown
    ? T["options"] extends ParseArgsOptionsConfig
  ...
  type ParsedPositionalToken<T extends ParseArgsConfig,> = IfDefaultsTrue<T["strict"], IfDefaultsFalse<T["allowPositionals"], {
    kind: "positional"
    index: number
    value: string
  }, never>, IfDefaultsTrue<T["allowPositionals"], {
    kind: "positional"
    index: number
    value: string
  }, never>>

  type ParsedTokens<T extends ParseArgsConfig,> = Array<ParsedOptionToken<T> | ParsedPositionalToken<T> | {
    kind: "option-terminator"
    index: number
  }>

  type PreciseParsedResults<T extends ParseArgsConfig,> = IfDefaultsFalse<T["tokens"], {
