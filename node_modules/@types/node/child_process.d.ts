...
declare module "child_process" {
  ...
  class ChildProcess extends EventEmitter {
     ...
     * @since v0.7.10
     */
    readonly stdio: [Writable | null, // stdin
  ...
  interface ChildProcessWithoutNullStreams
    ...
    stdout: Readable
    stderr: Readable
    readonly stdio: [Writable, Readable, Readable, Readable | Writable | null | undefined, Readable | Writable | null | undefined]
  }
  ...
  > extends ChildProcess {
    ...
    stdout: O
    stderr: E
    readonly stdio: [I, O, E, Readable | Writable | null | undefined, Readable | Writable | null | undefined]
  }
  ...
  interface ExecOptionsWithBufferEncoding
    extends ExecOptions { // specify `null`.
  ...
  type ExecFileException = Omit<ExecException, "code"> & Omit<NodeJS.ErrnoException, "code"> & {
  ...
  interface ExecFileSyncOptionsWithBufferEncoding
    extends ExecFileSyncOptions { // specify `null`.
    encoding?: "buffer" | null | undefined
  }
  /**
