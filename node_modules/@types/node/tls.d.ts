...
declare module "tls" {
  ...
  interface TlsOptions
    ...
    pskCallback?: ((
      socket: TLSSocket,
      identity: string,
    ) => NodeJS.ArrayBufferView | null) | undefined
  ...
  interface ConnectionOptions
    extends SecureContextOptions,
      CommonConnectionOptions { // Creates unix socket connection to path. If this option is specified, `host` and `port` are ignored. // Establish secure connection on a given socket rather than creating a new socket // SNI TLS Extension
      /**
       * When negotiating TLS-PSK (pre-shared keys), this function is called
    ...
    pskCallback?: ((
      hint: string | null,
    ) => PSKCallbackNegotation | null) | undefined
  }
  /**
