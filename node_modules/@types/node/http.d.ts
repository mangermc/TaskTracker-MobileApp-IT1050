...
declare module "http" {
  ...
  interface ClientRequestArgs
    extends Pick<LookupOptions, "hints"> {
    /**
     * @default 16384
     */
    ...
    ) => stream.Duplex | null | undefined) | undefined
  ...
  type RequestListener<Request extends typeof IncomingMessage = typeof IncomingMessage,
  Response extends typeof ServerResponse<InstanceType<Request>> = typeof ServerResponse,> = (
  ...
  interface AgentOptions
    extends NodeJS.PartialOptions<TcpSocketConnectOpts> {
    /**
   ...
   * @since v0.1.13
   */
  function createServer<Request extends typeof IncomingMessage = typeof IncomingMessage,
  Response extends typeof ServerResponse<InstanceType<Request>> = typeof ServerResponse,>(
    requestListener?: RequestListener<Request, Response>,
