...
declare module "dns" {
  ...
  export namespace lookupService {
    function __promisify__(address: string, port: number): Promise<{
      hostname: string
      service: string
    }>
  }
  ...
  export type AnyRecord = AnyARecord | AnyAaaaRecord | AnyCaaRecord | AnyCnameRecord | AnyMxRecord | AnyNaptrRecord | AnyNsRecord | AnyPtrRecord | AnySoaRecord | AnySrvRecord | AnyTlsaRecord | AnyTxtRecord
  /**
  ...
  export function resolve(
    ...
    callback: (
      err: NodeJS.ErrnoException | null,
      addresses: string[] | CaaRecord[] | MxRecord[] | NaptrRecord[] | SoaRecord | SrvRecord[] | TlsaRecord[] | string[][] | AnyRecord[],
    ) => void,
  ): void
  export namespace resolve {
    ...
    function __promisify__(
      hostname: string,
      rrtype: string,
    ): Promise<string[] | CaaRecord[] | MxRecord[] | NaptrRecord[] | SoaRecord | SrvRecord[] | TlsaRecord[] | string[][] | AnyRecord[]>
  }
  /**
