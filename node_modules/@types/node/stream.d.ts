...
declare module "stream" {
  ...
  namespace Stream {
    ...
    interface ReadableOptions<T extends Readable = Readable>
      ...
      read?: ((size: number) => void) | undefined
    }
    ...
    interface WritableOptions<T extends Writable = Writable>
      ...
      final?: ((callback: (error?: Error | null) => void) => void) | undefined
    }
    /**
     * @since v0.9.4
     */
    ...
    class Duplex extends Stream implements NodeJS.ReadWriteStream {
       ...
       */
      static from(
        src: Stream | NodeBlob | ArrayBuffer | string | Iterable<any> | AsyncIterable<any> | AsyncGeneratorFunction | Promise<any> | Object,
      ): Duplex
      /**
    ...
    interface TransformOptions<T extends Transform = Transform>
      ...
      flush?: ((callback: TransformCallback) => void) | undefined
    }
    /**
    ...
    type PipelineTransform<S extends PipelineTransformSource<any>,
    U,> = NodeJS.ReadWriteStream | ((
      source: S extends ((
        ...args: any[]
    ...
    type PipelineDestinationPromiseFunction<T,
    P,> = (source: AsyncIterable<T>) => Promise<P>
    type PipelineDestination<S extends PipelineTransformSource<any>,
    P,> = S extends PipelineTransformSource<infer ST>
    ...
    type PipelinePromise<S extends PipelineDestination<any, any>,> = S extends PipelineDestinationPromiseFunction<any, infer P>
      ? Promise<P>
      : Promise<void>
     ...
     */
    function isWritable(
      stream: Writable | NodeJS.WritableStream,
    ): boolean | null
  }
  export = Stream
}
