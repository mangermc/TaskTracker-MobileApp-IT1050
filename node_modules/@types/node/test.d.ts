...
declare module "node:test" {
  ...
  namespace test {
    ...
    interface TestContextAssert
      extends Pick<typeof import("assert"), AssertMethodNames> {
      /**
    ...
    interface MockTracker {
       ...
       */
      getter<MockedObject extends object,
       ...
       * @since v19.3.0, v18.13.0
       */
      setter<MockedObject extends object,
      MethodName extends keyof MockedObject,>(
        object: MockedObject,
        methodName: MethodName,
        options?: MockFunctionOptions,
       ...
       */
      property<MockedObject extends object,
    ...
    namespace assert {
       ...
       * @since v22.14.0
       */
      function register(name: string, fn: (...args: any[]) => void): void
    }
    /**
     * @since v22.3.0
     */
...
declare module "node:test/reporters" {
  ...
  type TestEvent = { type: "test:coverage" data: EventData.TestCoverage } | {
    type: "test:complete"
