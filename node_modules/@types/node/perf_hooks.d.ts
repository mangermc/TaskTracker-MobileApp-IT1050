...
declare module "perf_hooks" {
  ...
  type EntryType = "dns" | "function" | "gc" | "http2" | "http" | "mark" | "measure" | "net" | "node" | "resource" // Node.js only // Node.js only // Node.js only // Node.js only // Node.js only // available on the Web // available on the Web // Node.js only // Node.js only // available on the Web
