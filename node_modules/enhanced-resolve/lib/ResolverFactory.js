 ...
 */
/** @type {ResolveOptions["mainFields"]} */ /** @type {ExtensionAliasOptions} */
/** @type {SyncFileSystem} */
/** @type {unknown} */ /** @type {Cache} */
...
function createOptions(options) {
  ...
  return {
    ...
    cacheWithContext:
      typeof options.cacheWithContext !==
      "undefined"
        ? options.cacheWithContext
        : true,
    exportsFields: new Set(
      options.exportsFields || ["exports"],
    ),
    importsFields: new Set(
      options.importsFields || ["imports"],
    ),
    conditionNames: new Set(options.conditionNames),
    descriptionFiles: [
      ...new Set(
        options.descriptionFiles || ["package.json"],
      ),
    ],
    enforceExtension:
      ...
      undefined
        ? Boolean(
            options.extensions &&
              options.extensions.includes(""),
          )
        : options.enforceExtension,
    extensions: new Set(
      options.extensions || [".js", ".json", ".node"],
    ),
    ...
    extensionAliasForExports:
      options.extensionAliasForExports ||
      false,
    ...
    unsafeCache:
      options.unsafeCache &&
      typeof options.unsafeCache !==
        "object"
        ? {}
        : options.unsafeCache ||
          false,
    symlinks:
      typeof options.symlinks !==
      "undefined"
        ? options.symlinks
        : true,
    ...
    fullySpecified:
      options.fullySpecified ||
      false,
    resolveToContext:
      options.resolveToContext ||
      false,
    preferRelative:
      options.preferRelative ||
      false,
    preferAbsolute:
      options.preferAbsolute ||
      false,
