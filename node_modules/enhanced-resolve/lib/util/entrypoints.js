 ...
 */
/** @type {[ConditionalMapping, string[], number][]} */ /** @type {ConditionalMapping} */ /** @type {DirectMapping} */
...
/** @type {ConditionalMapping} */ /** @type {DirectMapping} */
  ...
  for (
    ...
    if (
      ...
      if (
        ...
        patternKeyCompare(bestMatch, key) !==
          1
      ) {
        continue
      }
...
function directMapping(
  ...
  for (
    let i = 0, len = mappingTarget.length;
    i <
    len;
    i++
  ) {
    ...
    for (
      let j = 0, innerLen = innerExports.length;
      j <
      innerLen;
      j++
    ) {
