 ...
 */ /** @type {CompiledAliasOption[]} */ /** @type {CompiledAliasOptions} */
    ...
    (item, callback) => {
      ...
      const matchRequest =
        ...
        (!item.onlyModule &&
          ((hasRequestString && innerRequest.startsWith(item.nameWithSlash)) ||
            (absolutePath !==
              null &&
              innerRequest.startsWith(absolutePath))))
      ...
      if (matchRequest || matchWildcard) {
        const resolveWithAlias = (alias, callback) => {
          ...
          if (
            matchWildcard &&
            innerRequest.startsWith(item.wildcardPrefix) &&
            innerRequest.endsWith(item.wildcardSuffix)
          ) {
