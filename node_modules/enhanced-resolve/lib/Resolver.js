 ...
 */ /** @type {ResolveStepHook} */ /** @type {ResolveStepHook} */
/** @type {ResolveStepHook} */ /** @type {KnownHooks & EnsuredHooks} */
/** @type {KnownHooks & EnsuredHooks} */ /** @type {KnownHooks & EnsuredHooks} */
...
/** @type {ResolveCallback | undefined} */
/** @type {ResolveContext | ResolveCallback | undefined} */ /** @type {string} */
...
/** @type {string[]} */ /** @type {ResolveContextYield} */
/** @type {ResolveRequest} */
...
class StackEntry {
  ...
  has(query) {
    ...
    return (
      this.preSeeded !==
        undefined &&
      this.preSeeded.has(query.toString())
    )
  }
  get size() {
  ...
  doResolve(hook, request, message, resolveContext, callback) {
    ...
    if (
      ...
      undefined
        ...
        : preSeeded !==
            undefined &&
          preSeeded.has(stackEntry.toString())
    ) {
