...
interface ObjectConstructor {
   ...
   * @param o Object on which to lock the attributes.
   */
  freeze<T extends { [idx: string]: U | null | undefined | object },
 ...
 */
type ThisParameterType<T> = T extends ((...args: never) => any) ? U : unknown
...
interface CallableFunction
   ...
   */
  apply<T, R>(thisArg: T): R
  apply<T, A extends any[], R>(thisArg: T, args: A): R
  call<T, A extends any[], R>(thisArg: T, ...args: A): R
  bind<T>(thisArg: ThisParameterType<T>): OmitThisParameter<T>
  bind<T, A extends any[], B extends any[], R>(thisArg: T, ...args: A): (
    ...args: B
  ) => R
}
...
interface NewableFunction
   ...
   * @param args Arguments to bind to the parameters of the function.
   */
  apply<T>(thisArg: T): void
  apply<T, A extends any[]>(thisArg: T, args: A): void
  call<T, A extends any[]>(thisArg: T, ...args: A): void
  bind<T>(thisArg: any): T
  bind<A extends any[], B extends any[], R>(thisArg: any, ...args: A): new (
    ...args: B
  ) => R
}
...
type ConstructorParameters<T extends abstract new (
  ...args: any
) => any,> = T extends (abstract new (...args: infer P) => any) ? P : never
 ...
 */
type InstanceType<T extends abstract new (
  ...args: any
