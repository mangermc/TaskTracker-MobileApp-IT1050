...
declare namespace ts {
  namespace server {
    namespace protocol {
       ...
       */
      export interface TodoCommentRequestArgs
       ...
       */
      export interface IndentationRequestArgs
        extends FileLocationRequestArgs {
        /**
       ...
       */
      export interface FileLocationRequestArgs
        extends FileRequestArgs {
        /**
      ...
      export interface GetPasteEditsRequestArgs
        extends FileRequestArgs {
       ...
       */
      export interface CodeFixRequestArgs
        extends FileRangeRequestArgs {
        /**
       ...
       */
      export interface GetSupportedCodeFixesResponse
        extends Response {
        /**
      ...
      export interface ReferencesResponseItem
        extends FileSpanWithContext {
        /**
       ...
       */
      export interface RenameRequestArgs
        extends FileLocationRequestArgs {
        /**
      ...
      export interface QuickInfoRequestArgs
        extends FileLocationRequestArgs {
        /**
       ...
       */
      export interface FormatRequestArgs
        extends FileLocationRequestArgs {
        /**
       ...
       */
      export interface FormatOnKeyRequestArgs
        extends FileLocationRequestArgs {
        /**
         * Key pressed (';', '\n', or '}').
         */
       ...
       */
      export interface CompletionsRequestArgs
        extends FileLocationRequestArgs {
        /**
      ...
      export interface JSDocLinkDisplayPart
        extends SymbolDisplayPart {
      ...
      export interface InlayHintsRequestArgs
        extends FileRequestArgs {
        /**
         * Start position of the span.
         */
       ...
       */
      export interface SavetoRequestArgs
        extends FileRequestArgs {
        /**
      ...
      export interface EndInstallTypesEventBody
        extends InstallTypesEventBody {
        /**
  ...
  interface NodeFactory {
     ...
     */
    replacePropertyName<T extends AccessorDeclaration | MethodDeclaration | MethodSignature | PropertyDeclaration | PropertySignature | PropertyAssignment,>(
      node: T,
      name: T["name"],
    ): T
  }
  ...
  interface TransformationContext
    extends CoreTransformationContext {
   ...
   */
  type Visitor<TIn extends Node = Node,
   ...
   */
  function visitNodes<TIn extends Node,
  TInArray extends NodeArray<TIn> | undefined,
  TOut extends Node,>(
    nodes: TInArray,
    visitor: Visitor<TIn, Node | undefined>,
