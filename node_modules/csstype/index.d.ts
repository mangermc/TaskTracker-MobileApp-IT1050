...
TTime = string & {},> = Fallback<StandardLonghandProperties<TLength, TTime>>

export type StandardShorthandPropertiesFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<StandardShorthandProperties<TLength, TTime>>
...
TTime = string & {},> = Fallback<VendorLonghandProperties<TLength, TTime>>

export type VendorShorthandPropertiesFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<VendorShorthandProperties<TLength, TTime>>
...
TTime = string & {},> = Fallback<ObsoleteProperties<TLength, TTime>>

export type SvgPropertiesFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<SvgProperties<TLength, TTime>>
...
TTime = string & {},> = Fallback<StandardLonghandPropertiesHyphen<TLength, TTime>>

export type StandardShorthandPropertiesHyphenFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<StandardShorthandPropertiesHyphen<TLength, TTime>>
...
TTime = string & {},> = Fallback<VendorLonghandPropertiesHyphen<TLength, TTime>>

export type VendorShorthandPropertiesHyphenFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<VendorShorthandPropertiesHyphen<TLength, TTime>>
...
TTime = string & {},> = Fallback<ObsoletePropertiesHyphen<TLength, TTime>>

export type SvgPropertiesHyphenFallback<TLength = string & {} | 0,
TTime = string & {},> = Fallback<SvgPropertiesHyphen<TLength, TTime>>
...
export namespace AtRule {
  ...
  export type CounterStyleFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<CounterStyle<TLength, TTime>>

  export type CounterStyleHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<CounterStyleHyphen<TLength, TTime>>
  ...
  export type FontFaceFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<FontFace<TLength, TTime>>

  export type FontFaceHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<FontFaceHyphen<TLength, TTime>>
  ...
  export type FontPaletteValuesFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<FontPaletteValues<TLength, TTime>>

  export type FontPaletteValuesHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<FontPaletteValuesHyphen<TLength, TTime>>
  ...
  TTime = string & {},> = Fallback<Page<TLength, TTime>>

  export type PageHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<PageHyphen<TLength, TTime>>
  ...
  export type PropertyFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<Property<TLength, TTime>>

  export type PropertyHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<PropertyHyphen<TLength, TTime>>
  ...
  export type ViewTransitionFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<ViewTransition<TLength, TTime>>

  export type ViewTransitionHyphenFallback<TLength = string & {} | 0,
  TTime = string & {},> = Fallback<ViewTransitionHyphen<TLength, TTime>>
