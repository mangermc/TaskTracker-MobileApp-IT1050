;(function (global) {
  ...
  function parse5322(opts) {
    ...
    function vchar() {
      return wrap(
        "vchar",
        compareToken(function vcharFunc(tok) {
    ...
    function quotedPair() {
      var qp = wrap(
        "quoted-pair",
        or(and(literal("\\"), or(vchar, wsp)), obsQP)(),
      )
      if (qp === null) {
        return null
      }
    ...
    function fws() {
      return wrap(
        "fws",
        or(obsFws, and(opt(and(star(wsp), invis(crlf))), star(wsp, 1)))(),
      )
    }
    function ctext() {
      return wrap(
        "ctext",
        or(function ctextFunc1() {
    ...
    function cfws() {
      return wrap(
        "cfws",
        or(and(star(and(opt(fws), comment), 1), opt(fws)), fws)(),
      )
    }
    function atext() {
      return wrap(
        "atext",
        compareToken(function atextFunc(tok) {
          var accept =
            ("a" <= tok && tok <= "z") ||
            ("A" <= tok && tok <= "Z") ||
            ("0" <= tok && tok <= "9") ||
    ...
    function atom() {
      return wrap(
        "atom",
        and(colwsp(opt(cfws)), star(atext, 1), colwsp(opt(cfws)))(),
      )
    }
    ...
    function dotAtom() {
      return wrap(
        "dot-atom",
        and(invis(opt(cfws)), dotAtomText, invis(opt(cfws)))(),
      )
    }
    function qtext() {
      return wrap(
        "qtext",
        or(function qtextFunc1() {
    ...
    function quotedString() {
      return wrap(
        ...
        and(
          invis(opt(cfws)),
          invis(dquote),
          star(and(opt(colwsp(fws)), qcontent)),
          opt(invis(fws)),
          invis(dquote),
          invis(opt(cfws)),
        )(),
    ...
    function mailboxList() {
      return wrap(
        "mailbox-list",
        or(and(mailbox, star(and(literal(","), mailbox))), obsMboxList)(),
      )
    }
    function addressList() {
      return wrap(
        "address-list",
        or(
          and(address, star(and(literal(opts.addressListSeparator), address))),
          obsAddrList,
        )(),
      )
    }
    ...
    function dtext() {
      return wrap(
        "dtext",
        or(function dtextFunc1() {
          return compareToken(function dtextFunc2(tok) {
            var code = tok.charCodeAt(0)
            var accept =
              (33 <= code && code <= 90) || (94 <= code && code <= 126)
            if (opts.rfc6532) {
              accept = accept || isUTF8NonAscii(tok)
            }
            return accept
    ...
    function obsQP() {
      return opts.strict
        ...
        : wrap(
            "obs-qp",
            and(literal("\\"), or(literal("\0"), obsNoWsCtl, lf, cr))(),
          )
    }
    function obsPhrase() {
      return opts.strict
    ...
    function obsFws() {
      return opts.strict
        ? null
        : wrap("obs-FWS", star(and(invis(opt(crlf)), wsp), 1)())
    }
    ...
    function obsRoute() {
      return opts.strict
        ? null
        : wrap("obs-route", and(obsDomainList, literal(":"))())
    }
    ...
    function obsMboxList() {
      return opts.strict
        ...
        : wrap(
            "obs-mbox-list",
            and(
              star(and(invis(opt(cfws)), literal(","))),
              mailbox,
              star(and(literal(","), opt(and(mailbox, invis(cfws))))),
            )(),
          )
    }
      ...
      return opts.strict
        ...
        : wrap(
            ...
            and(
              star(and(invis(opt(cfws)), literal(","))),
              address,
              star(and(literal(","), opt(and(address, invis(cfws))))),
            )(),
          )
    }
    function obsGroupList() {
      return opts.strict
        ...
        : wrap(
            "obs-group-list",
            and(
              star(and(invis(opt(cfws)), literal(",")), 1),
              invis(opt(cfws)),
            )(),
          )
    }
    function obsLocalPart() {
      return opts.strict
        ? null
        : wrap("obs-local-part", and(word, star(and(literal("."), word)))())
    }
    function obsDomain() {
      return opts.strict
        ? null
        : wrap("obs-domain", and(atom, star(and(literal("."), atom)))())
    }
    function obsDtext() {
      return opts.strict
        ? null
        : wrap("obs-dtext", or(obsNoWsCtl, quotedPair)())
    }
    ...
    function giveResult(ast) {
      ...
      result = { ast: ast, addresses: addresses }
      if (opts.simple) {
  ...
  function parseFromSimple(opts) {
    return parse5322(
      handleOpts(opts, { rfc6532: true, simple: true, startAt: "from" }),
    )
  }
  ...
  function parseReplyToSimple(opts) {
    return parse5322(
      handleOpts(opts, { rfc6532: true, simple: true, startAt: "reply-to" }),
    )
  }
