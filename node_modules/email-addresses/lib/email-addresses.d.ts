declare module emailAddresses {
  function parseOneAddress(
    input: string | Options,
  ): ParsedMailbox | ParsedGroup | null
  ...
  type StartProductions = "address" | "address-list" | "angle-addr" | "from" | "group" | "mailbox" | "mailbox-list" | "reply-to" | "sender"
...
declare function emailAddresses(
  opts: emailAddresses.Options,
): emailAddresses.ParsedResult | null
