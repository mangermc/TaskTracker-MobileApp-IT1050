...
type RequiredValue<Rule,> = Rule extends { value: object }
  ...
  ? Rule & {
    value: Required<StyleRule> & { declarations: Required<DeclarationBlock> }
  }
  : Rule & { value: Required<Rule["value"]> }
  : Rule
type RuleVisitor<R = RequiredValue<Rule>,> = (
  rule: R,
...
interface CustomAtRule<N, R extends CustomAtRuleDefinition> {
  name: N
  prelude: R["prelude"] extends keyof MappedPrelude
    ? MappedPrelude[R["prelude"]]
    : ParsedComponent
...
type FindProperty<Union,
Name,> = Union extends { property: Name } ? Union : never
...
type TokenVisitors = {
  [Name in VisitableTokenTypes]?: (
    token: FindByType<Token, Name>,
  ) => TokenReturnValue
}
...
export type VisitorFunction<C extends CustomAtRules,> = (
...
export interface BundleAsyncOptions<C extends CustomAtRules>
  extends BundleOptions<C> {
  resolver?: Resolver
}
 ...
 */
export declare function bundle<C extends CustomAtRules>(
