...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-android-arm64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ) {
          throw new Error(
            `Native binding package version mismatch, expected 4.3.3 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
          )
        }
        return binding
      } catch (e) {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-android-arm-eabi/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-win32-x64-gnu/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-win32-x64-msvc/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-win32-ia32-msvc/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-win32-arm64-msvc/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    try {
      ...
      const bindingPackageVersion =
        require("@tailwindcss/oxide-darwin-universal/package.json").version
      if (
        bindingPackageVersion !== "4.3.3" &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-darwin-x64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-darwin-arm64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-freebsd-x64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-freebsd-arm64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-x64-musl/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-x64-gnu/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-arm64-musl/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-arm64-gnu/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-arm-musleabihf/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-arm-gnueabihf/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-loong64-musl/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-loong64-gnu/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-riscv64-musl/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@tailwindcss/oxide-linux-riscv64-gnu/package.json").version
          if (
            bindingPackageVersion !== "4.3.3" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-linux-ppc64-gnu/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-linux-s390x-gnu/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-openharmony-arm64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-openharmony-x64/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@tailwindcss/oxide-openharmony-arm/package.json").version
        if (
          bindingPackageVersion !== "4.3.3" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
